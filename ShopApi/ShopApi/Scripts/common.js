...
String.prototype.isValidCode = function () {
    //var specChars = [",", ".", "/", "!", "@", "#", "$", "%", "^", "&", "*", "'", "\"", ";", "(", ")", ":", "|", "[", "]"];
    //var vietChars = [" ","á","à", "ạ", "ả", "ã", "â", "ấ", "ầ", "ậ", "ẩ", "ẫ", "ă", "ắ", "ằ", "ặ", "ẳ", "ẵ", "Á", "À", "Ạ", "Ả", "Ã", "Â", "Ấ", "Ầ", "Ậ", "Ẩ", "Ẫ", "Ă", "Ắ", "Ằ", "Ặ", "Ẳ", "Ẵ", "é", "è", "ẹ", "ẻ", "ẽ", "ê", "ế", "ề", "ệ", "ể", "ễ",
    //    "É", "È", "Ẹ", "Ẻ", "Ẽ", "Ê", "Ế", "Ề", "Ệ", "Ể", "Ễ", "ó", "ò", "ọ", "ỏ", "õ", "ô", "ố", "ồ", "ộ", "ổ", "ỗ", "ơ", "ớ", "ờ", "ợ", "ở", "ỡ",
    //    "Ó", "Ò", "Ọ", "Ỏ", "Õ", "Ô", "Ố", "Ồ", "Ộ", "Ổ", "Ỗ", "Ơ", "Ớ", "Ờ", "Ợ", "Ở", "Ỡ", "ú", "ù", "ụ", "ủ", "ũ", "ư", "ứ", "ừ", "ự", "ử", "ữ",
    //    "Ú", "Ù", "Ụ", "Ủ", "Ũ", "Ư", "Ứ", "Ừ", "Ự", "Ử", "Ữ", "í", "ì", "ị", "ỉ", "ĩ", "Í", "Ì", "Ị", "Ỉ", "Ĩ", "đ", "Đ", "ý", "ỳ", "ỵ", "ỷ", "ỹ", "Ý", "Ỳ", "Ỵ", "Ỷ", "Ỹ"];
    ////for (var i = 0; i < specChars.length; i++) {
    ////    if (this.indexOf(specChars[i]) > -1) {
    ////        return false;
    ////    }
    ////}
    //for (var i = 0; i < vietChars.length; i++) {
    //    if (this.indexOf(vietChars[i]) > -1) {
    //        return false;
    //    }
    //}
    if (this.indexOf(" ") > -1) {
