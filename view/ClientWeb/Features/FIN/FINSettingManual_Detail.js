...
var _FINSettingManual_Detail = {
    URL: {
        Get: 'FINSettingManual_Get',
        Save: 'FINSettingManual_Save',
    },
    Data: {
        DataCustomer: [],
        DataTransport: [
        ...
        GridAllSetting: [
            ...
            { Required: false, Type: 0, Code: "MasterCode", Name: "Mã chuyến", IsKey: false },
            ...
            { Required: false, Type: 0, Code: "RegNo", Name: "Xe", IsKey: false },
            ...
            { Required: false, Type: 0, Code: "IsInvoice", Name: "Nhận chứng từ", IsKey: false },
            { Required: false, Type: 0, Code: "DateFromCome", Name: "Ngày đến kho", IsKey: false },
            { Required: false, Type: 0, Code: "DateFromLeave", Name: "Ngày rời kho", IsKey: false },
            { Required: false, Type: 0, Code: "DateFromLoadStart", Name: "Thời gian vào máng", IsKey: false },
            { Required: false, Type: 0, Code: "DateFromLoadEnd", Name: "Thời gian ra máng", IsKey: false },
            { Required: false, Type: 0, Code: "DateToCome", Name: "Ngày đến NPP", IsKey: false },
            { Required: false, Type: 0, Code: "DateToLeave", Name: "Ngày rời NPP", IsKey: false },
            { Required: false, Type: 0, Code: "DateToLoadStart", Name: "Thời gian b.đầu dỡ hàng", IsKey: false },
            { Required: false, Type: 0, Code: "DateToLoadEnd", Name: "Thời gian k.thúc dỡ hàng", IsKey: false },
            { Required: false, Type: 0, Code: "InvoiceBy", Name: "Người nhận chứng từ", IsKey: false },
            { Required: false, Type: 0, Code: "InvoiceDate", Name: "Ngày nhận c/t", IsKey: false },
            { Required: false, Type: 0, Code: "InvoiceNote", Name: "Ghi chú c/t", IsKey: false },
            { Required: false, Type: 0, Code: "Note", Name: "Ghi chú", IsKey: false },
            { Required: false, Type: 0, Code: "OPSGroupNote1", Name: "Ghi chú 1", IsKey: false },
            { Required: false, Type: 0, Code: "OPSGroupNote2", Name: "Ghi chú 2", IsKey: false },
            { Required: false, Type: 0, Code: "ORDGroupNote1", Name: "Ghi chú Đ/h 1", IsKey: false },
            { Required: false, Type: 0, Code: "ORDGroupNote2", Name: "Ghi chú Đ/h 2", IsKey: false },
            { Required: false, Type: 0, Code: "TOMasterNote1", Name: "Ghi chú chuyến 1", IsKey: false },
            { Required: false, Type: 0, Code: "TOMasterNote2", Name: "Ghi chú chuyến 2", IsKey: false },
            ...
            { Required: false, Type: 0, Code: "ChipNo", Name: "ChipNo", IsKey: false },
            { Required: false, Type: 0, Code: "Temperature", Name: "Temperature", IsKey: false },
            { Required: false, Type: 0, Code: "Ton", Name: "Số tấn kế hoạch", IsKey: false },
            ...
            { Required: false, Type: 0, Code: "Kg", Name: "Kg kế hoạch", IsKey: false },
            { Required: false, Type: 0, Code: "TonTranfer", Name: "Tấn lấy", IsKey: false },
            { Required: false, Type: 0, Code: "CBMTranfer", Name: "Khối lấy", IsKey: false },
            { Required: false, Type: 0, Code: "QuantityTranfer", Name: "Số lượng lấy", IsKey: false },
            { Required: false, Type: 0, Code: "KgTranfer", Name: "Kg lấy", IsKey: false },
            { Required: false, Type: 0, Code: "TonBBGN", Name: "Tấn giao", IsKey: false },
            { Required: false, Type: 0, Code: "CBMBBGN", Name: "Khối giao", IsKey: false },
            { Required: false, Type: 0, Code: "QuantityBBGN", Name: "Số lượng giao", IsKey: false },
            { Required: false, Type: 0, Code: "KgBBGN", Name: "Kg giao", IsKey: false },
            { Required: false, Type: 0, Code: "Packing", Name: "Hàng hóa/Đơn vị tính", IsKey: false },
            { Required: false, Type: 0, Code: "VENLoadCode", Name: "Vendor bốc xếp lên", IsKey: false },
            { Required: false, Type: 0, Code: "VENUnLoadCode", Name: "Vendor bốc xếp xuống", IsKey: false },
            { Required: false, Type: 0, Code: "TonReturn", Name: "Tấn trả về", IsKey: false },
            { Required: false, Type: 0, Code: "CBMReturn", Name: "Khối trả về", IsKey: false },
            { Required: false, Type: 0, Code: "QuantityReturn", Name: "Số lượng trả về", IsKey: false },
            { Required: false, Type: 0, Code: "KgReturn", Name: "Kg trả về", IsKey: false },
            { Required: false, Type: 0, Code: "InvoiceReturnNote", Name: "Số chứng từ trả về", IsKey: false },
            { Required: false, Type: 0, Code: "InvoiceReturnDate", Name: "Ngày chứng từ trả về", IsKey: false },
            { Required: false, Type: 0, Code: "ReasonCancelNote", Name: "Ghi chú lí do", IsKey: false },
            { Required: false, Type: 0, Code: "RoutingCode", Name: "Mã cung đường", IsKey: false },
            { Required: true, Type: 0, Code: "TonManual", Name: "Tấn nhập tay", IsKey: false },
            { Required: true, Type: 0, Code: "CBMManual", Name: "Khối nhập tay", IsKey: false },
            { Required: true, Type: 0, Code: "QuantityManual", Name: "Số lượng nhập tay", IsKey: false },
            { Required: true, Type: 0, Code: "UnitPrice", Name: "Đơn giá", IsKey: false },
            { Required: true, Type: 0, Code: "Credit", Name: "Thu", IsKey: false },
            { Required: true, Type: 0, Code: "Debit", Name: "Chi", IsKey: false },
            { Required: true, Type: 0, Code: "ManualNote", Name: "Ghi chú nhập tay", IsKey: false },
        ],
        GridSelected: [
...
angular.module('myapp').controller('FINSettingManual_DetailCtrl', ['$rootScope', '$scope', '$http', '$location', '$state', '$timeout', '$stateParams', function ($rootScope, $scope, $http, $location, $state, $timeout, $stateParams) {
    Common.Log('FINSettingManual_DetailCtrl');
    $rootScope.IsLoading = false;

    _FINSettingManual_Detail.Param = $.extend(true, _FINSettingManual_Detail.Param, $state.params);
    ...
    // $scope.AllSettingGrid_Options.dataSource.data(_FINSettingManual_Detail.Data.GridAllSetting)
    ...
    $scope.change_key = function (data) {
        if (data.Code == "TonManual" || data.Code == "CBMManual" || data.Code == "QuantityManual" || data.Code == "UnitPrice" || data.Code == "Credit" || data.Code == "Debit" || data.Code == "ManualNote") {
            if (data.IsKey) {
    ...
    $scope.SelectedSettingGrid_Options.dataSource.data(_FINSettingManual_Detail.Data.GridSelected)
    ...
    $scope.Save_Click = function ($event) {
        ...
        if (!Common.HasValue($scope.Item.CustomerID) && $scope.Item.CustomerID <= 0) {
            ...
            var hasKey = false;
            var hasTan, hasCBM, hasQuantity, hasPrice, hasCredit, hasDebit, hasNote = false;
            Common.Data.Each(data, function (o) {
                if (o.Code != "" && o.Name != "") {
            ...
            if (!hasCredit || !hasDebit) {
                $rootScope.Message({ Msg: 'Thiếu cột thu hoặc chi', NotifyType: Common.Message.NotifyType.ERROR });
                hasError = true;
            }
            ...
            if (!hasError) {
                Common.Services.Call($http, {
                    ...
                    method: _FINSettingManual_Detail.URL.Save,
                    data: { item: ItemSend, id: _FINSettingManual_Detail.Param.id },
                    success: function (res) {
                        $rootScope.IsLoading = false;
                        $rootScope.Message({ Msg: 'Thành công', NotifyType: Common.Message.NotifyType.SUCCESS });
                        $state.go("main.FINManualFix.SettingIndex")
                    },
                    error: function (res) {
                        $rootScope.IsLoading = false;
                    }
    ...
    Common.Services.Call($http, {
        url: Common.Services.url.FIN,
        method: _FINSettingManual_Detail.URL.Get,
        data: { id: _FINSettingManual_Detail.Param.id },
        success: function (res) {
            $scope.Item = res;
            if (_FINSettingManual_Detail.Param.id <= 0)
                $scope.Item.RowStart = 2;

            var dataAll = [];
            var dataSource = $scope.SelectedSettingGrid.dataSource;

            var dataGridAllSetting = $.extend([], true, _FINSettingManual_Detail.Data.GridAllSetting)
