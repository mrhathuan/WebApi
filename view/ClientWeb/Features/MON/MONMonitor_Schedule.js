...
angular.module('myapp').controller('MONMonitor_ScheduleCtrl', ['$rootScope', '$scope', '$http', '$location', '$state', '$timeout', 'openMap', function ($rootScope, $scope, $http, $location, $state, $timeout, openMap) {
    Common.Log('MONMonitor_ScheduleCtrl');
