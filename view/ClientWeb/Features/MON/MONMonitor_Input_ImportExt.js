...
var _MONExt_Import = {
    URL: {
        Template_List: 'MONExtImport_Index_Setting_List',
        Template_Download: 'MONExtImport_Index_Setting_Download',
        Import: 'MONExtImport_Excel_Import',
        Check: 'MONExtImport_Excel_Check'
    },
    Data: {
        FromFile: [],
    },
...
angular.module('myapp').controller('MONMonitor_Input_ImportExtCtrl', ['$rootScope', '$scope', '$http', '$location', '$state', '$timeout', function ($rootScope, $scope, $http, $location, $state, $timeout) {
    Common.Log('MONMonitor_Input_ImportExtCtrl');
    ...
    $scope.excel_gridOptions = {
        ...
        columns: [
            ...
            {
                field: 'Ton', width: '100px', title: 'Tấn/kg', filterable: { cell: { operator: 'equal', showOperators: false } },
            },
            {
            ...
            {
                field: 'TonTranfer', width: '100px', title: 'Tấn/kg lấy', filterable: { cell: { operator: 'equal', showOperators: false } },
            },
            {
            ...
            {
                field: 'TonBBGN', width: '100px', title: 'Tấn/kg giao', filterable: { cell: { operator: 'equal', showOperators: false } },
            },
            {
            ...
            {
                field: 'TonReturn', width: '100px', title: 'Tấn/kg trả về', filterable: { cell: { operator: 'equal', showOperators: false } },
            },
            {
                field: 'CBMReturn', width: '100px', title: 'Khối trả về', filterable: { cell: { operator: 'equal', showOperators: false } },
            },
            {
                field: 'QuantityReturn', width: '100px', title: 'Số lượng trả về', filterable: { cell: { operator: 'equal', showOperators: false } },
            },
            {
        ...
        dataBound: function (e) {
            ...
            if (Common.HasValue(grid.tbody) && Common.HasValue(grid)) {
                ...
                Common.Data.Each(data, function (o) {
                    ...
                    if (o.IsDuplicate)
                        $('tr[data-uid="' + o.uid + '"] ').css({ "background-color": "#48BA52; color:white;" });
                })
            }
        }
    }
    ...
    $scope.datasys_gridOptions = {
        ...
        columns: [
            ...
            {
                field: 'Packing', width: '100px', title: 'Mã hàng hóa/Đơn vị tính', filterable: { cell: { operator: 'contains', showOperators: false } },
            },
            {
                field: 'PackingName', width: '100px', title: 'Tên hàng hóa/Đơn vị tính', filterable: { cell: { operator: 'contains', showOperators: false } },
            },
            {
                field: 'LocationFromCode', width: '100px', title: 'Mã kho', filterable: { cell: { operator: 'contains', showOperators: false } },
            },
    ...
    $scope.excel_template_gridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            ...
            method: _MONExt_Import.URL.Template_List,
            pageSize: 0,
            model: {
                id: 'SettingID',
                fields: {
    ...
    $scope.DownFile_Click = function ($event) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.MON,
            method: _MONExt_Import.URL.Template_Download,
            data: {
    ...
    $scope.Excel_Check = function () {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.MON,
            method: _MONExt_Import.URL.Check,
            data: {
            ...
            success: function (res) {
                ...
                Common.Services.Error(res, function (res) {
                    ...
                    _MONExt_Import.Data.FromFile = res;
    ...
    $scope.Import_Click = function ($event) {
        ...
        $.each(importData, function (i, item) {
            if (!item.ExcelSuccess) {
                ...
                _MONExt_Import.Data.FromFile[i].ID = item.ID.ID;
            }
        })
        ...
        if (errorID) {
            ...
            $rootScope.Message({
                ...
                Ok: function () {
                    $rootScope.IsLoading = true;
                    var data = _MONExt_Import.Data.FromFile;

                    Common.Services.Call($http, {
                        url: Common.Services.url.MON,
                        method: _MONExt_Import.URL.Import,
                        data: {
                            Data: data,
                            TemplateID: $scope.Template.ID,
                        },
