...
var _CUSSettingPODMapDetail = {
    URL: {
        Get: 'CUSSettingPODMap_Get',
        Save: 'CUSSettingPODMap_Save',
    },
    Data: {
        DataCustomer: [],
        DataTransport: [
        ...
        GridAllSetting: [
            ...
            { Required: false, Type: 0, Code: "OrderCode", Name: "Mã đơn hàng", IsKey: true },
            ...
            { Required: false, Type: 0, Code: "LocationToName", Name: "Điểm giao", IsKey: false },
            ...
            { Required: false, Type: 0, Code: "DistributorName", Name: "NPP", IsKey: false },
            ...
            { Required: false, Type: 0, Code: "Packing", Name: "Packing", IsKey: false },
            { Required: true, Type: 0, Code: "ShipmentNo", Name: "ShipmentNo", IsKey: false },
            { Required: true, Type: 0, Code: "InvoiceNo", Name: "Số chứng từ", IsKey: false },
            { Required: true, Type: 0, Code: "BillingNo", Name: "BillingNo", IsKey: false },
        ],
        GridSelected: [
...
angular.module('myapp').controller('CUSSettingPODMap_DetailCtrl', ['$rootScope', '$scope', '$http', '$location', '$state', '$timeout', '$stateParams', function ($rootScope, $scope, $http, $location, $state, $timeout, $stateParams) {
    Common.Log('CUSSettingPODMap_DetailCtrl');
    $rootScope.IsLoading = false;

    _CUSSettingPODMapDetail.Param = $.extend(true, _CUSSettingPODMapDetail.Param, $state.params);
    ...
    $scope.cboType_Options.dataSource.data(_CUSSettingPODMapDetail.Data.TypeTransport);
    ...
    // $scope.AllSettingGrid_Options.dataSource.data(_CUSSettingPODMapDetail.Data.GridAllSetting)
    ...
    $scope.SelectedSettingGrid_Options.dataSource.data(_CUSSettingPODMapDetail.Data.GridSelected)
        ...
        if (!Common.HasValue($scope.Item.CustomerID) && $scope.Item.CustomerID <= 0) {
            ...
            else
            {
                Common.Services.Call($http, {
                    ...
                    method: _CUSSettingPODMapDetail.URL.Save,
                    data: { item: ItemSend, id: _CUSSettingPODMapDetail.Param.id },
    ...
    Common.Services.Call($http, {
        url: Common.Services.url.CUS,
        method: _CUSSettingPODMapDetail.URL.Get,
        data: { id: _CUSSettingPODMapDetail.Param.id },
        success: function (res) {
            $scope.Item = res;
            if (_CUSSettingPODMapDetail.Param.id <= 0)
                $scope.Item.RowStart = 2;

            var dataAll = [];
            var dataSource = $scope.SelectedSettingGrid.dataSource;

            var dataGridAllSetting = $.extend([], true, _CUSSettingPODMapDetail.Data.GridAllSetting)
