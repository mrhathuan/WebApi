...
var _CUSContract_Price_DI_UnLoadPartner = {
    URL: {
        Get: 'CUSContract_Price_Get',
        Data: 'CUSContract_Price_Data',
        UnLoading_List: 'CUSPrice_DI_UnLoadPartner_Partner_List',
        UnLoading_Partner_NotIn_List: 'CUSPrice_DI_UnLoadPartner_Partner_PartnerNotIn_List',
        UnLoading_Partner_NotIn_SaveList: 'CUSPrice_DI_UnLoadPartner_Partner_PartnerNotIn_SaveList',
        UnLoading_Delete: 'CUSPrice_DI_UnLoad_Delete',
        UnLoading_SaveList: 'CUSPrice_DI_UnLoadPartner_Partner_SaveList',
        UnLoading_DeleteList: 'CUSPrice_DI_UnLoadPartner_Partner_DeleteList',
...
angular.module('myapp').controller('CUSContract_Price_DI_UnLoadPartnerCtrl', ['$rootScope', '$scope', '$http', '$location', '$state', '$timeout', '$stateParams', function ($rootScope, $scope, $http, $location, $state, $timeout, $stateParams) {
    Common.Log('CUSContract_Price_DI_UnLoadPartnerCtrl');
    $rootScope.IsLoading = false;

    $scope.Item = null;
    _CUSContract_Price_DI_UnLoadPartner.Params = $.extend({}, true, $state.params);

    Common.ALL.Get($http, {
        url: Common.ALL.URL.SYSVarPriceOfGOP,
        success: function (res) {
            _CUSContract_Price_DI_UnLoadPartner.Data.ListPriceOfGOP = res;
        }
    })
    ...
    Common.Services.Call($http, {
        ...
        method: _CUSContract_Price_DI_UnLoadPartner.URL.Data,
        data: { contractTermID: _CUSContract_Price_DI_UnLoadPartner.Params.TermID },
        success: function (res) {
            _CUSContract_Price_DI_UnLoadPartner.Data.ListGroupProduct = res.ListGroupOfProduct;
            Common.Services.Call($http, {
                url: Common.Services.url.CUS,
                method: _CUSContract_Price_DI_UnLoadPartner.URL.Get,
                data: { priceID: _CUSContract_Price_DI_UnLoadPartner.Params.PriceID },
                success: function (res) {
                    $scope.Item = res;
    ...
    $scope.Back_Click = function ($event) {
        ...
        $state.go("main.CUSContract.PriceDI", _CUSContract_Price_DI_UnLoadPartner.Params)
    }
    ...
    $scope.InitView_UnLoading = function () {
        ...
        for (var i = 0; i < _CUSContract_Price_DI_UnLoadPartner.Data.ListGroupProduct.length; i++) {
            var item = _CUSContract_Price_DI_UnLoadPartner.Data.ListGroupProduct[i];
                            ...
                            $('<input data-bind="value:' + options.field + '" />').appendTo(container)
                                .kendoComboBox({
                                    ...
                                    dataSource: Common.DataSource.Local({
                                        data: _CUSContract_Price_DI_UnLoadPartner.Data.ListPriceOfGOP,
                                        model: {
                                            id: 'ID',
                                            fields: {
                                                ID: { type: 'number' },
    ...
    $scope.LoadData_UnLoading = function () {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.CUS,
            method: _CUSContract_Price_DI_UnLoadPartner.URL.UnLoading_List,
            ...
            success: function (res) {
                Common.Services.Error(res, function (res) {
                    ...
                    for (var i = 0; i < res.length; i++) {
                        ...
                        for (var j = 0; j < _CUSContract_Price_DI_UnLoadPartner.Data.ListGroupProduct.length; j++) {

                            var gop = _CUSContract_Price_DI_UnLoadPartner.Data.ListGroupProduct[j];
                            var field = "F_" + gop.ID
    ...
    $scope.UnLoading_Delete_Click = function ($event, item, grid) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.CUS,
            method: _CUSContract_Price_DI_UnLoadPartner.URL.UnLoading_Delete,
            data: { ID: item.ID },
            success: function (res) {
    ...
    $scope.UnLoading_Update_Click = function ($event, grid) {
        ...
        for (var i = 0; i < dataSource.length; i++) {
            ...
            if (dataitem.dirty) {
                ...
                for (var j = 0; j < _CUSContract_Price_DI_UnLoadPartner.Data.ListGroupProduct.length; j++) {
                    var product = _CUSContract_Price_DI_UnLoadPartner.Data.ListGroupProduct[j];
        ...
        if (data.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.CUS,
                method: _CUSContract_Price_DI_UnLoadPartner.URL.UnLoading_SaveList,
                data: { data: data },
                success: function (res) {
                    $scope.LoadData_UnLoading();
    ...
    $scope.UnLoading_DeleteAll_Click = function ($event, grid) {
        ...
        $rootScope.Message({
            ...
            Ok: function () {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.CUS,
                    method: _CUSContract_Price_DI_UnLoadPartner.URL.UnLoading_DeleteList,
                    data: { data: data },
                    success: function (res) {
    ...
    $scope.unloading_partner_notin_gridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.CUS,
            method: _CUSContract_Price_DI_UnLoadPartner.URL.UnLoading_Partner_NotIn_List,
            readparam: function () {
                return {
    ...
    $scope.UnLoading_Partner_NotIn_Submit_Click = function ($event, grid, win) {
        ...
        if (data.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.CUS,
                method: _CUSContract_Price_DI_UnLoadPartner.URL.UnLoading_Partner_NotIn_SaveList,
    ...
    $scope.Excel_Click = function ($event, win) {
        ...
        $rootScope.UploadExcel({
            ...
            Download: function () {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.CUS,
                    method: _CUSContract_Price_DI_UnLoadPartner.URL.Excel_Export,
                    data: { contractTermID: _CUSContract_Price_DI_UnLoadPartner.Params.TermID, priceID: _CUSContract_Price_DI_UnLoadPartner.Params.PriceID },
                    success: function (res) {
                        $rootScope.IsLoading = false;
            ...
            Upload: function (e, callback) {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.CUS,
                    method: _CUSContract_Price_DI_UnLoadPartner.URL.Excel_Check,
                    data: { file: e, contractTermID: _CUSContract_Price_DI_UnLoadPartner.Params.TermID, priceID: _CUSContract_Price_DI_UnLoadPartner.Params.PriceID },
            ...
            Complete: function (e, data) {
                if (!$scope.Item.TermClosed) {
                    ...
                    Common.Services.Call($http, {
                        url: Common.Services.url.CUS,
                        method: _CUSContract_Price_DI_UnLoadPartner.URL.Excel_Save,
                        data: { lst: data, priceID: _CUSContract_Price_DI_UnLoadPartner.Params.PriceID },
                        success: function (res) {
                            $rootScope.Message({
                                Msg: 'Đã cập nhật.',
