...
var _CUSContract_Price_DI_LoadRoute = {
    URL: {
        Get: 'CUSContract_Price_Get',
        Data: 'CUSContract_Price_Data',


        Loading_List: 'CUSPrice_DI_LoadRoute_List',
        Loading_Delete: 'CUSPrice_DI_Load_Delete',
        Loading_SaveList: 'CUSPrice_DI_LoadRoute_SaveList',
        Loading_DeleteList: 'CUSPrice_DI_Load_DeleteList',
        Loading_Location_NotIn_List: 'CUSPrice_DI_LoadRoute_RouteNotIn_List',
        Loading_Location_NotIn_SaveList: 'CUSPrice_DI_LoadRoute_RouteNotIn_SaveList',

        Excel_Export: "CUSPrice_DI_LoadRoute_ExcelExport",
        Excel_Check: "CUSPrice_DI_LoadRoute_ExcelCheck",
        Excel_Save: "CUSPrice_DI_LoadRoute_Import",
...
angular.module('myapp').controller('CUSContract_Price_DI_LoadRouteCtrl', ['$rootScope', '$scope', '$http', '$location', '$state', '$timeout', '$stateParams', function ($rootScope, $scope, $http, $location, $state, $timeout, $stateParams) {
    Common.Log('CUSContract_Price_DI_LoadRouteCtrl');
    $rootScope.IsLoading = false;

    $scope.Item = null;
    _CUSContract_Price_DI_LoadRoute.Params = $.extend({}, true, $state.params);
    ...
    Common.ALL.Get($http, {
        ...
        success: function (res) {
            _CUSContract_Price_DI_LoadRoute.Data.ListPriceOfGOP = res;
        }
    })
        ...
        $rootScope.UploadExcel({
            ...
            Download: function () {
                ...
                Common.Services.Call($http, {
                    ...
                    method: _CUSContract_Price_DI_LoadRoute.URL.Excel_Export,
                    data: { contractTermID: _CUSContract_Price_DI_LoadRoute.Params.TermID, priceID: _CUSContract_Price_DI_LoadRoute.Params.PriceID },
                    success: function (res) {
                        $rootScope.IsLoading = false;
            ...
            Upload: function (e, callback) {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.CUS,
                    method: _CUSContract_Price_DI_LoadRoute.URL.Excel_Check,
                    data: { file: e, contractTermID: _CUSContract_Price_DI_LoadRoute.Params.TermID, priceID: _CUSContract_Price_DI_LoadRoute.Params.PriceID },
            ...
            Complete: function (e, data) {
                if (!$scope.Item.TermClosed) {
                    ...
                    Common.Services.Call($http, {
                        url: Common.Services.url.CUS,
                        method: _CUSContract_Price_DI_LoadRoute.URL.Excel_Save,
                        data: { lst: data, priceID: _CUSContract_Price_DI_LoadRoute.Params.PriceID },
                        success: function (res) {
                            $rootScope.Message({
                                Msg: 'Đã cập nhật.',
    ...
    Common.Services.Call($http, {
        url: Common.Services.url.CUS,
        method: _CUSContract_Price_DI_LoadRoute.URL.Data,
        data: { contractTermID: _CUSContract_Price_DI_LoadRoute.Params.TermID },
        success: function (res) {
            _CUSContract_Price_DI_LoadRoute.Data.ListGroupProduct = res.ListGroupOfProduct;

            Common.Services.Call($http, {
                url: Common.Services.url.CUS,
                method: _CUSContract_Price_DI_LoadRoute.URL.Get,
                data: { priceID: _CUSContract_Price_DI_LoadRoute.Params.PriceID },
                success: function (res) {
                    $scope.Item = res;
    ...
    $scope.Back_Click = function ($event) {
        ...
        $state.go("main.CUSContract.PriceDI", _CUSContract_Price_DI_LoadRoute.Params)
    }
    ...
    $scope.InitView_Loading = function () {
        ...
        for (var i = 0; i < _CUSContract_Price_DI_LoadRoute.Data.ListGroupProduct.length; i++) {
            var item = _CUSContract_Price_DI_LoadRoute.Data.ListGroupProduct[i];
                            ...
                            $('<input data-bind="value:' + options.field + '" />').appendTo(container)
                                .kendoComboBox({
                                    ...
                                    dataSource: Common.DataSource.Local({
                                        data: _CUSContract_Price_DI_LoadRoute.Data.ListPriceOfGOP,
                                        model: {
                                            id: 'ID',
                                            fields: {
                                                ID: { type: 'number' },
    ...
    $scope.Loading_Delete_Click = function ($event, item, grid) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.CUS,
            method: _CUSContract_Price_DI_LoadRoute.URL.Loading_Delete,
            data: { ID: item.ID },
            success: function (res) {
    ...
    $scope.Loading_DeleteAll_Click = function ($event, grid) {
        ...
        $rootScope.Message({
            ...
            Ok: function () {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.CUS,
                    method: _CUSContract_Price_DI_LoadRoute.URL.Loading_DeleteList,
                    data: { data: data },
                    success: function (res) {
    ...
    $scope.Loading_Location_NotIn_Submit_Click = function ($event, grid, win) {
        ...
        if (data.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.CUS,
                method: _CUSContract_Price_DI_LoadRoute.URL.Loading_Location_NotIn_SaveList,
    ...
    $scope.Loading_Update_Click = function ($event, grid) {
        ...
        for (var i = 0; i < dataSource.length; i++) {
            ...
            if (dataitem.dirty) {
                ...
                for (var j = 0; j < _CUSContract_Price_DI_LoadRoute.Data.ListGroupProduct.length; j++) {
                    var product = _CUSContract_Price_DI_LoadRoute.Data.ListGroupProduct[j];
        ...
        if (data.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.CUS,
                method: _CUSContract_Price_DI_LoadRoute.URL.Loading_SaveList,
                data: { data: data },
                success: function (res) {
                    $scope.LoadData_Loading();
                    $rootScope.Message({ Msg: "Đã cập nhật!" });
    ...
    $scope.LoadData_Loading = function () {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.CUS,
            method: _CUSContract_Price_DI_LoadRoute.URL.Loading_List,
                ...
                Common.Services.Error(res, function (res) {
                    ...
                    for (var i = 0; i < res.length; i++) {
                        ...
                        for (var j = 0; j < _CUSContract_Price_DI_LoadRoute.Data.ListGroupProduct.length; j++) {
                            ...
                            var gop = _CUSContract_Price_DI_LoadRoute.Data.ListGroupProduct[j];
                            var field = "F_" + gop.ID
    ...
    $scope.loading_location_notin_gridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.CUS,
            method: _CUSContract_Price_DI_LoadRoute.URL.Loading_Location_NotIn_List,
            readparam: function () {
                return {
