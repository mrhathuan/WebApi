...
var _CUSContract_Price_DI_Ex = {
    URL: {
        //#region price ex
        PriceEx_Get: 'CUSPrice_DI_Ex_Get',
        PriceEx_Save: 'CUSPrice_DI_Ex_Save',

        PriceEx_GroupLocation_List: 'CUSPrice_DI_Ex_GroupLocation_List',
        PriceEx_GroupLocation_Delete: 'CUSPrice_DI_Ex_GroupLocation_DeleteList',
        PriceEx_GroupLocation_Save: 'CUSPrice_DI_Ex_GroupLocation_SaveList',
        PriceEx_GroupLocation_NotInList: 'CUSPrice_DI_Ex_GroupLocation_GroupNotInList',

        PriceEx_GroupProduct_List: 'CUSPrice_DI_Ex_GroupProduct_List',
        PriceEx_GroupProduct_Delete: 'CUSPrice_DI_Ex_GroupProduct_DeleteList',
        PriceEx_GroupProduct_Save: 'CUSPrice_DI_Ex_GroupProduct_Save',
        PriceEx_GroupProduct_Get: 'CUSPrice_DI_Ex_GroupProduct_Get',
        PriceEx_GroupProduct_GOPList: 'CUSPrice_DI_Ex_GroupProduct_GOPList',

        PriceEx_Location_List: 'CUSPrice_DI_Ex_Location_List',
        PriceEx_Location_Delete: 'CUSPrice_DI_Ex_Location_DeleteList',
        PriceEx_Location_Save: 'CUSPrice_DI_Ex_Location_Save',
        PriceEx_Location_Get: 'CUSPrice_DI_Ex_Location_Get',
        PriceEx_Location_NotInSave: 'CUSPrice_DI_Ex_Location_LocationNotInSaveList',
        PriceEx_Location_NotInList: 'CUSPrice_DI_Ex_Location_LocationNotInList',

        PriceEx_Route_List: 'CUSPrice_DI_Ex_Route_List',
        PriceEx_Route_Delete: 'CUSPrice_DI_Ex_Route_DeleteList',
        PriceEx_Route_Save: 'CUSPrice_DI_Ex_Route_SaveList',
        PriceEx_Route_NotInList: 'CUSPrice_DI_Ex_Route_RouteNotInList',

        PriceEx_ParentRoute_List: 'CUSPrice_DI_Ex_ParentRoute_List',
        PriceEx_ParentRoute_Delete: 'CUSPrice_DI_Ex_ParentRoute_DeleteList',
        PriceEx_ParentRoute_Save: 'CUSPrice_DI_Ex_ParentRoute_SaveList',
        PriceEx_ParentRoute_NotInList: 'CUSPrice_DI_Ex_ParentRoute_RouteNotInList',
       
        PriceEx_Parent_List: 'CUSPrice_DI_Ex_Partner_List',
        PriceEx_Parent_Delete: 'CUSPrice_DI_Ex_Partner_DeleteList',
        PriceEx_Parent_Save: 'CUSPrice_DI_Ex_Partner_SaveList',
        PriceEx_Parent_NotInList: 'CUSPrice_DI_Ex_Partner_PartnerNotInList',

        PriceMOQ_Province_List: 'CUSPrice_DI_Ex_Province_List',
        PriceMOQ_Province_Delete: 'CUSPrice_DI_Ex_Province_DeleteList',
        PriceMOQ_Province_Save: 'CUSPrice_DI_Ex_Province_SaveList',
        PriceMOQ_Province_NotInList: 'CUSPrice_DI_Ex_Province_NotInList',
        //#endregion
    },
    Data: {
    },
...
angular.module('myapp').controller('CUSContract_Price_DI_ExCtrl', ['$rootScope', '$scope', '$http', '$location', '$state', '$timeout', '$stateParams', function ($rootScope, $scope, $http, $location, $state, $timeout, $stateParams) {
    Common.Log('CUSContract_Price_DI_ExCtrl');
    $rootScope.IsLoading = false;

    _CUSContract_Price_DI_Ex.Params = $.extend({}, true, $state.params);
    ...
    Common.Services.Call($http, {
        ...
        method: _CUSContract_Price_DI_Ex.URL.PriceEx_Get,
        data: { id: _CUSContract_Price_DI_Ex.Params.PriceIDEx },
    ...
    $scope.priceEX_SaveInfo_Click = function ($event, vform) {
        ...
        if (vform()) {
            if ($scope.ItemPriceEx.TypeOfPriceDIExID > 0 && $scope.ItemPriceEx.DIExSumID > 0) {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.CUS,
                    method: _CUSContract_Price_DI_Ex.URL.PriceEx_Save,
                    data: { priceID: _CUSContract_Price_DI_Ex.Params.PriceID, item: $scope.ItemPriceEx },
                    success: function (res) {
                        Common.Services.Call($http, {
                            url: Common.Services.url.CUS,
                            method: _CUSContract_Price_DI_Ex.URL.PriceEx_Get,
    ...
    $scope.priceEx_GroupLocation_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.CUS,
            method: _CUSContract_Price_DI_Ex.URL.PriceEx_GroupLocation_List,
    ...
    $scope.priceEx_GroupLocation_Delete = function ($event, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.CUS,
                method: _CUSContract_Price_DI_Ex.URL.PriceEx_GroupLocation_Delete,
                data: { lst: datasend },
                success: function (res) {
                    $rootScope.IsLoading = false;
                    $scope.priceEx_GroupLocation_GridOptions.dataSource.read();
    ...
    $scope.price_ex_GroupNotIn_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.CUS,
            method: _CUSContract_Price_DI_Ex.URL.PriceEx_GroupLocation_NotInList,
            readparam: function () { return { priceExID: $scope.ItemPriceEx.ID } },
            model: {
                id: 'ID',
                fields: {
    ...
    $scope.price_ex_GroupNotIn_Save_Click = function ($event, win, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.CUS,
                method: _CUSContract_Price_DI_Ex.URL.PriceEx_GroupLocation_Save,
    ...
    $scope.priceEx_Route_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.CUS,
            method: _CUSContract_Price_DI_Ex.URL.PriceEx_Route_List,
            readparam: function () { return { priceExID: $scope.ItemPriceEx.ID } },
            model: {
                id: 'ID',
                fields: {
    ...
    $scope.price_ex_RouteNotIn_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.CUS,
            method: _CUSContract_Price_DI_Ex.URL.PriceEx_Route_NotInList,
            readparam: function () { return { priceExID: $scope.ItemPriceEx.ID, contractTermID: _CUSContract_Price_DI_Ex.Params.TermID } },
            model: {
                id: 'ID',
                fields: {
                    ID: { type: 'number', editable: false, nullable: true },
    ...
    $scope.price_ex_RouteNotIn_Save_Click = function ($event, win, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.CUS,
                method: _CUSContract_Price_DI_Ex.URL.PriceEx_Route_Save,
                data: { priceExID: $scope.ItemPriceEx.ID, lst: datasend },
                success: function (res) {
                    $rootScope.IsLoading = false;
                    $scope.priceEx_Route_GridOptions.dataSource.read();
    ...
    $scope.priceEx_Route_Delete = function ($event, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.CUS,
                method: _CUSContract_Price_DI_Ex.URL.PriceEx_Route_Delete,
                data: { lst: datasend },
                success: function (res) {
                    $rootScope.IsLoading = false;
                    $scope.priceEx_Route_GridOptions.dataSource.read();
    ...
    $scope.priceEx_GroupProduct_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.CUS,
            method: _CUSContract_Price_DI_Ex.URL.PriceEx_GroupProduct_List,
            readparam: function () { return { priceExID: $scope.ItemPriceEx.ID } },
            model: {
                id: 'ID',
                fields: {
    ...
    $scope.GOPLoadItem = function (id, win, vform) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.CUS,
            method: _CUSContract_Price_DI_Ex.URL.PriceEx_GroupProduct_Get,
            data: { id: id, cusID: _CUSContract_Price_DI_Ex.Params.CustomerID },
            success: function (res) {
                $rootScope.IsLoading = false;
    ...
    $scope.priceEx_GroupProduct_GridDestroy_Click = function ($event, data) {
        ...
        if (lst.length > 0) {
            Common.Services.Call($http, {
                url: Common.Services.url.CUS,
                method: _CUSContract_Price_DI_Ex.URL.PriceEx_GroupProduct_Delete,
                data: { lst: lst },
                success: function (res) {
                    $rootScope.IsLoading = false;
                    $scope.priceEx_GroupProduct_GridOptions.dataSource.read();
    ...
    $scope.price_ex_GOP_Save_Click = function ($event, win, vform) {
        ...
        if (vform()) {
            if ($scope.ItemPriceExGOP.GroupOfProductID > 0) {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.CUS,
                    method: _CUSContract_Price_DI_Ex.URL.PriceEx_GroupProduct_Save,
    ...
    Common.Services.Call($http, {
        url: Common.Services.url.CUS,
        method: _CUSContract_Price_DI_Ex.URL.PriceEx_GroupProduct_GOPList,
        data: { cusID: _CUSContract_Price_DI_Ex.Params.CustomerID },
        success: function (res) {
    ...
    $scope.priceEx_Location_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.CUS,
            method: _CUSContract_Price_DI_Ex.URL.PriceEx_Location_List,
            readparam: function () { return { priceExID: $scope.ItemPriceEx.ID } },
            model: {
                id: 'ID',
                fields: {
    ...
    $scope.priceEx_Location_Delete = function ($event, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.CUS,
                method: _CUSContract_Price_DI_Ex.URL.PriceEx_Location_Delete,
                data: { lst: datasend },
                success: function (res) {
                    $rootScope.IsLoading = false;
                    $scope.priceEx_Location_GridOptions.dataSource.read();
    ...
    $scope.price_ex_LocationNotIn_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.CUS,
            method: _CUSContract_Price_DI_Ex.URL.PriceEx_Location_NotInList,
            readparam: function () { return { priceExID: $scope.ItemPriceEx.ID, customerID: _CUSContract_Price_DI_Ex.Params.CustomerID } },
            model: {
                id: 'ID',
                fields: {
                    ID: { type: 'number', editable: false, nullable: true },
    ...
    $scope.price_ex_LocationNotIn_Save_Click = function ($event, win, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.CUS,
                method: _CUSContract_Price_DI_Ex.URL.PriceEx_Location_NotInSave,
                data: { priceExID: $scope.ItemPriceEx.ID, lst: datasend },
                success: function (res) {
                    $rootScope.IsLoading = false;
                    $scope.priceEx_Location_GridOptions.dataSource.read();
    ...
    $scope.priceEx_Location_GridEdit_Click = function ($event, win, data) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.CUS,
            method: _CUSContract_Price_DI_Ex.URL.PriceEx_Location_Get,
            data: { id: data.ID },
            success: function (res) {
                $rootScope.IsLoading = false;
    ...
    $scope.price_ex_Location_Save_Click = function ($event, win) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.CUS,
            method: _CUSContract_Price_DI_Ex.URL.PriceEx_Location_Save,
    ...
    $scope.priceEx_ParentRoute_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.CUS,
            method: _CUSContract_Price_DI_Ex.URL.PriceEx_ParentRoute_List,
            readparam: function () { return { priceExID: $scope.ItemPriceEx.ID } },
            model: {
                id: 'ID',
                fields: {
    ...
    $scope.price_ex_ParentRouteNotIn_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.CUS,
            method: _CUSContract_Price_DI_Ex.URL.PriceEx_ParentRoute_NotInList,
            readparam: function () { return { priceExID: $scope.ItemPriceEx.ID, contractTermID: _CUSContract_Price_DI_Ex.Params.TermID } },
            model: {
                id: 'ID',
                fields: {
    ...
    $scope.price_exParent_RouteNotIn_Save_Click = function ($event, win, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.CUS,
                method: _CUSContract_Price_DI_Ex.URL.PriceEx_ParentRoute_Save,
                data: { priceExID: $scope.ItemPriceEx.ID, lst: datasend },
                success: function (res) {
                    $rootScope.IsLoading = false;
                    $scope.priceEx_ParentRoute_GridOptions.dataSource.read();
    ...
    $scope.priceEx_ParentRoute_Delete = function ($event, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.CUS,
                method: _CUSContract_Price_DI_Ex.URL.PriceEx_ParentRoute_Delete,
                data: { lst: datasend },
                success: function (res) {
                    $rootScope.IsLoading = false;
                    $scope.priceEx_ParentRoute_GridOptions.dataSource.read();
    ...
    $scope.priceEx_Parent_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.CUS,
            method: _CUSContract_Price_DI_Ex.URL.PriceEx_Parent_List,
            readparam: function () { return { priceExID: $scope.ItemPriceEx.ID } },
            model: {
                id: 'ID',
                fields: {
    ...
    $scope.price_ex_ParentNotIn_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.CUS,
            method: _CUSContract_Price_DI_Ex.URL.PriceEx_Parent_NotInList,
            readparam: function () { return { priceExID: $scope.ItemPriceEx.ID, contractTermID: _CUSContract_Price_DI_Ex.Params.TermID, CustomerID: _CUSContract_Price_DI_Ex.Params.CustomerID } },
            model: {
                id: 'ID',
                fields: {
                    ID: { type: 'number', editable: false, nullable: true },
    ...
    $scope.price_exParent_NotIn_Save_Click = function ($event, win, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.CUS,
                method: _CUSContract_Price_DI_Ex.URL.PriceEx_Parent_Save,
                data: { priceExID: $scope.ItemPriceEx.ID, lst: datasend },
                success: function (res) {
                    $rootScope.IsLoading = false;
                    $scope.priceEx_Parent_GridOptions.dataSource.read();
    ...
    $scope.priceEx_Parent_Delete = function ($event, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.CUS,
                method: _CUSContract_Price_DI_Ex.URL.PriceEx_Parent_Delete,
                data: { lst: datasend },
                success: function (res) {
                    $rootScope.IsLoading = false;
                    $scope.priceEx_Parent_GridOptions.dataSource.read();
    ...
    $scope.Back_Click = function ($event) {
        ...
        $state.go("main.CUSContract.PriceDI", _CUSContract_Price_DI_Ex.Params)
    }
    ...
    $scope.priceEx_Province_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.CUS,
            method: _CUSContract_Price_DI_Ex.URL.PriceMOQ_Province_List,
            readparam: function () { return { priceExID: $scope.ItemPriceEx.ID } },
            model: {
                id: 'ID',
                fields: {
    ...
    $scope.price_ex_ProvinceNotIn_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.CUS,
            method: _CUSContract_Price_DI_Ex.URL.PriceMOQ_Province_NotInList,
            readparam: function () { return { priceExID: $scope.ItemPriceEx.ID, contractTermID: _CUSContract_Price_DI_Ex.Params.TermID, CustomerID: _CUSContract_Price_DI_Ex.Params.CustomerID } },
            model: {
                id: 'ID',
                fields: {
    ...
    $scope.price_exProvince_NotIn_Save_Click = function ($event, win, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.CUS,
                method: _CUSContract_Price_DI_Ex.URL.PriceMOQ_Province_Save,
                data: { priceExID: $scope.ItemPriceEx.ID, lst: datasend },
                success: function (res) {
                    $rootScope.IsLoading = false;
                    $scope.priceEx_Province_GridOptions.dataSource.read();
    ...
    $scope.priceEx_Province_Delete = function ($event, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.CUS,
                method: _CUSContract_Price_DI_Ex.URL.PriceMOQ_Province_Delete,
                data: { lst: datasend },
                success: function (res) {
                    $rootScope.IsLoading = false;
                    $scope.priceEx_Province_GridOptions.dataSource.read();
