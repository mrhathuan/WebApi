...
var _CUSContract_PriceDI_PriceNormal = {
    URL: {
        Get: 'CUSContract_Price_Get',

        Data: 'CUSContract_Price_Data',

        GroupVehicle_GetData: 'CUSPrice_DI_GroupVehicle_GetData',
        GroupVehicle_SaveList: 'CUSPrice_DI_GroupVehicle_SaveList',

        GroupVehicle_Export: 'CUSPrice_DI_GroupVehicle_ExcelExport',
        GroupVehicle_Check: 'CUSPrice_DI_GroupVehicle_ExcelCheck',
        GroupVehicle_Import: 'CUSPrice_DI_GroupVehicle_ExcelImport',

        GroupProduct_Data: 'CUSPrice_DI_GroupProduct_Data',
        GroupProduct_SaveList: 'CUSPrice_DI_GroupProduct_SaveList',

        GroupProduct_Export: 'CUSPrice_DI_GroupProduct_Export',
        GroupProduct_Check: 'CUSPrice_DI_GroupProduct_Check',
        GroupProduct_Import: 'CUSPrice_DI_GroupProduct_Import',

        ExcelInit: 'CUSPrice_DI_GroupProduct_ExcelInit',
        ExcelChange: 'CUSPrice_DI_GroupProduct_ExcelChange',
        ExcelImport: 'CUSPrice_DI_GroupProduct_ExcelOnImport',
        ExcelApprove: 'CUSPrice_DI_GroupProduct_ExcelApprove',

        GroupVehicle_ExcelInit: 'CUSPrice_DI_GroupVehicle_ExcelInit',
        GroupVehicle_ExcelChange: 'CUSPrice_DI_GroupVehicle_ExcelChange',
        GroupVehicle_ExcelImport: 'CUSPrice_DI_GroupVehicle_ExcelOnImport',
        GroupVehicle_ExcelApprove: 'CUSPrice_DI_GroupVehicle_ExcelApprove',
    },
    Data: {
...
angular.module('myapp').controller('CUSContract_Price_DI_PriceNormalCtrl', ['$rootScope', '$scope', '$http', '$location', '$state', '$timeout', '$stateParams', function ($rootScope, $scope, $http, $location, $state, $timeout, $stateParams) {
    Common.Log('CUSContract_Price_DI_PriceNormalCtrl');
    $rootScope.IsLoading = false;

    $scope.Item = null;
    _CUSContract_PriceDI_PriceNormal.Params = $.extend(true, _CUSContract_PriceDI_PriceNormal.Params, $state.params);
    ...
    Common.Services.Call($http, {
        ...
        method: _CUSContract_PriceDI_PriceNormal.URL.Data,
        data: { contractTermID: _CUSContract_PriceDI_PriceNormal.Params.TermID },
        success: function (res) {
            _CUSContract_PriceDI_PriceNormal.Data.ListGroupVehicle = res.ListGroupOfVehicle;
            _CUSContract_PriceDI_PriceNormal.Data.ListGroupProduct = res.ListGroupOfProduct;
            _CUSContract_PriceDI_PriceNormal.Data.ListRouting = res.ListRouting;

            Common.Services.Call($http, {
                url: Common.Services.url.CUS,
                method: _CUSContract_PriceDI_PriceNormal.URL.Get,
                data: { priceID: _CUSContract_PriceDI_PriceNormal.Params.PriceID },
                success: function (res) {
                    $scope.Item = res;
    ...
    $scope.Back_Click = function ($event) {
        ...
        $state.go("main.CUSContract.Term", { TermID: _CUSContract_PriceDI_PriceNormal.Params.TermID, ContractID: $scope.Item.ContractID })
    }
    ...
    $scope.InitView_GroupVehicle = function (isframe) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.CUS,
            method: _CUSContract_PriceDI_PriceNormal.URL.GroupVehicle_GetData,
            data: { priceID: _CUSContract_PriceDI_PriceNormal.Params.PriceID },
            success: function (res) {
                var Model = {
                    id: 'RouteID',
                ...
                if (isframe) {//hợp đồng khung
                    Common.Data.Each(_CUSContract_PriceDI_PriceNormal.Data.ListGroupVehicle, function (gov) {
                        var listCol = [];
                ...
                var dataGrid = [];
                if (isframe) {
                    Common.Data.Each(_CUSContract_PriceDI_PriceNormal.Data.ListRouting, function (route) {
                        var item = {};
                        item["RuoteCode"] = route.Code;
                        item["RuoteName"] = route.RoutingName;
                        item["RouteID"] = route.ID;
                        item["SortOrder"] = route.SortOrder;
                        Common.Data.Each(_CUSContract_PriceDI_PriceNormal.Data.ListGroupVehicle, function (level) {
    ...
    $scope.GroupVehicle_Excel_Click = function ($event, win) {
        $rootScope.UploadExcel({
            ...
            Download: function () {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.CUS,
                    method: _CUSContract_PriceDI_PriceNormal.URL.GroupVehicle_Export,
                    data: { priceID: _CUSContract_PriceDI_PriceNormal.Params.PriceID, contractTermID: _CUSContract_PriceDI_PriceNormal.Params.TermID, isFrame: $scope.IsFrame },
                    success: function (res) {
                        $rootScope.IsLoading = false;
            ...
            Upload: function (e, callback) {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.CUS,
                    method: _CUSContract_PriceDI_PriceNormal.URL.GroupVehicle_Check,
                    data: { file: e, priceID: _CUSContract_PriceDI_PriceNormal.Params.PriceID, contractTermID: _CUSContract_PriceDI_PriceNormal.Params.TermID, isFrame: $scope.IsFrame },
            ...
            Complete: function (e, data) {
                if (!$scope.Item.TermClosed) {
                    ...
                    Common.Services.Call($http, {
                        url: Common.Services.url.CUS,
                        method: _CUSContract_PriceDI_PriceNormal.URL.GroupVehicle_Import,
                        data: { lst: data, priceID: _CUSContract_PriceDI_PriceNormal.Params.PriceID, contractTermID: _CUSContract_PriceDI_PriceNormal.Params.TermID },
                        success: function (res) {
                            $rootScope.IsLoading = false;
    ...
    $scope.GroupVehicle_Save_Click = function ($event, grid) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.CUS,
            method: _CUSContract_PriceDI_PriceNormal.URL.GroupVehicle_SaveList,
            data: { data: dataSave, priceID: _CUSContract_PriceDI_PriceNormal.Params.PriceID },
            success: function (res) {
                $scope.InitView_GroupVehicle($scope.IsFrame);
                $rootScope.IsLoading = false;
                $rootScope.Message({ Msg: 'Thành công', NotifyType: Common.Message.NotifyType.SUCCESS });
    ...
    $scope.InitView_GroupProduct = function (isframe) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.CUS,
            method: _CUSContract_PriceDI_PriceNormal.URL.GroupProduct_Data,
            data: { priceID: _CUSContract_PriceDI_PriceNormal.Params.PriceID },
            success: function (res) {
                var Model = {
                    id: "RouteID",
                ...
                if (isframe) {//hợp đồng khung
                    Common.Data.Each(_CUSContract_PriceDI_PriceNormal.Data.ListGroupProduct, function (gop) {
                        var listCol = [];
                    ...
                    Common.Data.Each(_CUSContract_PriceDI_PriceNormal.Data.ListGroupProduct, function (gov) {
                        var listCol = [];
                        var field = "L" + gov.ID;
                        Model.fields[field] = { type: "number", editable: true };
                        GridColumn.push({
                ...
                if (isframe) {
                    Common.Data.Each(_CUSContract_PriceDI_PriceNormal.Data.ListRouting, function (route) {
                        ...
                        item["SortOrder"] = route.SortOrder;
                        Common.Data.Each(_CUSContract_PriceDI_PriceNormal.Data.ListGroupProduct, function (level) {
                            var fieldMax = "L" + level.ID + "MAX";
                            var fieldMin = "L" + level.ID + "MIN";
                            item[fieldMax] = 0;
                            item[fieldMin] = 0;
    ...
    $scope.GroupProduct_SaveChanges_Click = function ($event, grid) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.CUS,
            method: _CUSContract_PriceDI_PriceNormal.URL.GroupProduct_SaveList,
            data: { data: dataSave, priceID: _CUSContract_PriceDI_PriceNormal.Params.PriceID },
            success: function (res) {
    ...
    $scope.GroupProduct_Excel_Click = function ($event, grid, win) {
        ...
        $rootScope.UploadExcel({
            ...
            Download: function () {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.CUS,
                    method: _CUSContract_PriceDI_PriceNormal.URL.GroupProduct_Export,
                    data: { priceID: _CUSContract_PriceDI_PriceNormal.Params.PriceID, isFrame: $scope.IsFrame },
                    success: function (res) {
                        $rootScope.DownloadFile(res);
                        $rootScope.IsLoading = false;
                    },
            ...
            Upload: function (e, callback) {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.CUS,
                    method: _CUSContract_PriceDI_PriceNormal.URL.GroupProduct_Check,
                    data: { file: e.FilePath, priceID: _CUSContract_PriceDI_PriceNormal.Params.PriceID, isFrame: $scope.IsFrame },
                    success: function (data) {
                        callback(data);
                        $rootScope.IsLoading = false;
                    },
            ...
            Complete: function (e, data) {
                if (!$scope.Item.TermClosed) {
                    ...
                    Common.Services.Call($http, {
                        url: Common.Services.url.CUS,
                        method: _CUSContract_PriceDI_PriceNormal.URL.GroupProduct_Import,
                        data: { data: data, priceID: _CUSContract_PriceDI_PriceNormal.Params.PriceID },
                        success: function (res) {
                            $rootScope.IsLoading = false;
    ...
    $scope.GroupVehicle_ExcelOn_Click = function ($event) {
        ...
        $rootScope.excelShare.Init({
            ...
            params: {
                priceID: _CUSContract_PriceDI_PriceNormal.Params.PriceID,
                contractTermID: _CUSContract_PriceDI_PriceNormal.Params.TermID,
                isFrame: $scope.IsFrame
            },
            rowStart: 1,
            colCheckChange: 6,
            url: Common.Services.url.CUS,
            methodInit: _CUSContract_PriceDI_PriceNormal.URL.GroupVehicle_ExcelInit,
            methodChange: _CUSContract_PriceDI_PriceNormal.URL.GroupVehicle_ExcelChange,
            methodImport: _CUSContract_PriceDI_PriceNormal.URL.GroupVehicle_ExcelImport,
            methodApprove: _CUSContract_PriceDI_PriceNormal.URL.GroupVehicle_ExcelApprove,
    ...
    $scope.GroupProduct_ExcelOn_Click = function ($event) {
        ...
        $rootScope.excelShare.Init({
            ...
            colCheckChange: 6,
            url: Common.Services.url.CUS,
            methodInit: _CUSContract_PriceDI_PriceNormal.URL.ExcelInit,
            methodChange: _CUSContract_PriceDI_PriceNormal.URL.ExcelChange,
            methodImport: _CUSContract_PriceDI_PriceNormal.URL.ExcelImport,
            methodApprove: _CUSContract_PriceDI_PriceNormal.URL.ExcelApprove,
            lstMessageError: lstMessageError,
            Changed: function () {
