...
var _CUSSettingORDPlanDetail = {
    ...
    Data: {
        ...
        GridAllSetting: [
            ...
            { GOPID: -1, ProductID: -1, Required: true, Type: 0, StockID: 0, IsStock: false, Code: "VendorCode", Name: "Mã nhà xe" },
            { GOPID: -1, ProductID: -1, Required: true, Type: 0, StockID: 0, IsStock: false, Code: "VehicleNo", Name: "Số xe" },
            { GOPID: -1, ProductID: -1, Required: true, Type: 0, StockID: 0, IsStock: false, Code: "MasterETDDate_Time", Name: "Ngày-giờ ETD" },
            { GOPID: -1, ProductID: -1, Required: false, Type: 0, StockID: 0, IsStock: false, Code: "MasterETDDate", Name: "Ngày ETD" },
            { GOPID: -1, ProductID: -1, Required: false, Type: 0, StockID: 0, IsStock: false, Code: "MasterETDTime", Name: "Giờ ETD" },
            { GOPID: -1, ProductID: -1, Required: true, Type: 0, StockID: 0, IsStock: false, Code: "MasterETADate_Time", Name: "Ngày-giờ ETA" },
            { GOPID: -1, ProductID: -1, Required: false, Type: 0, StockID: 0, IsStock: false, Code: "MasterETADate", Name: "Ngày ETA" },
            { GOPID: -1, ProductID: -1, Required: false, Type: 0, StockID: 0, IsStock: false, Code: "MasterETATime", Name: "Giờ ETA" },
            { GOPID: -1, ProductID: -1, Required: false, Type: 0, StockID: 0, IsStock: false, Code: "MasterNote", Name: "Ghi chú chuyến" },
            { GOPID: -1, ProductID: -1, Required: true, Type: 0, StockID: 0, IsStock: false, Code: "MasterGroupVehicle", Name: "Loại xe" },
            { GOPID: -1, ProductID: -1, Required: true, Type: 0, StockID: 0, IsStock: false, Code: "DriverName", Name: "Tên tài xế" },
            { GOPID: -1, ProductID: -1, Required: false, Type: 0, StockID: 0, IsStock: false, Code: "DriverTel", Name: "SĐT tài xế" },
            { GOPID: -1, ProductID: -1, Required: false, Type: 0, StockID: 0, IsStock: false, Code: "MasterSortOrder", Name: "Số chuyến" },
            { GOPID: -1, ProductID: -1, Required: false, Type: 0, StockID: 0, IsStock: false, Code: "LocationFromProvince", Name: "Tỉnh thành điểm lấy" },
            { GOPID: -1, ProductID: -1, Required: false, Type: 0, StockID: 0, IsStock: false, Code: "LocationFromDistrict", Name: "Quận huyện điểm lấy" },
            { GOPID: -1, ProductID: -1, Required: false, Type: 0, StockID: 0, IsStock: false, Code: "LocationToProvince", Name: "Tỉnh thành điểm giao" },
            { GOPID: -1, ProductID: -1, Required: false, Type: 0, StockID: 0, IsStock: false, Code: "LocationToDistrict", Name: "Quận huyện điểm giao" },
            { GOPID: -1, ProductID: -1, Required: false, Type: 0, StockID: 0, IsStock: false, Code: "MasterHours", Name: "Thời gian chuyến" },
            { GOPID: -1, ProductID: -1, Required: false, Type: 0, StockID: 0, IsStock: false, Code: "RomoocNo", Name: "Số Romooc" }
        ],
        GridSelected: [
...
angular.module('myapp').controller('CUSSettingORDPlan_DetailCtrl', ['$rootScope', '$scope', '$http', '$location', '$state', '$timeout', '$stateParams', function ($rootScope, $scope, $http, $location, $state, $timeout, $stateParams) {
    Common.Log('CUSSettingORDPlan_DetailCtrl');
    $rootScope.IsLoading = false;
    $scope.IsShowCbo = true;
    $scope.ItemContract = [];
    $scope.DataContract = {};
    _CUSSettingORDPlanDetail.Param = $.extend(true, _CUSSettingORDPlanDetail.Param, $state.params);
            ...
            if (e.sender.selectedIndex >= 0) {
                ...
                if (val > 0) {
                    Common.Services.Call($http, {
                        ...
                        method: _CUSSettingORDPlanDetail.URL.Get_StockByCus,
                        data: { CusID: val },
                        success: function (res) {
                            ...
                            _CUSSettingORDPlanDetail.Data.Stock = [];
                            _CUSSettingORDPlanDetail.Data.StockDetail = [];
                            _CUSSettingORDPlanDetail.Data.Packing = [];
                            _CUSSettingORDPlanDetail.Data.Stock = res.ListStock;
                            _CUSSettingORDPlanDetail.Data.StockDetail = res.ListDetail;
                            _CUSSettingORDPlanDetail.Data.Packing = res.ListPacking;
                            if ($scope.Item.HasStock) {
                                Common.Data.Each(dataFilter, function (o) {
                                    if (!o.IsStock) newData.push(o);
                                })
                                Common.Data.Each(_CUSSettingORDPlanDetail.Data.Stock, function (o) {
                                ...
                                Common.Data.Each(_CUSSettingORDPlanDetail.Data.StockDetail, function (o) {
                                ...
                                Common.Data.Each(_CUSSettingORDPlanDetail.Data.Packing, function (o) {
    ...
    Common.Services.Call($http, {
        url: Common.Services.url.CUS,
        method: _CUSSettingORDPlanDetail.URL.Customer_List,
        data: { },
        success: function (res) {
            var newData = [];
            newData.push({ ID: 0, CustomerName: "Tất cả" })
        ...
        success: function (res) {
            $timeout(function () {
                ...
                angular.forEach(res, function (value, key) {
                    if (value.TypeOfVar == 33 || value.TypeOfVar == 34)
                    data.push(value);
                });
    ...
    //$scope.cboType_Options.dataSource.data(_CUSSettingORDPlanDetail.Data.TypeTransport);
    ...
    //$scope.cboService_Options.dataSource.data(_CUSSettingORDPlanDetail.Data.Service);
    ...
    // $scope.AllSettingGrid_Options.dataSource.data(_CUSSettingORDPlanDetail.Data.GridAllSetting)
    ...
    $scope.SelectedSettingGrid_Options.dataSource.data(_CUSSettingORDPlanDetail.Data.GridSelected)
        ...
        if (Common.HasValue($scope.Item.Name) && $scope.Item.Name != "") {
            if (Common.HasValue($scope.Item.ServiceOfOrderID) && $scope.Item.ServiceOfOrderID >= 0) {
                ...
                if (!isError) {
                    Common.Services.Call($http, {
                        url: Common.Services.url.CUS,
                        method: _CUSSettingORDPlanDetail.URL.Save,
                        data: { item: ItemSend, id: _CUSSettingORDPlanDetail.Param.id },
                        success: function (res) {
                            $rootScope.IsLoading = false;
                            $rootScope.Message({ Msg: 'Thành công', NotifyType: Common.Message.NotifyType.SUCCESS });
                            $state.go("main.CUSSettingOrder.Plan")
                        },
                        error: function (res) {
                            $rootScope.IsLoading = false;
                        }
    ...
    Common.Services.Call($http, {
        url: Common.Services.url.CUS,
        method: _CUSSettingORDPlanDetail.URL.Get,
        data: { id: _CUSSettingORDPlanDetail.Param.id },
        success: function (res) {
            ...
            Common.Services.Call($http, {
                ...
                success: function (stock) {
                    ...
                    _CUSSettingORDPlanDetail.Data.Stock = stock.ListStock;
                    _CUSSettingORDPlanDetail.Data.StockDetail = stock.ListDetail;
                    _CUSSettingORDPlanDetail.Data.Packing = stock.ListPacking;

                    var dataAll = [];
                    var dataSource = $scope.SelectedSettingGrid.dataSource;

                    var dataGridAllSetting = $.extend([], true, _CUSSettingORDPlanDetail.Data.GridAllSetting)
