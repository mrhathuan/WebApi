...
var _CUSSettingPOD = {
    URL: {
        Read: 'CUSSettingPOD_List',
        Delete: 'CUSSettingPOD_Delete'
    }
}

angular.module('myapp').controller('CUSSettingPOD_IndexCtrl', ['$rootScope', '$scope', '$http', '$location', '$state', '$timeout', '$stateParams', function ($rootScope, $scope, $http, $location, $state, $timeout, $stateParams) {
    Common.Log('CUSSettingPOD_IndexCtrl');
    $rootScope.IsLoading = false;

    $scope.setting_gridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.CUS,
            method: _CUSSettingPOD.URL.Read,
            model: {
                id: 'SettingID',
                fields: {
        ...
        $rootScope.Message({
            ...
            Ok: function () {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.CUS,
                    method: _CUSSettingPOD.URL.Delete,
                    data: { item: data },
