...
var _CUSContract_Price_DI_PriceLevel = {
    URL: {
        ...
        GroupVehicleLV_Save: 'CUSPrice_DI_PriceGVLevel_Save',
        GroupVehicle_DetailData: 'CUSPrice_DI_PriceGVLevel_DetailData',
        GroupVehicle_ExcelExport: 'CUSPrice_DI_PriceGVLevel_ExcelExport',
        GroupVehicle_ExcelCheck: 'CUSPrice_DI_PriceGVLevel_ExcelCheck',
        GroupVehicle_ExcelImport: 'CUSPrice_DI_PriceGVLevel_ExcelImport',

        PriceLevel_Save: 'CUSPrice_DI_PriceLevel_Save',
        PriceLevel_DetailData: 'CUSPrice_DI_PriceLevel_DetailData',
        PriceLevel_ExcelExport: 'CUSPrice_DI_PriceLevel_ExcelExport',
        PriceLevel_ExcelImport: 'CUSPrice_DI_PriceLevel_ExcelImport',
        PriceLevel_ExcelCheck: 'CUSPrice_DI_PriceLevel_ExcelCheck',

        GOV_ExcelInit: 'CUSPrice_DI_PriceGVLevel_ExcelInit',
        GOV_ExcelChange: 'CUSPrice_DI_PriceGVLevel_ExcelChange',
        GOV_ExcelImport: 'CUSPrice_DI_PriceGVLevel_ExcelOnImport',
        GOV_ExcelApprove: 'CUSPrice_DI_PriceGVLevel_ExcelApprove',

        ExcelInit: 'CUSPrice_DI_PriceLevel_ExcelInit',
        ExcelChange: 'CUSPrice_DI_PriceLevel_ExcelChange',
        ExcelImport: 'CUSPrice_DI_PriceLevel_ExcelImport',
        ExcelApprove: 'CUSPrice_DI_PriceLevel_ExcelApprove',
    },
    Data: {
        ListPriceOfGOP: null,
...
angular.module('myapp').controller('CUSContract_Price_DI_PriceLevelCtrl', ['$rootScope', '$scope', '$http', '$location', '$state', '$timeout', '$stateParams', function ($rootScope, $scope, $http, $location, $state, $timeout, $stateParams) {
    Common.Log('CUSContract_Price_DI_PriceLevelCtrl');
    $rootScope.IsLoading = false;

    $scope.Item = null;
    _CUSContract_Price_DI_PriceLevel.Params = $.extend(true, _CUSContract_Price_DI_PriceLevel.Params, $state.params);
    $scope.IsFrame = false;


    Common.Services.Call($http, {
        url: Common.Services.url.CUS,
        method: _CUSContract_Price_DI_PriceLevel.URL.Data,
        data: { contractTermID: _CUSContract_Price_DI_PriceLevel.Params.TermID },
        success: function (res) {
            _CUSContract_Price_DI_PriceLevel.Data.ListGroupVehicle = res.ListGroupOfVehicle;
            _CUSContract_Price_DI_PriceLevel.Data.ListGroupProduct = res.ListGroupOfProduct;
            _CUSContract_Price_DI_PriceLevel.Data.ListRouting = res.ListRouting;
            _CUSContract_Price_DI_PriceLevel.Data.ListLevel = res.ListLevel;

            Common.Services.Call($http, {
                url: Common.Services.url.CUS,
                method: _CUSContract_Price_DI_PriceLevel.URL.Get,
                data: { priceID: _CUSContract_Price_DI_PriceLevel.Params.PriceID },
                success: function (res) {
                    $scope.Item = res;
                    if ($scope.Item.ID > 0) {
                        $timeout(function () {
    ...
    $scope.Back_Click = function ($event) {
        ...
        $state.go("main.CUSContract.Term", { TermID: _CUSContract_Price_DI_PriceLevel.Params.TermID, ContractID: $scope.Item.ContractID })
    }
    ...
    $scope.InitView_PriceLevel = function () {
        Common.Services.Call($http, {
            url: Common.Services.url.CUS,
            method: _CUSContract_Price_DI_PriceLevel.URL.PriceLevel_DetailData,
            data: { priceID: _CUSContract_Price_DI_PriceLevel.Params.PriceID },
            success: function (res) {
                ...
                Common.Data.Each(_CUSContract_Price_DI_PriceLevel.Data.ListLevel, function (level) {
                    if (_CUSContract_Price_DI_PriceLevel.Data.ListGroupProduct.length > 0) {
                        var listCol = [];
                        Common.Data.Each(_CUSContract_Price_DI_PriceLevel.Data.ListGroupProduct, function (pro) {
                ...
                Common.Data.Each(_CUSContract_Price_DI_PriceLevel.Data.ListRouting, function (route) {
                    var item = {};
    ...
    $scope.GOPLevel_Save_Click = function ($event, grid) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.CUS,
            method: _CUSContract_Price_DI_PriceLevel.URL.PriceLevel_Save,
            data: { lst: dataSave, priceID: _CUSContract_Price_DI_PriceLevel.Params.PriceID },
            success: function (res) {
                $scope.InitView_PriceLevel();
                $rootScope.IsLoading = false;
    ...
    $scope.PriceLevel_Excel_Click = function ($event, win) {
        ...
        $rootScope.UploadExcel({
            ...
            Download: function () {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.CUS,
                    method: _CUSContract_Price_DI_PriceLevel.URL.PriceLevel_ExcelExport,
                    data: { priceID: _CUSContract_Price_DI_PriceLevel.Params.PriceID,  contractTermID: _CUSContract_Price_DI_PriceLevel.Params.TermID },
                    success: function (res) {
                        $rootScope.IsLoading = false;
            ...
            Upload: function (e, callback) {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.CUS,
                    method: _CUSContract_Price_DI_PriceLevel.URL.PriceLevel_ExcelCheck,
                    data: { file: e, priceID: _CUSContract_Price_DI_PriceLevel.Params.PriceID, contractTermID: _CUSContract_Price_DI_PriceLevel.Params.TermID },
            ...
            Complete: function (e, data) {
                if (!$scope.Item.TermClosed) {
                    ...
                    Common.Services.Call($http, {
                        url: Common.Services.url.CUS,
                        method: _CUSContract_Price_DI_PriceLevel.URL.PriceLevel_ExcelImport,
                        data: { lst: data, priceID: _CUSContract_Price_DI_PriceLevel.Params.PriceID},
                        success: function (res) {
                            $rootScope.IsLoading = false;
                            $rootScope.Message({ Msg: 'Thành công', NotifyType: Common.Message.NotifyType.SUCCESS });
                            $scope.InitView_PriceLevel()
    ...
    $scope.InitView_GroupVehicleLV = function (isframe) {
        Common.Services.Call($http, {
            url: Common.Services.url.CUS,
            method: _CUSContract_Price_DI_PriceLevel.URL.GroupVehicle_DetailData,
            data: { id: _CUSContract_Price_DI_PriceLevel.Params.PriceID },
            success: function (res) {
    ...
    $scope.GOVLevel_Save_Click = function ($event, grid) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.CUS,
            method: _CUSContract_Price_DI_PriceLevel.URL.GroupVehicleLV_Save,
            data: { lst: dataSave, priceID: _CUSContract_Price_DI_PriceLevel.Params.PriceID },
            success: function (res) {
    ...
    $scope.GOV_Excel_Click = function ($event, win) {
        ...
        $rootScope.UploadExcel({
            ...
            Download: function () {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.CUS,
                    method: _CUSContract_Price_DI_PriceLevel.URL.GroupVehicle_ExcelExport,
                    data: { priceID: _CUSContract_Price_DI_PriceLevel.Params.PriceID, contractTermID: _CUSContract_Price_DI_PriceLevel.Params.TermID, isFrame: $scope.IsFrame },
                    success: function (res) {
                        $rootScope.IsLoading = false;
                        $rootScope.DownloadFile(res);
                    },
            ...
            Upload: function (e, callback) {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.CUS,
                    method: _CUSContract_Price_DI_PriceLevel.URL.GroupVehicle_ExcelCheck,
                    data: { file: e, priceID: _CUSContract_Price_DI_PriceLevel.Params.PriceID, contractTermID: _CUSContract_Price_DI_PriceLevel.Params.TermID, isFrame: $scope.IsFrame },
                    success: function (data) {
                        $rootScope.IsLoading = false;
                        callback(data);
                    }
            ...
            Complete: function (e, data) {
                if (!$scope.Item.TermClosed) {
                    ...
                    Common.Services.Call($http, {
                        url: Common.Services.url.CUS,
                        method: _CUSContract_Price_DI_PriceLevel.URL.GroupVehicle_ExcelImport,
                        data: { lst: data, priceID: _CUSContract_Price_DI_PriceLevel.Params.PriceID },
                        success: function (res) {
                            $rootScope.IsLoading = false;
                            $rootScope.Message({ Msg: 'Thành công', NotifyType: Common.Message.NotifyType.SUCCESS });
    ...
    $scope.GOV_ExcelOnline_Click = function ($event) {
        ...
        $rootScope.excelShare.Init({
            ...
            params: {
                priceID: _CUSContract_Price_DI_PriceLevel.Params.PriceID,
                contractTermID: _CUSContract_Price_DI_PriceLevel.Params.TermID,
                isFrame: $scope.IsFrame
            },
            rowStart: 1,
            colCheckChange: 6,
            url: Common.Services.url.CUS,
            methodInit: _CUSContract_Price_DI_PriceLevel.URL.GOV_ExcelInit,
            methodChange: _CUSContract_Price_DI_PriceLevel.URL.GOV_ExcelChange,
            methodImport: _CUSContract_Price_DI_PriceLevel.URL.GOV_ExcelImport,
            methodApprove: _CUSContract_Price_DI_PriceLevel.URL.GOV_ExcelApprove,
    ...
    $scope.PriceLevel_ExcelOnline_Click = function ($event) {
        ...
        $rootScope.excelShare.Init({
            ...
            colCheckChange: 6,
            url: Common.Services.url.CUS,
            methodInit: _CUSContract_Price_DI_PriceLevel.URL.ExcelInit,
            methodChange: _CUSContract_Price_DI_PriceLevel.URL.ExcelChange,
            methodImport: _CUSContract_Price_DI_PriceLevel.URL.ExcelImport,
            methodApprove: _CUSContract_Price_DI_PriceLevel.URL.ExcelApprove,
            lstMessageError: lstMessageError,
            Changed: function () {
