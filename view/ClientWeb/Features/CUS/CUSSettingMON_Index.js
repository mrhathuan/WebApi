...
var _CUSSettingMON = {
    URL: {
        Read: 'CUSSettingMON_List',
        Delete: 'CUSSettingMON_Delete'
    }
}

angular.module('myapp').controller('CUSSettingMON_IndexCtrl', ['$rootScope', '$scope', '$http', '$location', '$state', '$timeout', '$stateParams', function ($rootScope, $scope, $http, $location, $state, $timeout, $stateParams) {
    Common.Log('CUSSettingMON_IndexCtrl');
    $rootScope.IsLoading = false;

    $scope.setting_gridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.CUS,
            method: _CUSSettingMON.URL.Read,
            model: {
                id: 'SettingID',
                fields: {
        ...
        $rootScope.Message({
            ...
            Ok: function () {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.CUS,
                    method: _CUSSettingMON.URL.Delete,
                    data: { item: data },
