...
var _CUSContract_Price_DI_LoadMOQ = {
    URL: {
        Get: 'CUSContract_Price_Get',

        //#region price ex
        loadMOQ_List: 'CUSPrice_DI_PriceMOQLoad_List',
        loadMOQ_Get: 'CUSPrice_DI_PriceMOQLoad_Get',
        loadMOQ_Save: 'CUSPrice_DI_PriceMOQLoad_Save',
        loadMOQ_Delete: 'CUSPrice_DI_PriceMOQLoad_Delete',

        LoadMOQ_GroupLocation_List: 'CUSPrice_DI_PriceMOQLoad_GroupLocation_List',
        LoadMOQ_GroupLocation_Delete: 'CUSPrice_DI_PriceMOQLoad_GroupLocation_DeleteList',
        LoadMOQ_GroupLocation_Save: 'CUSPrice_DI_PriceMOQLoad_GroupLocation_SaveList',
        LoadMOQ_GroupLocation_NotInList: 'CUSPrice_DI_PriceMOQLoad_GroupLocation_GroupNotInList',

        LoadMOQ_GroupProduct_List: 'CUSPrice_DI_PriceMOQLoad_GroupProduct_List',
        LoadMOQ_GroupProduct_Delete: 'CUSPrice_DI_PriceMOQLoad_GroupProduct_DeleteList',
        LoadMOQ_GroupProduct_Save: 'CUSPrice_DI_PriceMOQLoad_GroupProduct_Save',
        LoadMOQ_GroupProduct_Get: 'CUSPrice_DI_PriceMOQLoad_GroupProduct_Get',
        LoadMOQ_GroupProduct_GOPList: 'CUSPrice_DI_PriceMOQLoad_GroupProduct_GOPList',

        LoadMOQ_Location_List: 'CUSPrice_DI_PriceMOQLoad_Location_List',
        LoadMOQ_Location_Delete: 'CUSPrice_DI_PriceMOQLoad_Location_DeleteList',
        LoadMOQ_Location_NotInSave: 'CUSPrice_DI_PriceMOQLoad_Location_LocationNotInSaveList',
        LoadMOQ_Location_NotInList: 'CUSPrice_DI_PriceMOQLoad_Location_LocationNotInList',
        LoadMOQ_Location_Save: 'CUSPrice_DI_PriceMOQLoad_Location_Save',
        LoadMOQ_Location_Get: 'CUSPrice_DI_PriceMOQLoad_Location_Get',

        LoadMOQ_Route_List: 'CUSPrice_DI_PriceMOQLoad_Route_List',
        LoadMOQ_Route_Delete: 'CUSPrice_DI_PriceMOQLoad_Route_DeleteList',
        LoadMOQ_Route_Save: 'CUSPrice_DI_PriceMOQLoad_Route_SaveList',
        LoadMOQ_Route_NotInList: 'CUSPrice_DI_PriceMOQLoad_Route_RouteNotInList',

        LoadMOQ_ParentRoute_List: 'CUSPrice_DI_PriceMOQLoad_ParentRoute_List',
        LoadMOQ_ParentRoute_Delete: 'CUSPrice_DI_PriceMOQLoad_ParentRoute_DeleteList',
        LoadMOQ_ParentRoute_Save: 'CUSPrice_DI_PriceMOQLoad_ParentRoute_SaveList',
        LoadMOQ_ParentRoute_NotInList: 'CUSPrice_DI_PriceMOQLoad_ParentRoute_RouteNotInList',

        PriceMOQ_Province_List: 'CUSPrice_DI_PriceMOQLoad_Province_List',
        PriceMOQ_Province_Delete: 'CUSPrice_DI_PriceMOQLoad_Province_DeleteList',
        PriceMOQ_Province_Save: 'CUSPrice_DI_PriceMOQLoad_Province_SaveList',
        PriceMOQ_Province_NotInList: 'CUSPrice_DI_PriceMOQLoad_Province_NotInList',
        //#endregion
...
angular.module('myapp').controller('CUSContract_Price_DI_LoadMOQCtrl', ['$rootScope', '$scope', '$http', '$location', '$state', '$timeout', '$stateParams', function ($rootScope, $scope, $http, $location, $state, $timeout, $stateParams) {
    Common.Log('CUSContract_Price_DI_LoadMOQCtrl');
    $rootScope.IsLoading = false;
    _CUSContract_Price_DI_LoadMOQ.Params = $.extend({}, true, $state.params);
    ...
    //    method: _CUSContract_Price_DI_LoadMOQ.URL.loadMOQ_Get,
    //    data: { priceID: _CUSContract_Price_DI_LoadMOQ.Params.ID },
    ...
    $scope.load_MOQ_grid_Options = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.CUS,
            method: _CUSContract_Price_DI_LoadMOQ.URL.loadMOQ_List,
            readparam: function () { return { priceID: _CUSContract_Price_DI_LoadMOQ.Params.PriceID } },
            model: {
                id: 'ID',
                fields: {
        ...
        columns: [
            ...
            { field: 'DIMOQLoadSumName', width: 200, title: 'Loại tính tổng', filterable: { cell: { operator: 'contains', showOperators: false } } },
        ]
    }
    ...
    $scope.loadMOQ_GridDestroy_Click = function ($event, data) {
        ...
        $rootScope.Message({
            ...
            Ok: function () {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.CUS,
                    method: _CUSContract_Price_DI_LoadMOQ.URL.loadMOQ_Delete,
                    data: { id: data.ID },
                    success: function (res) {
                        $rootScope.IsLoading = false;
    ...
    $scope.Back_Click = function ($event) {
        ...
        $state.go("main.CUSContract.PriceDI", _CUSContract_Price_DI_LoadMOQ.Params)
    }
    ...
    $scope.loadMOQ_SaveInfo_Click = function ($event, vform) {
        ...
        if (vform()) {
            if ($scope.ItemLoadMOQ.DIMOQLoadSumID > 0) {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.CUS,
                    method: _CUSContract_Price_DI_LoadMOQ.URL.loadMOQ_Save,
                    data: { priceID: _CUSContract_Price_DI_LoadMOQ.Params.PriceID, item: $scope.ItemLoadMOQ },
                    success: function (res) {
                        Common.Services.Call($http, {
                            url: Common.Services.url.CUS,
                            method: _CUSContract_Price_DI_LoadMOQ.URL.loadMOQ_Get,
    ...
    $scope.loadMOQ_GroupLocation_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.CUS,
            method: _CUSContract_Price_DI_LoadMOQ.URL.LoadMOQ_GroupLocation_List,
    ...
    $scope.loadMOQ_GroupLocation_Delete = function ($event, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.CUS,
                method: _CUSContract_Price_DI_LoadMOQ.URL.LoadMOQ_GroupLocation_Delete,
                data: { lst: datasend },
                success: function (res) {
                    $rootScope.IsLoading = false;
                    $scope.loadMOQ_GroupLocation_GridOptions.dataSource.read();
    ...
    $scope.load_MOQ_GroupNotIn_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.CUS,
            method: _CUSContract_Price_DI_LoadMOQ.URL.LoadMOQ_GroupLocation_NotInList,
            readparam: function () { return { PriceMOQLoadID: $scope.ItemLoadMOQ.ID } },
            model: {
                id: 'ID',
                fields: {
    ...
    $scope.load_MOQ_GroupNotIn_Save_Click = function ($event, win, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.CUS,
                method: _CUSContract_Price_DI_LoadMOQ.URL.LoadMOQ_GroupLocation_Save,
    ...
    $scope.loadMOQ_GroupProduct_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.CUS,
            method: _CUSContract_Price_DI_LoadMOQ.URL.LoadMOQ_GroupProduct_List,
            readparam: function () { return { PriceMOQLoadID: $scope.ItemLoadMOQ.ID } },
            model: {
                id: 'ID',
                fields: {
    ...
    $scope.GOPLoadItem = function (id, win, vform) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.CUS,
            method: _CUSContract_Price_DI_LoadMOQ.URL.LoadMOQ_GroupProduct_Get,
            data: { id: id, cusID: _CUSContract_Price_DI_LoadMOQ.Params.CustomerID },
            success: function (res) {
                $rootScope.IsLoading = false;
    ...
    $scope.loadMOQ_GroupProduct_GridDestroy_Click = function ($event, data) {
        ...
        if (lst.length > 0) {
            Common.Services.Call($http, {
                url: Common.Services.url.CUS,
                method: _CUSContract_Price_DI_LoadMOQ.URL.LoadMOQ_GroupProduct_Delete,
                data: { lst: lst },
                success: function (res) {
                    $rootScope.IsLoading = false;
                    $scope.loadMOQ_GroupProduct_GridOptions.dataSource.read();
    ...
    $scope.load_MOQ_GOP_Save_Click = function ($event, win, vform) {
        ...
        if (vform()) {
            if ($scope.ItemLoadMOQGOP.GroupOfProductID > 0) {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.CUS,
                    method: _CUSContract_Price_DI_LoadMOQ.URL.LoadMOQ_GroupProduct_Save,
    ...
    Common.Services.Call($http, {
        url: Common.Services.url.CUS,
        method: _CUSContract_Price_DI_LoadMOQ.URL.LoadMOQ_GroupProduct_GOPList,
        data: { cusID: _CUSContract_Price_DI_LoadMOQ.Params.CustomerID },
        success: function (res) {
    ...
    $scope.loadMOQ_Location_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.CUS,
            method: _CUSContract_Price_DI_LoadMOQ.URL.LoadMOQ_Location_List,
            readparam: function () { return { PriceMOQLoadID: $scope.ItemLoadMOQ.ID } },
            model: {
                id: 'ID',
                fields: {
    ...
    $scope.loadMOQ_Location_Delete = function ($event, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.CUS,
                method: _CUSContract_Price_DI_LoadMOQ.URL.LoadMOQ_Location_Delete,
                data: { lst: datasend },
                success: function (res) {
                    $rootScope.IsLoading = false;
                    $scope.loadMOQ_Location_GridOptions.dataSource.read();
    ...
    $scope.load_MOQ_LocationNotIn_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.CUS,
            method: _CUSContract_Price_DI_LoadMOQ.URL.LoadMOQ_Location_NotInList,
            readparam: function () { return { PriceMOQLoadID: $scope.ItemLoadMOQ.ID, customerID: _CUSContract_Price_DI_LoadMOQ.Params.CustomerID } },
            model: {
                id: 'ID',
                fields: {
                    ID: { type: 'number', editable: false, nullable: true },
    ...
    $scope.load_MOQ_LocationNotIn_Save_Click = function ($event, win, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.CUS,
                method: _CUSContract_Price_DI_LoadMOQ.URL.LoadMOQ_Location_NotInSave,
                data: { PriceMOQLoadID: $scope.ItemLoadMOQ.ID, lst: datasend },
                success: function (res) {
                    $rootScope.IsLoading = false;
                    $scope.loadMOQ_Location_GridOptions.dataSource.read();
    ...
    $scope.Location_GridEdit_Click = function ($event, win, data) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.CUS,
            method: _CUSContract_Price_DI_LoadMOQ.URL.LoadMOQ_Location_Get,
            data: { id: data.ID },
            success: function (res) {
                $rootScope.IsLoading = false;
    ...
    $scope.Location_Save_Click = function ($event, win) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.CUS,
            method: _CUSContract_Price_DI_LoadMOQ.URL.LoadMOQ_Location_Save,
    ...
    $scope.loadMOQ_Route_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.CUS,
            method: _CUSContract_Price_DI_LoadMOQ.URL.LoadMOQ_Route_List,
            readparam: function () { return { PriceMOQLoadID: $scope.ItemLoadMOQ.ID } },
            model: {
                id: 'ID',
                fields: {
    ...
    $scope.load_MOQ_RouteNotIn_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.CUS,
            method: _CUSContract_Price_DI_LoadMOQ.URL.LoadMOQ_Route_NotInList,
            readparam: function () { return { PriceMOQLoadID: $scope.ItemLoadMOQ.ID, contractTermID: _CUSContract_Price_DI_LoadMOQ.Params.TermID } },
            model: {
                id: 'ID',
                fields: {
                    ID: { type: 'number', editable: false, nullable: true },
    ...
    $scope.load_MOQ_RouteNotIn_Save_Click = function ($event, win, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.CUS,
                method: _CUSContract_Price_DI_LoadMOQ.URL.LoadMOQ_Route_Save,
                data: { PriceMOQLoadID: $scope.ItemLoadMOQ.ID, lst: datasend },
                success: function (res) {
                    $rootScope.IsLoading = false;
                    $scope.loadMOQ_Route_GridOptions.dataSource.read();
    ...
    $scope.loadMOQ_Route_Delete = function ($event, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.CUS,
                method: _CUSContract_Price_DI_LoadMOQ.URL.LoadMOQ_Route_Delete,
                data: { lst: datasend },
                success: function (res) {
                    $rootScope.IsLoading = false;
                    $scope.loadMOQ_Route_GridOptions.dataSource.read();
    ...
    $scope.loadMOQ_ParentRoute_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.CUS,
            method: _CUSContract_Price_DI_LoadMOQ.URL.LoadMOQ_ParentRoute_List,
            readparam: function () { return { PriceMOQLoadID: $scope.ItemLoadMOQ.ID } },
            model: {
                id: 'ID',
                fields: {
    ...
    $scope.load_MOQ_ParentRouteNotIn_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.CUS,
            method: _CUSContract_Price_DI_LoadMOQ.URL.LoadMOQ_ParentRoute_NotInList,
            readparam: function () { return { PriceMOQLoadID: $scope.ItemLoadMOQ.ID, contractTermID: _CUSContract_Price_DI_LoadMOQ.Params.TermID } },
            model: {
                id: 'ID',
                fields: {
    ...
    $scope.load_MOQ_ParentRouteNotIn_Save_Click = function ($event, win, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.CUS,
                method: _CUSContract_Price_DI_LoadMOQ.URL.LoadMOQ_ParentRoute_Save,
                data: { PriceMOQLoadID: $scope.ItemLoadMOQ.ID, lst: datasend },
                success: function (res) {
                    $rootScope.IsLoading = false;
                    $scope.loadMOQ_ParentRoute_GridOptions.dataSource.read();
    ...
    $scope.loadMOQ_ParentRoute_Delete = function ($event, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.CUS,
                method: _CUSContract_Price_DI_LoadMOQ.URL.LoadMOQ_ParentRoute_Delete,
                data: { lst: datasend },
                success: function (res) {
                    $rootScope.IsLoading = false;
                    $scope.loadMOQ_ParentRoute_GridOptions.dataSource.read();
    ...
    $scope.priceEx_Province_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.CUS,
            method: _CUSContract_Price_DI_LoadMOQ.URL.PriceMOQ_Province_List,
    ...
    $scope.price_ex_ProvinceNotIn_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.CUS,
            method: _CUSContract_Price_DI_LoadMOQ.URL.PriceMOQ_Province_NotInList,
            readparam: function () { return { PriceDIMOQLoadID: $scope.ItemLoadMOQ.ID, contractTermID: _CUSContract_Price_DI_LoadMOQ.Params.TermID, CustomerID: _CUSContract_Price_DI_LoadMOQ.Params.CustomerID } },
            model: {
                id: 'ID',
                fields: {
                    ID: { type: 'number', editable: false, nullable: true },
    ...
    $scope.price_exProvince_NotIn_Save_Click = function ($event, win, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.CUS,
                method: _CUSContract_Price_DI_LoadMOQ.URL.PriceMOQ_Province_Save,
    ...
    $scope.priceEx_Province_Delete = function ($event, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.CUS,
                method: _CUSContract_Price_DI_LoadMOQ.URL.PriceMOQ_Province_Delete,
                data: { lst: datasend },
                success: function (res) {
                    $rootScope.IsLoading = false;
                    $scope.priceEx_Province_GridOptions.dataSource.read();
