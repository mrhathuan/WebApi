...
var _CUSSettingMONImportDetail = {
    URL: {
    ...
    Data: {
        GridAllSetting: [
            ...
            { Code: "MasterCode", Name: "Mã chuyến" },
            ...
            { Code: "IsReturn", Name: "Hàng lấy tại nhà phân phối" },
            { Code: "InvoiceReturnNote", Name: "Số chứng từ trả về" },
            { Code: "InvoiceReturnDate", Name: "Ngày chứng từ trả về" },
            { Code: "ReasonCancelNote", Name: "Ghi chú lí do" },
        ],
        GridSelected: [
...
angular.module('myapp').controller('CUSSettingMON_InputDetailCtrl', ['$rootScope', '$scope', '$http', '$location', '$state', '$timeout', '$stateParams', function ($rootScope, $scope, $http, $location, $state, $timeout, $stateParams) {
    Common.Log('CUSSettingMON_InputDetailCtrl');
    $rootScope.IsLoading = false;
    $scope.SettingItem = null;
    $scope.SettingOrder = '';
    _CUSSettingMONImportDetail.Param = $.extend(true, _CUSSettingMONImportDetail.Param, $state.params);
    ...
    $scope.LoadSetting = function () {
        ...
        //$scope.SelectedSettingGrid_Options.dataSource.data(_CUSSettingMONImportDetail.Data.GridSelected);
        Common.Services.Call($http, {
            url: Common.Services.url.CUS,
            method: _CUSSettingMONImportDetail.URL.GetSettingOrder,
            ...
            success: function (res) {
                ...
                var dataOrder = $.extend(true, [], _CUSSettingMONImportDetail.Data.GridSelected);// _CUSSettingMONImportDetail.Data.GridSelected;

                var dataAllSet = $.extend(true, [], _CUSSettingMONImportDetail.Data.GridAllSettingOrder);
                ...
                if (res.HasStock || res.HasStockProduct) {
                    ...
                    Common.Services.Call($http, {
                        url: Common.Services.url.CUS,
                        method: _CUSSettingMONImportDetail.URL.Get_StockByCus,
                        ...
                        success: function (res) {
                            ...
                            Common.Data.Each(_CUSSettingMONImportDetail.Data.GridAllSetting, function (o) {
                    ...
                    Common.Data.Each(_CUSSettingMONImportDetail.Data.GridAllSettingOrder, function (o) {
                        if (res[o.Code] > 0) {
    ...
    Common.Services.Call($http, {
        url: Common.Services.url.CUS,
        method: _CUSSettingMONImportDetail.URL.Get,
        data: { id: _CUSSettingMONImportDetail.Param.ID },
        success: function (res) {
            $rootScope.IsLoading = false;
    ...
    $scope.settingOrder_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.CUS,
            method: _CUSSettingMONImportDetail.URL.SettingOrderList,
    ...
    $scope.SettingOrder_SelectClick = function ($event, grid, win) {
        ...
        if (!Common.HasValue(itemSelect)) {
            ...
            $scope.SettingItem.IsSKU = false;
            $scope.SettingItem.IsReturnSetting = false;
            $scope.SettingItem.IsImportOnReceived = false;
            $scope.LoadSetting();
            win.close();
        }
    }
        ...
        if (Common.HasValue($scope.SettingItem.Name) && $scope.SettingItem.Name != "") {
            if (Common.HasValue($scope.SettingItem.CUSSettingOrderID) && $scope.SettingItem.CUSSettingOrderID > 0) {
                ...
                var ItemSend = {
                    ...
                    IsSKU: $scope.SettingItem.IsSKU,
                    IsImportOnReceived: $scope.SettingItem.IsImportOnReceived,
                    IsReturnSetting: $scope.SettingItem.IsReturnSetting,
                }
                var objStock = {};
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.CUS,
                    method: _CUSSettingMONImportDetail.URL.Save,
                    data: { item: ItemSend },
                    success: function (res) {
                        $rootScope.IsLoading = false;
                        $rootScope.Message({ Msg: 'Thành công', NotifyType: Common.Message.NotifyType.SUCCESS });
                        $state.go("main.CUSSettingMonitor.Input")
                    },
                    error: function (res) {
                        $rootScope.IsLoading = false;
                    }
