...
var _PODFLMDI_Input = {
    URL: {
        Read: 'DTOPODFLMDIInput_List',
        FLMDIInput_Approved: 'PODFLMDIInput_Approved',
        DriverList: 'PODFLMDIInput_DriverList',
        StationCost: 'PODFLMDIInput_StationCostList',
        TroubleCost: 'PODFLMDIInput_TroubleCostList',
        TroubleCostNotIn_List: 'PODFLMDIInput_TroubleCostNotIn_List',
        TroubleCostNotIn_Save: 'PODFLMDIInput_TroubleCostNotIn_SaveList',
        TroubleCost_Delete: 'PODFLMDIInput_TroubleCost_DeleteList',
        TroubleCostSave: 'PODFLMDIInput_TroubleCostSave',
        StationCostSave: 'PODFLMDIInput_StationCostSave',
        Update: 'PODFLMDIInput_Save',
        GetDrivers: 'PODFLMDIInput_GetDrivers',
        SaveDrivers: 'PODFLMDIInput_SaveDrivers',
...
angular.module('myapp').controller('PODFLMDI_InputCtrl', ['$rootScope', '$scope', '$http', '$location', '$state', '$timeout', function ($rootScope, $scope, $http, $location, $state, $timeout) {

    Common.Log('PODFLMDI_InputCtrl');
    ...
    Common.Services.Call($http, {
        ...
        method: _PODFLMDI_Input.URL.DriverList,
    ...
    $scope.PODInput_gridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.POD,
            method: _PODFLMDI_Input.URL.Read,
            readparam: function () {
                return {
        ...
        columns: [
            ...
            { field: 'DITOMasterCode', width: CS['DITOMasterCode'], title: 'Mã chuyến', filterable: { cell: { operator: 'contains', showOperators: false } } },
    ...
    $scope.TroubleCost_gridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.POD,
            method: _PODFLMDI_Input.URL.TroubleCost,
            readparam: function () {
                return {
    ...
    $scope.troubleCost_Delete = function ($event, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.POD,
                method: _PODFLMDI_Input.URL.TroubleCost_Delete,
                data: { lst: datasend },
                success: function (res) {
                    $rootScope.IsLoading = false;
    ...
    $scope.TroubleCostNotIn_gridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.POD,
            method: _PODFLMDI_Input.URL.TroubleCostNotIn_List,
            readparam: function () {
                return {
                    DITOMasterID: $scope.DITOMasterID
                };
    ...
    $scope.TroubleCostNotIn_Save_Click = function ($event, win, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.POD,
                method: _PODFLMDI_Input.URL.TroubleCostNotIn_Save,
    ...
    $scope.StationCost_gridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.POD,
            method: _PODFLMDI_Input.URL.StationCost,
            readparam: function () {
                return {
                    DITOMasterID: $scope.DITOMasterID
                };
    ...
    $scope.DriverList_Click = function ($event, data, win) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.POD,
            method: _PODFLMDI_Input.URL.GetDrivers,
    ...
    $scope.DriverList_Save_Click = function ($event, win) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.POD,
            method: _PODFLMDI_Input.URL.SaveDrivers,
    ...
    $scope.TroubleCost_Save_Click = function ($event, win) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.POD,
            method: _PODFLMDI_Input.URL.TroubleCostSave,
    ...
    $scope.StationCost_Save_Click = function ($event, win) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.POD,
            method: _PODFLMDI_Input.URL.StationCostSave,
    ...
    $scope.SaveDataInput = function (item) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.POD,
            method: _PODFLMDI_Input.URL.Update,
            data: { item: item },
            success: function (res) {
                $rootScope.IsLoading = false;
                $rootScope.Message({ Msg: 'Thành công', NotifyType: Common.Message.NotifyType.SUCCESS });
    ...
    $scope.FLMDIInput_Approved_Click = function ($event, grid) {
        ...
        if (lstid.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.POD,
                method: _PODFLMDI_Input.URL.FLMDIInput_Approved,
                data: { lst: lstid },
                success: function (res) {
                    $rootScope.Message({ Msg: 'Thành công', NotifyType: Common.Message.NotifyType.SUCCESS });
                    grid.dataSource.read();
    ...
    $scope.Excel_Click = function ($event, win) {
        ...
        $rootScope.UploadExcel({
            ...
            Download: function () {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.POD,
                    method: _PODFLMDI_Input.URL.ExcelExport,
                    data: {
                        'dtFrom': $scope.PODInputItem.DateFrom,
                        'dtTo': $scope.PODInputItem.DateTo, 'isCO': 0
                    },
                    success: function (res) {
                        $rootScope.IsLoading = false;
            ...
            Upload: function (e, callback) {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.POD,
                    method: _PODFLMDI_Input.URL.ExcelCheck,
                    data: { file: e, 'dtFrom': $scope.PODInputItem.DateFrom, 'dtTo': $scope.PODInputItem.DateTo, 'isCO': 0 },
                    success: function (data) {
                        $rootScope.IsLoading = false;
                        callback(data);
                    }
            ...
            Complete: function (e, data) {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.POD,
                    method: _PODFLMDI_Input.URL.ExcelImport,
