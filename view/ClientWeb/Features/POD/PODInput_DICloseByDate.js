...
var _PODDICloseByDate = {
    URL: {
        Read: 'PODDI_CloseDataList',
        Approved: 'PODDI_CloseDataByDate',
...
angular.module('myapp').controller('PODInput_DICloseByDateCtrl', ['$rootScope', '$scope', '$http', '$location', '$state', '$timeout', function ($rootScope, $scope, $http, $location, $state, $timeout) {

    Common.Log('PODInput_DICloseByDateCtrl');
    ...
    $scope.PODInput_gridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            ...
            method: _PODDICloseByDate.URL.Read,
            readparam: function () {
                return {
    ...
    $scope.PODInput_ApprovedClick = function ($event, grid) {
        ...
        if (data.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.POD,
                method: _PODDICloseByDate.URL.Approved,
                data: {
                    listCustomerID: $scope.PODInputItem.ListCustomerID,
                    lst: data,
                    isOpen: false,
