...
var _REPDIOPSPlan_DetailGroupStock = {
    URL: {
        Search: 'REPDIOPSPlan_DetailGroupStock',
        Template: 'REPDIOPSPlan_DetailGroupStockTemplate',

        Read_Customer: 'REP_Customer_Read',
        Read_GroupOfProduct: 'REP_GroupOfProduct_Read',

        DetailGroupStock_Export: 'REPDIOPSPlan_DetailGroupStock_Export',
...
angular.module('myapp').controller('REPDIOPSPlan_DetailGroupStockCtrl', ['$rootScope', '$scope', '$http', '$location', '$state', '$timeout', '$stateParams', function ($rootScope, $scope, $http, $location, $state, $timeout, $stateParams) {
    if ($rootScope.IsPageComplete != true) return;
    Common.Log('REPDIOPSPlan_DetailGroupStockCtrl');
    ...
    $scope.mulCustomer_Options = {
        ...
        change: function () {
            ...
            Common.Services.Call($http, {
                ...
                method: _REPDIOPSPlan_DetailGroupStock.URL.Read_GroupOfProduct,
                data: { lstid: lstid },
    ...
    Common.Services.Call($http, {
        url: Common.Services.url.REP,
        method: _REPDIOPSPlan_DetailGroupStock.URL.Read_Customer,
        data: {},
        success: function (res) {
    ...
    $scope.SearchData = function () {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.REP,
            method: _REPDIOPSPlan_DetailGroupStock.URL.Search,
            ...
            success: function (res) {
                ...
                _REPDIOPSPlan_DetailGroupStock.Data._listData = res.ListData;
                _REPDIOPSPlan_DetailGroupStock.Data._listColumn = res.ListColumn;
                _REPDIOPSPlan_DetailGroupStock.Data._listColumnKey = res.ListColumnKey;
    ...
    $scope.InitGrid = function () {
        ...
        $scope.fieldGrid = [];
        Common.Data.Each(_REPDIOPSPlan_DetailGroupStock.Data._listColumnKey, function (group) {
            var array = [];
        ...
        var dataGrid = [];
        Common.Data.Each(_REPDIOPSPlan_DetailGroupStock.Data._listData, function (data) {
            for (var i = 0 ; i < _REPDIOPSPlan_DetailGroupStock.Data._listColumn.length ; i++) {
                var group = _REPDIOPSPlan_DetailGroupStock.Data._listColumn[i];
                if (group.StockID == data.StockID && group.LocationToID == data.LocationToID && group.OrderID == data.OrderID && group.DITOMasterID == data.DITOMasterID) {
                    var count = 0;
                    Common.Data.Each(_REPDIOPSPlan_DetailGroupStock.Data._listColumnKey, function (key) {
                        var dataGroup = null;
                        if (group.GroupOfProductID == key.GroupOfProductID) {
                            dataGroup = group;
                            _REPDIOPSPlan_DetailGroupStock.Data._listColumn.splice(i, 1);
                        }
    ...
    $scope.Excel_Click = function ($event) {
        ...
        $rootScope.UploadFile({
            ...
            Complete: function (file) {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.REP,
                    method: _REPDIOPSPlan_DetailGroupStock.URL.Template,
    ...
    $scope.SettingReport = function ($event, win) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.REP,
            method: _REPDIOPSPlan_DetailGroupStock.URL.SettingList,
    ...
    $scope.SettingReport_SaveClick = function ($event, win, vform) {
        ...
        if (vform()) {
            ...
            if (!error) {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.REP,
                    method: _REPDIOPSPlan_DetailGroupStock.URL.SettingSave,
    ...
    $scope.SettingDelete = function (win, datasend) {
        $rootScope.Message({
            ...
            Ok: function () {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.REP,
                    method: _REPDIOPSPlan_DetailGroupStock.URL.SettingDelete,
                    data: { lst: datasend },
                    success: function (res) {
                        $rootScope.Message({
                            Type: Common.Message.Type.Notify,
    ...
    $scope.customerNotIn_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.REP,
            method: _REPDIOPSPlan_DetailGroupStock.URL.SettingCusNotInList,
    ...
    $scope.customerNotIn_Save_Click = function ($event, win, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.REP,
                method: _REPDIOPSPlan_DetailGroupStock.URL.SettingCusNotInSave,
    ...
    $scope.customer_Delete = function ($event, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.REP,
                method: _REPDIOPSPlan_DetailGroupStock.URL.SettingCusDeleteList,
                data: { item: $scope.SettingItem, lst: datasend },
                success: function (res) {
                    $scope.SettingItem = res;
                    if (Common.HasValue(res.ListCustomer)) {
    ...
    $scope.gopNotIn_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.REP,
            method: _REPDIOPSPlan_DetailGroupStock.URL.SettingGOPNotInList,
    ...
    $scope.gopNotIn_Save_Click = function ($event, win, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.REP,
                method: _REPDIOPSPlan_DetailGroupStock.URL.SettingGOPNotInSave,
                data: { item: $scope.SettingItem, lst: datasend },
                success: function (res) {
                    $scope.SettingItem = res;
                    if (Common.HasValue(res.ListGroupProduct)) {
    ...
    $scope.gop_Delete = function ($event, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.REP,
                method: _REPDIOPSPlan_DetailGroupStock.URL.SettingGOPDeleteList,
                data: { item: $scope.SettingItem, lst: datasend },
                success: function (res) {
                    $scope.SettingItem = res;
                    if (Common.HasValue(res.ListGroupProduct)) {
    ...
    //#endregion
    $scope.REPDIOPSPlan_DetailGroupStock_Export = function ($event) {
        $event.preventDefault();

        $rootScope.IsLoading = true;
        Common.Services.Call($http, {
            url: Common.Services.url.REP,
            method: _REPDIOPSPlan_DetailGroupStock.URL.DetailGroupStock_Export,
            data: { lstid: $scope.Item.lstCustomerID, lstgroupid: $scope.Item.lstGroupID, dtfrom: $scope.Item.DateFrom, dtto: $scope.Item.DateTo, statusID: $scope.Item.statusID },
            success: function (res) {
                $rootScope.IsLoading = false;
                $rootScope.DownloadFile(res);
