...
var _REPOwnerEquiment_Index = {
    URL: {
        ...
        SettingAction: 'REPOwner_Equipment_SettingDownload',
    },
    Param: {
    },
    Data: {
...
angular.module('myapp').controller('REPOwnerEquiment_IndexCtrl', ['$rootScope', '$scope', '$http', '$location', '$state', '$timeout', '$stateParams', function ($rootScope, $scope, $http, $location, $state, $timeout, $stateParams) {
    if ($rootScope.IsPageComplete != true) return;
    Common.Log('REPOwnerEquiment_IndexCtrl');
    ...
    Common.Services.Call($http, {
        ...
        method: _REPOwnerEquiment_Index.URL.SettingList,
    ...
    $scope.SettingReport_SaveClick = function ($event, win, vform) {
        ...
        if (vform()) {
            ...
            if (!error) {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.REP,
                    method: _REPOwnerEquiment_Index.URL.SettingSave,
    ...
    $scope.SettingDelete = function (win, datasend) {
        $rootScope.Message({
            ...
            Ok: function () {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.REP,
                    method: _REPOwnerEquiment_Index.URL.SettingDelete,
                    data: { lst: datasend },
                    success: function (res) {
                        $rootScope.Message({
                            Type: Common.Message.Type.Notify,
    ...
    $scope.SettingReport_ActionClickConfirm = function ($event, vform, win) {
        ...
        if (vform() && !error) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.REP,
                method: _REPOwnerEquiment_Index.URL.SettingAction,
    ...
    $scope.ShowSetting = function ($event, grid) {
        ...
        $rootScope.ShowSetting({
            ListView: views.REPOwnerEquiment,
            event: $event,
            grid: grid,
