...
var _REPOwnerPLVehicle_DetailColumn = {
    URL: {
        Search: 'REPOwner_VehicleFee_DetailColumn',
        Template: 'REPOwnerPLVehicle_DetailColumnTemplate',

        Excel_Export: 'REPOwner_VehicleFee_DetailColumn_Export',
...
angular.module('myapp').controller('REPOwnerPLVehicle_DetailColumnCtrl', ['$rootScope', '$scope', '$http', '$location', '$state', '$timeout', '$stateParams', function ($rootScope, $scope, $http, $location, $state, $timeout, $stateParams) {
    if ($rootScope.IsPageComplete != true) return;
    Common.Log('REPOwnerPLVehicle_DetailColumnCtrl');
    ...
    $scope.SearchData = function () {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.REP,
            method: _REPOwnerPLVehicle_DetailColumn.URL.Search,
            ...
            success: function (res) {
                ...
                _REPOwnerPLVehicle_DetailColumn.Data._listData = res.ListData;
                _REPOwnerPLVehicle_DetailColumn.Data._listPrice = res.ListPrice;
                _REPOwnerPLVehicle_DetailColumn.Data._listPriceKey = res.ListPriceKey;
    ...
    $scope.InitGrid = function () {
        ...
        $scope.fieldGrid = [];
        Common.Data.Each(_REPOwnerPLVehicle_DetailColumn.Data._listPriceKey, function (group) {
            var array = []; 
        ...
        var dataGrid = [];
        Common.Data.Each(_REPOwnerPLVehicle_DetailColumn.Data._listData, function (data) {
            for (var i = 0 ; i < _REPOwnerPLVehicle_DetailColumn.Data._listPrice.length ; i++) {
                var price = _REPOwnerPLVehicle_DetailColumn.Data._listPrice[i];
                ...
                if (price.VehicleID == data.VehicleID && dateD.getTime() == dateP.getTime()) {
                    var count = 0;
                    Common.Data.Each(_REPOwnerPLVehicle_DetailColumn.Data._listPriceKey, function (key) {
                        var dataGroup = null;
                        if (price.KeyCode == key.KeyCode) {
                            dataGroup = price;
                            _REPOwnerPLVehicle_DetailColumn.Data._listPrice.splice(i, 1);
                        }
    ...
    $scope.Excel_Click = function ($event) {
        ...
        $rootScope.UploadFile({
            ...
            Complete: function (file) {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.REP,
                    method: _REPOwnerPLVehicle_DetailColumn.URL.Template,
    ...
    $scope.SettingReport = function ($event, win) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.REP,
            method: _REPOwnerPLVehicle_DetailColumn.URL.SettingList,
    ...
    $scope.SettingReport_SaveClick = function ($event, win, vform) {
        ...
        if (vform()) {
            ...
            if (!error) {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.REP,
                    method: _REPOwnerPLVehicle_DetailColumn.URL.SettingSave,
    ...
    $scope.SettingDelete = function (win, datasend) {
        $rootScope.Message({
            ...
            Ok: function () {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.REP,
                    method: _REPOwnerPLVehicle_DetailColumn.URL.SettingDelete,
                    data: { lst: datasend },
                    success: function (res) {
                        $rootScope.Message({
                            Type: Common.Message.Type.Notify,
    ...
    $scope.customerNotIn_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.REP,
            method: _REPOwnerPLVehicle_DetailColumn.URL.SettingCusNotInList,
    ...
    $scope.customerNotIn_Save_Click = function ($event, win, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.REP,
                method: _REPOwnerPLVehicle_DetailColumn.URL.SettingCusNotInSave,
    ...
    $scope.customer_Delete = function ($event, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.REP,
                method: _REPOwnerPLVehicle_DetailColumn.URL.SettingCusDeleteList,
                data: { item: $scope.SettingItem, lst: datasend },
                success: function (res) {
                    $scope.SettingItem = res;
                    if (Common.HasValue(res.ListCustomer)) {
    ...
    $scope.gopNotIn_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.REP,
            method: _REPOwnerPLVehicle_DetailColumn.URL.SettingGOPNotInList,
    ...
    $scope.gopNotIn_Save_Click = function ($event, win, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.REP,
                method: _REPOwnerPLVehicle_DetailColumn.URL.SettingGOPNotInSave,
                data: { item: $scope.SettingItem, lst: datasend },
                success: function (res) {
                    $scope.SettingItem = res;
                    if (Common.HasValue(res.ListGroupProduct)) {
    ...
    $scope.gop_Delete = function ($event, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.REP,
                method: _REPOwnerPLVehicle_DetailColumn.URL.SettingGOPDeleteList,
                data: { item: $scope.SettingItem, lst: datasend },
                success: function (res) {
                    $scope.SettingItem = res;
                    if (Common.HasValue(res.ListGroupProduct)) {
    ...
    $scope.Excel_Export = function ($event) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.REP,
            method: _REPOwnerPLVehicle_DetailColumn.URL.Excel_Export,
