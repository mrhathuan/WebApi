...
var _REPCOPL_OrderColumn = {
    URL: {
        Search: 'REPCOPL_ColumnOrderData',

        Read_Customer: 'REP_Customer_Read',

        Excel_Export: 'REPCOPL_OrderColumn_Export',
...
angular.module('myapp').controller('REPCOPL_OrderColumnCtrl', ['$rootScope', '$scope', '$http', '$location', '$state', '$timeout', '$stateParams', function ($rootScope, $scope, $http, $location, $state, $timeout, $stateParams) {
    if ($rootScope.IsPageComplete != true) return;
    Common.Log('REPCOPL_OrderColumnCtrl');
    ...
    Common.Services.Call($http, {
        ...
        method: _REPCOPL_OrderColumn.URL.Read_Customer,
        data: {},
    ...
    $scope.LoadData = function () {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.REP,
            method: _REPCOPL_OrderColumn.URL.Search,
            data: { lstid: $scope.Item.lstCustomerID, dtfrom: $scope.Item.DateFrom, dtto: $scope.Item.DateTo },
            success: function (res) {
                $rootScope.IsLoading = false;
                _REPCOPL_OrderColumn.Data._ListData = res.ListData;
                _REPCOPL_OrderColumn.Data._ListColumn = res.ListColumn;
                _REPCOPL_OrderColumn.Data._ListColumnKey = res.ListColumnKey;
                $scope.InitGrid();
            },
            error: function (res) {
                $rootScope.IsLoading = false;
    ...
    $scope.InitGrid = function () {
        ...
        var GridColumn = [
            ...
            {
                field: 'IncomeTrouble', title: '<b>IncomeTrouble</b><br>[IncomeTrouble]', width: '120px', template: '#=IncomeTrouble==null?" ":Common.Number.ToMoney(IncomeTrouble)#',
            ...
            {
                field: 'Description', title: '<b>Mô tả nhóm hàng</b><br>[Description]', width: '120px',
                filterable: { cell: { operator: 'contains', showOperators: false } }
            },
            {
        ...
        $scope.fieldGrid = [];
        Common.Data.Each(_REPCOPL_OrderColumn.Data._ListColumnKey, function (group) {
            var array = [];
        ...
        $scope.OrderColumn_grid.setOptions({
            ...
            height: '100%', pageable: true, sortable: { mode: 'multiple', allowUnsort: true }, columnMenu: false, resizable: true, reorderable: false, filterable: { mode: 'row' }, editable: false, pageSize: 20,
            columns: GridColumn
        });

        var dataGrid = []; 
        Common.Data.Each(_REPCOPL_OrderColumn.Data._ListData, function (data) {
            for (var i = 0 ; i < _REPCOPL_OrderColumn.Data._ListColumn.length ; i++) {
                var group = _REPCOPL_OrderColumn.Data._ListColumn[i];
                if (group.OrderID == data.OrderID && group.LocationToID == data.LocationToID && group.LocationFromID == data.LocationFromID) {
                    debugger
                    var count = 0;
                    Common.Data.Each(_REPCOPL_OrderColumn.Data._ListColumnKey, function (key) {
                        var dataGroup = null;
                        if (group.KeyCode == key.KeyCode && group.PackingID == key.PackingID) {
                            dataGroup = group;
                            _REPCOPL_OrderColumn.Data._ListColumn.splice(i, 1);
                        }
    ...
    $scope.Excel_Click = function ($event) {
        ...
        $rootScope.UploadFile({
            ...
            Complete: function (file) {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.REP,
                    method: _REPCOPL_OrderColumn.URL.Template,
    ...
    $scope.SettingReport = function ($event, win) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.REP,
            method: _REPCOPL_OrderColumn.URL.SettingList,
    ...
    $scope.SettingReport_SaveClick = function ($event, win, vform) {
        ...
        if (vform()) {
            ...
            if (!error) {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.REP,
                    method: _REPCOPL_OrderColumn.URL.SettingSave,
    ...
    $scope.SettingDelete = function (win, datasend) {
        $rootScope.Message({
            ...
            Ok: function () {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.REP,
                    method: _REPCOPL_OrderColumn.URL.SettingDelete,
                    data: { lst: datasend },
                    success: function (res) {
                        $rootScope.Message({
                            Type: Common.Message.Type.Notify,
    ...
    $scope.SettingReport_ActionClick = function ($event, data) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.REP,
            method: _REPCOPL_OrderColumn.URL.SettingAction,
    ...
    $scope.customerNotIn_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.REP,
            method: _REPCOPL_OrderColumn.URL.SettingCusNotInList,
    ...
    $scope.customerNotIn_Save_Click = function ($event, win, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.REP,
                method: _REPCOPL_OrderColumn.URL.SettingCusNotInSave,
    ...
    $scope.customer_Delete = function ($event, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.REP,
                method: _REPCOPL_OrderColumn.URL.SettingCusDeleteList,
                data: { item: $scope.SettingItem, lst: datasend },
                success: function (res) {
                    $scope.SettingItem = res;
                    if (Common.HasValue(res.ListCustomer)) {
    ...
    $scope.ProvinceNotIn_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.REP,
            method: _REPCOPL_OrderColumn.URL.SettingProvinceInList,
    ...
    $scope.ProvinNotIn_Save_Click = function ($event, win, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.REP,
                method: _REPCOPL_OrderColumn.URL.SettingProvinceNotInSave,
    ...
    $scope.Province_Delete = function ($event, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.REP,
                method: _REPCOPL_OrderColumn.URL.SettingProvinceDeleteList,
                data: { item: $scope.SettingItem, lstProvinceID: datasend },
                success: function (res) {
                    $scope.SettingItem = res;
                    if (Common.HasValue(res.ListProvince)) {
    ...
    $scope.ServiceOfOrderNotIn_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.REP,
            method: _REPCOPL_OrderColumn.URL.SettingServiceOfOrderInList,
    ...
    $scope.ServiceOfOrderNotIn_Save_Click = function ($event, win, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.REP,
                method: _REPCOPL_OrderColumn.URL.SettingServiceOfOrderNotInSave,
    ...
    $scope.ServiceOfOrder_Delete = function ($event, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.REP,
                method: _REPCOPL_OrderColumn.URL.SettingServiceOfOrderDeleteList,
                data: { item: $scope.SettingItem, lstServiceOfOrderID: datasend },
                success: function (res) {
                    $scope.SettingItem = res;
                    if (Common.HasValue(res.ListServiceOfOrder)) {
    ...
    $scope.Excel_Export = function ($event) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.REP,
            method: _REPCOPL_OrderColumn.URL.Excel_Export,
            data: { lstid: $scope.Item.lstCustomerID, dtfrom: $scope.Item.DateFrom, dtto: $scope.Item.DateTo },
            success: function (res) {
                $rootScope.IsLoading = false;
                $rootScope.DownloadFile(res);
