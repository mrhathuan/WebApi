...
var _REPDIOPSPlan_DetailColumn = {
    URL: {
        Search: 'REPDIOPSPlan_DetailColumn',
        Template: 'REPDIOPSPlan_DetailColumnTemplate',

        Read_Customer: 'REP_Customer_Read',
        Read_GroupOfProduct: 'REP_GroupOfProduct_Read',

        DetailColumn_Export: 'REPDIOPSPlan_DetailColumn_Export',
...
angular.module('myapp').controller('REPDIOPSPlan_DetailColumnCtrl', ['$rootScope', '$scope', '$http', '$location', '$state', '$timeout', '$stateParams', function ($rootScope, $scope, $http, $location, $state, $timeout, $stateParams) {
    if ($rootScope.IsPageComplete != true) return;
    Common.Log('REPDIOPSPlan_DetailColumnCtrl');
    ...
    $scope.mulCustomer_Options = {
        ...
        change: function () {
            ...
            Common.Services.Call($http, {
                ...
                method: _REPDIOPSPlan_DetailColumn.URL.Read_GroupOfProduct,
                data: { lstid: lstid },
    ...
    Common.Services.Call($http, {
        url: Common.Services.url.REP,
        method: _REPDIOPSPlan_DetailColumn.URL.Read_Customer,
        data: {},
        success: function (res) {
    ...
    $scope.SearchData = function () {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.REP,
            method: _REPDIOPSPlan_DetailColumn.URL.Search,
            ...
            success: function (res) {
                ...
                _REPDIOPSPlan_DetailColumn.Data._listData = res.ListData;
                _REPDIOPSPlan_DetailColumn.Data._listColumn = res.ListColumn;
                _REPDIOPSPlan_DetailColumn.Data._listColumnKey = res.ListColumnKey;
    ...
    $scope.InitGrid = function () {
        ...
        $scope.fieldGrid = [];
        Common.Data.Each(_REPDIOPSPlan_DetailColumn.Data._listColumnKey, function (group) {
            var array = [];
        ...
        var dataGrid = [];
        Common.Data.Each(_REPDIOPSPlan_DetailColumn.Data._listData, function (data) {
            for (var i = 0 ; i < _REPDIOPSPlan_DetailColumn.Data._listColumn.length ; i++) {
                var group = _REPDIOPSPlan_DetailColumn.Data._listColumn[i];
                if (group.DITOMasterID == data.DITOMasterID && group.OrderID == data.OrderID && group.StockID == data.StockID && group.LocationToID == data.LocationToID) {
                    var count = 0;
                    Common.Data.Each(_REPDIOPSPlan_DetailColumn.Data._listColumnKey, function (key) {
                        var dataGroup = null;
                        if (group.GroupOfProductID == key.GroupOfProductID) {
                            dataGroup = group;
                            _REPDIOPSPlan_DetailColumn.Data._listColumn.splice(i, 1);
                        }
    ...
    $scope.Excel_Click = function ($event) {
        ...
        $rootScope.UploadFile({
            ...
            Complete: function (file) {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.REP,
                    method: _REPDIOPSPlan_DetailColumn.URL.Template,
    ...
    $scope.SettingReport = function ($event, win) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.REP,
            method: _REPDIOPSPlan_DetailColumn.URL.SettingList,
    ...
    $scope.SettingReport_SaveClick = function ($event, win, vform) {
        ...
        if (vform()) {
            ...
            if (!error) {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.REP,
                    method: _REPDIOPSPlan_DetailColumn.URL.SettingSave,
    ...
    $scope.SettingDelete = function (win, datasend) {
        $rootScope.Message({
            ...
            Ok: function () {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.REP,
                    method: _REPDIOPSPlan_DetailColumn.URL.SettingDelete,
                    data: { lst: datasend },
                    success: function (res) {
                        $rootScope.Message({
                            Type: Common.Message.Type.Notify,
    ...
    $scope.customerNotIn_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.REP,
            method: _REPDIOPSPlan_DetailColumn.URL.SettingCusNotInList,
    ...
    $scope.customerNotIn_Save_Click = function ($event, win, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.REP,
                method: _REPDIOPSPlan_DetailColumn.URL.SettingCusNotInSave,
    ...
    $scope.customer_Delete = function ($event, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.REP,
                method: _REPDIOPSPlan_DetailColumn.URL.SettingCusDeleteList,
                data: { item: $scope.SettingItem, lst: datasend },
                success: function (res) {
                    $scope.SettingItem = res;
                    if (Common.HasValue(res.ListCustomer)) {
    ...
    $scope.gopNotIn_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.REP,
            method: _REPDIOPSPlan_DetailColumn.URL.SettingGOPNotInList,
    ...
    $scope.gopNotIn_Save_Click = function ($event, win, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.REP,
                method: _REPDIOPSPlan_DetailColumn.URL.SettingGOPNotInSave,
                data: { item: $scope.SettingItem, lst: datasend },
                success: function (res) {
                    $scope.SettingItem = res;
                    if (Common.HasValue(res.ListGroupProduct)) {
    ...
    $scope.gop_Delete = function ($event, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.REP,
                method: _REPDIOPSPlan_DetailColumn.URL.SettingGOPDeleteList,
                data: { item: $scope.SettingItem, lst: datasend },
                success: function (res) {
                    $scope.SettingItem = res;
                    if (Common.HasValue(res.ListGroupProduct)) {
    ...
    //#endregion
    $scope.REPDIOPSPlan_DetailColumn_Export = function ($event) {
        $event.preventDefault();

        $rootScope.IsLoading = true;
        Common.Services.Call($http, {
            url: Common.Services.url.REP,
            method: _REPDIOPSPlan_DetailColumn.URL.DetailColumn_Export,
            data: { lstid: $scope.Item.lstCustomerID, lstgroupid: $scope.Item.lstGroupID, dtfrom: $scope.Item.DateFrom, dtto: $scope.Item.DateTo, statusID: $scope.Item.statusID },
            success: function (res) {
                $rootScope.IsLoading = false;
                $rootScope.DownloadFile(res);
