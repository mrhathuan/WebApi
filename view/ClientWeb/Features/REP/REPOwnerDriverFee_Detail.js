...
var _REPOwnerDriverFee_Detail = {
    URL: {
        Search: 'REPOwner_DriverFee',
        Schedule_Read: 'REPOwner_Schedule',
        Template: 'REPOwner_DriverFee_Template',
        ...
        Excel_Export: 'REPOwner_DriverFee_Export',
    },
}

angular.module('myapp').controller('REPOwnerDriverFee_DetailCtrl', ['$rootScope', '$scope', '$http', '$location', '$state', '$timeout', '$stateParams', function ($rootScope, $scope, $http, $location, $state, $timeout, $stateParams) {
    if ($rootScope.IsPageComplete != true) return;
    Common.Log('REPOwnerDriverFee_DetailCtrl');
    ...
    Common.Services.Call($http, {
        ...
        method: _REPOwnerDriverFee_Detail.URL.Schedule_Read,
        data: {},
    ...
    $scope.REPOwnerDriverFee_gridOptions = {
        dataSource: Common.DataSource.Local({
            data: [],
            model: {
                id: 'ID',
        ...
        columns: [
            ...
            {
                field: 'CostName', title: '<b>Khoản lương</b><br>[CostName]', width: '120px',
                filterable: { cell: { operator: 'contains', showOperators: false } }
            },
            {
                field: 'CostUnitPrice', title: '<b>Đơn giá</b><br>[CostUnitPrice]', width: '120px', template: '#=CostUnitPrice==null?" ":Common.Number.ToMoney(CostUnitPrice)#',
                filterable: { cell: { operator: 'gte', showOperators: false } }
            },
            {
                field: 'CostQuantity', title: '<b>Số lượng</b><br>[CostQuantity]', width: '120px', template: '#=CostQuantity==null?" ":Common.Number.ToNumber3(CostQuantity)#',
                filterable: { cell: { operator: 'gte', showOperators: false } }
            },
            {
                field: 'Cost', title: '<b>Số tiền</b><br>[Cost]', width: '120px', template: '#=Cost==null?" ":Common.Number.ToMoney(Cost)#',
                filterable: { cell: { operator: 'gte', showOperators: false } }
            },
            {
                field: 'TotalCost', title: '<b>Tổng tiền</b><br>[TotalCost]', width: '120px', template: '#=TotalCost==null?" ":Common.Number.ToMoney(TotalCost)#',
                filterable: { cell: { operator: 'gte', showOperators: false } }
            },
            {
            ...
            {
                field: 'DaysAllowOff', title: '<b>Số ngày nghỉ</b><br>[DaysAllowOff]', width: '120px', template: '#=DaysAllowOff==null?" ":Common.Number.ToNumber1(DaysAllowOff)#',
                filterable: { cell: { operator: 'gte', showOperators: false } }
            },
            {
                field: 'DaysAllowOffRemain', title: '<b>Số ngày nghỉ còn lại</b><br>[DaysAllowOffRemain]', width: '120px', template: '#=DaysAllowOffRemain==null?" ":Common.Number.ToNumber1(DaysAllowOffRemain)#',
                filterable: { cell: { operator: 'gte', showOperators: false } }
            },
            {
                field: 'DaysWorkInOn', title: '<b>Số ngày làm việc</b><br>[DaysWorkInOn]', width: '120px', template: '#=DaysWorkInOn==null?" ":Common.Number.ToNumber1(DaysWorkInOn)#',
                filterable: { cell: { operator: 'gte', showOperators: false } }
            },
            {
                field: 'DaysWorkInOff', title: '<b>Số ngày ko làm việc</b><br>[DaysWorkInOff]', width: '120px', template: '#=DaysWorkInOff==null?" ":Common.Number.ToNumber1(DaysWorkInOff)#',
                filterable: { cell: { operator: 'gte', showOperators: false } }
            },
            {
                field: 'DaysWorkInHoliday', title: '<b>Số ngày lễ</b><br>[DaysWorkInHoliday]', width: '120px', template: '#=DaysWorkInHoliday==null?" ":Common.Number.ToNumber1(DaysWorkInHoliday)#',
                filterable: { cell: { operator: 'gte', showOperators: false } }
            },
            {
                field: 'TypeOfScheduleFeeCode', title: '<b>Mã loại ngày</b><br>[TypeOfScheduleFeeCode]', width: '120px',
                filterable: { cell: { operator: 'contains', showOperators: false } }
            },
            {
                field: 'TypeOfScheduleFeeName', title: '<b>Loại ngày</b><br>[TypeOfScheduleFeeName]', width: '120px',
                filterable: { cell: { operator: 'contains', showOperators: false } }
            },
            {
                field: 'TypeOfScheduleFeeDay', title: '<b>Số ngày</b><br>[TypeOfScheduleFeeDay]', width: '120px', template: '#=TypeOfScheduleFeeDay==null?" ":Common.Number.ToNumber1(TypeOfScheduleFeeDay)#',
                filterable: { cell: { operator: 'gte', showOperators: false } }
            },
        ...
        $('.dtp-filter-from').kendoDatePicker({
            ...
            change: function (e) {
                try {
                    ...
                    var filters = [];
                    if (Common.HasValue($scope.REPOwnerDriverFee_gridOptions.dataSource.filter())) {
                        filters = $scope.REPOwnerDriverFee_gridOptions.dataSource.filter().filters;
                    ...
                    $scope.REPOwnerDriverFee_gridOptions.dataSource.filter(filters);
                }
                catch (e) {
    ...
    $scope.Search_Click = function ($event) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.REP,
            method: _REPOwnerDriverFee_Detail.URL.Search,
            ...
            success: function (res) {
                ...
                $scope.REPOwnerDriverFee_gridOptions.dataSource.data(res);
            },
            error: function (res) {
                $rootScope.IsLoading = false;
            }
    ...
    $scope.Excel_Click = function ($event) {
        ...
        var request = Common.Request.CreateFromGrid($scope.REPOwnerDriverFee_gridOptions.dataSource);
        ...
        $rootScope.UploadFile({
            ...
            Complete: function (file) {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.REP,
                    method: _REPOwnerDriverFee_Detail.URL.Template,
                    data: { itemfile: file, request: request, scheduleID: $scope.Item.ScheduleID },
                    success: function (res) {
                        $rootScope.IsLoading = false;
    ...
    $scope.SettingReport = function ($event, win) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.REP,
            method: _REPOwnerDriverFee_Detail.URL.SettingList,
    ...
    $scope.SettingReport_SaveClick = function ($event, win, vform) {
        ...
        if (vform()) {
            ...
            if (!error) {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.REP,
                    method: _REPOwnerDriverFee_Detail.URL.SettingSave,
    ...
    $scope.SettingDelete = function (win, datasend) {
        $rootScope.Message({
            ...
            Ok: function () {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.REP,
                    method: _REPOwnerDriverFee_Detail.URL.SettingDelete,
                    data: { lst: datasend },
                    success: function (res) {
                        $rootScope.Message({
                            Type: Common.Message.Type.Notify,
    ...
    $scope.SettingReport_ActionClick = function ($event, data) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.REP,
            method: _REPOwnerDriverFee_Detail.URL.SettingAction,
    ...
    $scope.customerNotIn_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.REP,
            method: _REPOwnerDriverFee_Detail.URL.SettingCusNotInList,
    ...
    $scope.customerNotIn_Save_Click = function ($event, win, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.REP,
                method: _REPOwnerDriverFee_Detail.URL.SettingCusNotInSave,
    ...
    $scope.customer_Delete = function ($event, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.REP,
                method: _REPOwnerDriverFee_Detail.URL.SettingCusDeleteList,
                data: { item: $scope.SettingItem, lst: datasend },
                success: function (res) {
                    $scope.SettingItem = res;
                    if (Common.HasValue(res.ListCustomer)) {
    ...
    $scope.gopNotIn_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.REP,
            method: _REPOwnerDriverFee_Detail.URL.SettingGOPNotInList,
    ...
    $scope.gopNotIn_Save_Click = function ($event, win, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.REP,
                method: _REPOwnerDriverFee_Detail.URL.SettingGOPNotInSave,
                data: { item: $scope.SettingItem, lst: datasend },
                success: function (res) {
                    $scope.SettingItem = res;
                    if (Common.HasValue(res.ListGroupProduct)) {
    ...
    $scope.gop_Delete = function ($event, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.REP,
                method: _REPOwnerDriverFee_Detail.URL.SettingGOPDeleteList,
                data: { item: $scope.SettingItem, lst: datasend },
                success: function (res) {
                    $scope.SettingItem = res;
                    if (Common.HasValue(res.ListGroupProduct)) {
    ...
    $scope.Excel_Export = function ($event) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.REP,
            method: _REPOwnerDriverFee_Detail.URL.Excel_Export,
            data: { },
            success: function (res) {
                $rootScope.IsLoading = false;
                $rootScope.DownloadFile(res);
