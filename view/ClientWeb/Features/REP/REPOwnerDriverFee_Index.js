...
angular.module('myapp').controller('REPOwnerDriverFee_IndexCtrl', ['$rootScope', '$scope', '$http', '$location', '$state', '$timeout', '$stateParams', function ($rootScope, $scope, $http, $location, $state, $timeout, $stateParams) {
    if ($rootScope.IsPageComplete != true) return;
    Common.Log('REPOwnerDriverFee_IndexCtrl');
    ...
    Common.Services.Call($http, {
        ...
        method: _REPOwnerDriverFee_Index.URL.Schedule_Read,
        data: {},
        success: function (res) {
            debugger
            if (Common.HasValue(res.Data) && res.Data.length > 0) {
                $scope.ItemDownload.ScheduleID = res.Data[1].ID;
            }
    ...
    Common.Services.Call($http, {
        url: Common.Services.url.REP,
        method: _REPOwnerDriverFee_Index.URL.SettingList,
    ...
    $scope.SettingReport_SaveClick = function ($event, win, vform) {
        ...
        if (vform()) {
            ...
            if (!error) {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.REP,
                    method: _REPOwnerDriverFee_Index.URL.SettingSave,
    ...
    $scope.SettingDelete = function (win, datasend) {
        $rootScope.Message({
            ...
            Ok: function () {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.REP,
                    method: _REPOwnerDriverFee_Index.URL.SettingDelete,
                    data: { lst: datasend },
                    success: function (res) {
                        $rootScope.Message({
                            Type: Common.Message.Type.Notify,
    ...
    $scope.SettingReport_ActionClickConfirm = function ($event, vform, win) {
        ...
        var request = "";//Common.Request.CreateFromGrid($scope.settingReport_GridOptions.dataSource);
        var error = false;
        if (!Common.HasValue($scope.ItemDownload.ScheduleID) || $scope.ItemDownload.ScheduleID <= 0) {
            error = true;
            $rootScope.Message({ Msg: 'Chưa chọn kì lương', NotifyType: Common.Message.NotifyType.ERROR });
        }
        if (vform() && !error) {
            $rootScope.IsLoading = true;
            Common.Services.Call($http, {
                url: Common.Services.url.REP,
                method: _REPOwnerDriverFee_Index.URL.SettingAction,
                data: { item: $scope.ItemDownload.data, scheduleID: $scope.ItemDownload.ScheduleID, request: request },
                success: function (res) {
                    $rootScope.IsLoading = false;
    ...
    $scope.customerNotIn_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.REP,
            method: _REPOwnerDriverFee_Index.URL.SettingCusNotInList,
    ...
    $scope.customerNotIn_Save_Click = function ($event, win, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.REP,
                method: _REPOwnerDriverFee_Index.URL.SettingCusNotInSave,
    ...
    $scope.customer_Delete = function ($event, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.REP,
                method: _REPOwnerDriverFee_Index.URL.SettingCusDeleteList,
                data: { item: $scope.SettingItem, lst: datasend },
                success: function (res) {
                    $scope.SettingItem = res;
                    if (Common.HasValue(res.ListCustomer)) {
    ...
    $scope.gopNotIn_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.REP,
            method: _REPOwnerDriverFee_Index.URL.SettingGOPNotInList,
    ...
    $scope.gopNotIn_Save_Click = function ($event, win, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.REP,
                method: _REPOwnerDriverFee_Index.URL.SettingGOPNotInSave,
                data: { item: $scope.SettingItem, lst: datasend },
                success: function (res) {
                    $scope.SettingItem = res;
                    if (Common.HasValue(res.ListGroupProduct)) {
    ...
    $scope.gop_Delete = function ($event, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.REP,
                method: _REPOwnerDriverFee_Index.URL.SettingGOPDeleteList,
                data: { item: $scope.SettingItem, lst: datasend },
                success: function (res) {
                    $scope.SettingItem = res;
                    if (Common.HasValue(res.ListGroupProduct)) {
    ...
    $scope.Back_Click = function ($event) {
        ...
        $state.go("main.REPOwnerDriverFee.Index");
    }
    //#endregion
