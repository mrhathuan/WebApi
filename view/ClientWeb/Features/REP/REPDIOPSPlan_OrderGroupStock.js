...
var _REPDIOPSPlan_OrderGroupStock = {
    URL: {
        Search: 'REPDIOPSPlan_OrderGroupStock',
        Template: 'REPDIOPSPlan_OrderGroupStockTemplate',

        Read_Customer: 'REP_Customer_Read',
        Read_GroupOfProduct: 'REP_GroupOfProduct_Read',

        OrderGroupStock_Export: 'REPDIOPSPlan_OrderGroupStock_Export',
...
angular.module('myapp').controller('REPDIOPSPlan_OrderGroupStockCtrl', ['$rootScope', '$scope', '$http', '$location', '$state', '$timeout', '$stateParams', function ($rootScope, $scope, $http, $location, $state, $timeout, $stateParams) {
    if ($rootScope.IsPageComplete != true) return;
    Common.Log('REPDIOPSPlan_OrderGroupStockCtrl');
    ...
    $scope.mulCustomer_Options = {
        ...
        change: function () {
            ...
            Common.Services.Call($http, {
                ...
                method: _REPDIOPSPlan_OrderGroupStock.URL.Read_GroupOfProduct,
                data: { lstid: lstid },
    ...
    Common.Services.Call($http, {
        url: Common.Services.url.REP,
        method: _REPDIOPSPlan_OrderGroupStock.URL.Read_Customer,
        data: {},
        success: function (res) {
    ...
    $scope.SearchData = function () {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.REP,
            method: _REPDIOPSPlan_OrderGroupStock.URL.Search,
            ...
            success: function (res) {
                ...
                _REPDIOPSPlan_OrderGroupStock.Data._listData = res.ListData;
                _REPDIOPSPlan_OrderGroupStock.Data._listColumn = res.ListColumn;
                _REPDIOPSPlan_OrderGroupStock.Data._listColumnKey = res.ListColumnKey;
    ...
    $scope.InitGrid = function () {
        ...
        $scope.fieldGrid = [];
        Common.Data.Each(_REPDIOPSPlan_OrderGroupStock.Data._listColumnKey, function (group) {
            var array = [];
        ...
        var dataGrid = [];
        Common.Data.Each(_REPDIOPSPlan_OrderGroupStock.Data._listData, function (data) {
            for (var i = 0 ; i < _REPDIOPSPlan_OrderGroupStock.Data._listColumn.length ; i++) {
                var group = _REPDIOPSPlan_OrderGroupStock.Data._listColumn[i];
                if (group.StockID == data.StockID && group.LocationToID == data.LocationToID && group.OrderID == data.OrderID) {
                    var count = 0;
                    Common.Data.Each(_REPDIOPSPlan_OrderGroupStock.Data._listColumnKey, function (key) {
                        var dataGroup = null;
                        if (group.GroupOfProductID == key.GroupOfProductID) {
                            dataGroup = group;
                            _REPDIOPSPlan_OrderGroupStock.Data._listColumn.splice(i, 1);
                        }
    ...
    $scope.Excel_Click = function ($event) {
        ...
        $rootScope.UploadFile({
            ...
            Complete: function (file) {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.REP,
                    method: _REPDIOPSPlan_OrderGroupStock.URL.Template,
    ...
    $scope.SettingReport = function ($event, win) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.REP,
            method: _REPDIOPSPlan_OrderGroupStock.URL.SettingList,
    ...
    $scope.SettingReport_SaveClick = function ($event, win, vform) {
        ...
        if (vform()) {
            ...
            if (!error) {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.REP,
                    method: _REPDIOPSPlan_OrderGroupStock.URL.SettingSave,
    ...
    $scope.SettingDelete = function (win, datasend) {
        $rootScope.Message({
            ...
            Ok: function () {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.REP,
                    method: _REPDIOPSPlan_OrderGroupStock.URL.SettingDelete,
                    data: { lst: datasend },
                    success: function (res) {
                        $rootScope.Message({
                            Type: Common.Message.Type.Notify,
    ...
    $scope.customerNotIn_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.REP,
            method: _REPDIOPSPlan_OrderGroupStock.URL.SettingCusNotInList,
    ...
    $scope.customerNotIn_Save_Click = function ($event, win, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.REP,
                method: _REPDIOPSPlan_OrderGroupStock.URL.SettingCusNotInSave,
    ...
    $scope.customer_Delete = function ($event, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.REP,
                method: _REPDIOPSPlan_OrderGroupStock.URL.SettingCusDeleteList,
                data: { item: $scope.SettingItem, lst: datasend },
                success: function (res) {
                    $scope.SettingItem = res;
                    if (Common.HasValue(res.ListCustomer)) {
    ...
    $scope.gopNotIn_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.REP,
            method: _REPDIOPSPlan_OrderGroupStock.URL.SettingGOPNotInList,
    ...
    $scope.gopNotIn_Save_Click = function ($event, win, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.REP,
                method: _REPDIOPSPlan_OrderGroupStock.URL.SettingGOPNotInSave,
                data: { item: $scope.SettingItem, lst: datasend },
                success: function (res) {
                    $scope.SettingItem = res;
                    if (Common.HasValue(res.ListGroupProduct)) {
    ...
    $scope.gop_Delete = function ($event, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.REP,
                method: _REPDIOPSPlan_OrderGroupStock.URL.SettingGOPDeleteList,
                data: { item: $scope.SettingItem, lst: datasend },
                success: function (res) {
                    $scope.SettingItem = res;
                    if (Common.HasValue(res.ListGroupProduct)) {
    ...
    //#endregion
    $scope.REPDIOPSPlan_OrderGroupStock_Export = function ($event) {
        $event.preventDefault();

        $rootScope.IsLoading = true;
        Common.Services.Call($http, {
            url: Common.Services.url.REP,
            method: _REPDIOPSPlan_OrderGroupStock.URL.OrderGroupStock_Export,
            data: { lstid: $scope.Item.lstCustomerID, lstgroupid: $scope.Item.lstGroupID, dtfrom: $scope.Item.DateFrom, dtto: $scope.Item.DateTo, statusID: $scope.Item.statusID },
            success: function (res) {
                $rootScope.IsLoading = false;
                $rootScope.DownloadFile(res);
