...
var _REPCOOPSPlan_DetailColumn = {
    URL: {
        Search: 'REPCOOPSPlan_ColumnDetailData',

        Read_Customer: 'REP_Customer_Read',

        Excel_Export: 'REPCOOPSPlan_ColumnDetail_Export',
...
angular.module('myapp').controller('REPCOOPSPlan_DetailColumnCtrl', ['$rootScope', '$scope', '$http', '$location', '$state', '$timeout', '$stateParams', function ($rootScope, $scope, $http, $location, $state, $timeout, $stateParams) {
    if ($rootScope.IsPageComplete != true) return;
    Common.Log('REPCOOPSPlan_DetailColumnCtrl');
    $rootScope.IsLoading = false;

    $scope.Auth = $rootScope.GetAuth();

    $scope.SettingItem = { ID: 0 };
    $scope.arrayColumn = ['PackingCode', 'Quantity'];
    $scope.arrayColumnRS = ['Loại cont', 'Số lượng'];
    $scope.fieldGrid = [];
    ...
    Common.Services.Call($http, {
        ...
        method: _REPCOOPSPlan_DetailColumn.URL.Read_Customer,
        data: {},
    ...
    $scope.SearchData = function () {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.REP,
            method: _REPCOOPSPlan_DetailColumn.URL.Search,
            ...
            success: function (res) {
                ...
                _REPCOOPSPlan_DetailColumn.Data._listData = res.ListData;
                _REPCOOPSPlan_DetailColumn.Data._listColumn = res.ListColumn;
                _REPCOOPSPlan_DetailColumn.Data._listColumnKey = res.ListColumnKey;
    ...
    $scope.InitGrid = function () {
        ...
        var GridColumn = [
            ...
            {
                field: 'OrderContainerETD', title: '<b>Ngày tới kho đ/h</b><br>[OrderContainerETD]', width: '120px', template: '#=Common.Date.FromJsonDMYHM(OrderContainerETD)#',
                filterable: {
                    cell: {
                        template: function (e) {
                            var element = e.element.parent();
                            element.empty();
                            $("<input class='dtp-filter-from' data-field='OrderContainerETD' style='width:50%; float:left;' />").appendTo(element);
                            $("<input class='dtp-filter-to' data-field='OrderContainerETD' style='width:50%; float:left;' />").appendTo(element);
                        }, showOperators: false
                    }
                },
            },
            {
                field: 'OrderContainerETA', title: '<b>Ngày giao hàng đ/h</b><br>[OrderContainerETA]', width: '120px', template: '#=Common.Date.FromJsonDMYHM(OrderContainerETA)#',
                filterable: {
                    cell: {
                        template: function (e) {
                            var element = e.element.parent();
                            element.empty();
                            $("<input class='dtp-filter-from' data-field='OrderContainerETA' style='width:50%; float:left;' />").appendTo(element);
                            $("<input class='dtp-filter-to' data-field='OrderContainerETA' style='width:50%; float:left;' />").appendTo(element);
                        }, showOperators: false
                    }
                },
            },
            {
                field: 'OrderContainerETDRequest', title: '<b>Ngày y/c tới kho đ/h</b><br>[OrderContainerETDRequest]', width: '120px', template: '#=Common.Date.FromJsonDMYHM(OrderContainerETDRequest)#',
                filterable: {
                    cell: {
                        template: function (e) {
                            var element = e.element.parent();
                            element.empty();
                            $("<input class='dtp-filter-from' data-field='OrderContainerETDRequest' style='width:50%; float:left;' />").appendTo(element);
                            $("<input class='dtp-filter-to' data-field='OrderContainerETDRequest' style='width:50%; float:left;' />").appendTo(element);
                        }, showOperators: false
                    }
                },
            },
            {
                field: 'OrderContainerETARequest', title: '<b>Ngày y/c giao hàng đ/h</b><br>[OrderContainerETARequest]', width: '120px', template: '#=Common.Date.FromJsonDMYHM(OrderContainerETARequest)#',
                filterable: {
                    cell: {
                        template: function (e) {
                            var element = e.element.parent();
                            element.empty();
                            $("<input class='dtp-filter-from' data-field='OrderContainerETARequest' style='width:50%; float:left;' />").appendTo(element);
                            $("<input class='dtp-filter-to' data-field='OrderContainerETARequest' style='width:50%; float:left;' />").appendTo(element);
                        }, showOperators: false
                    }
                },
            },
            ...
            {
                field: 'InspectionDate', title: '<b>Thời gian gửi tờ khai kiểm hoá</b><br>[InspectionDate]', width: '120px', template: '#=Common.Date.FromJsonDMYHM(InspectionDate)#',
                filterable: {
                    cell: {
                        template: function (e) {
                            var element = e.element.parent();
            ...
            {
                field: 'ORDContainerTon', title: '<b>Trọng tải</b><br>[ORDContainerTon]', width: '120px', template: '#=ORDContainerTon==null?" ":Common.Number.ToNumber3(ORDContainerTon)#',
        ...
        $scope.fieldGrid = [];
        Common.Data.Each(_REPCOOPSPlan_DetailColumn.Data._listColumnKey, function (group) {
            var array = [];
        ...
        var dataGrid = [];
        Common.Data.Each(_REPCOOPSPlan_DetailColumn.Data._listData, function (data) {
            for (var i = 0 ; i < _REPCOOPSPlan_DetailColumn.Data._listColumn.length ; i++) {
                var group = _REPCOOPSPlan_DetailColumn.Data._listColumn[i];
                if (group.COTOMasterID == data.COTOMasterID && group.OrderID == data.OrderID && group.LocationFromID == data.LocationFromID && group.LocationToID == data.LocationToID) {
                    var count = 0;
                    Common.Data.Each(_REPCOOPSPlan_DetailColumn.Data._listColumnKey, function (key) {
                        var dataGroup = null;
                        if (group.KeyCode == key.KeyCode) {
                            dataGroup = group;
                            _REPCOOPSPlan_DetailColumn.Data._listColumn.splice(i, 1);
                        }

                        if (dataGroup != null) {
                            data[$scope.fieldGrid[count][0]] = dataGroup.PackingCode;
                            data[$scope.fieldGrid[count][1]] = dataGroup.Quantity;
                        } else {
    ...
    $scope.Excel_Click = function ($event) {
        ...
        $rootScope.UploadFile({
            ...
            Complete: function (file) {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.REP,
                    method: _REPCOOPSPlan_DetailColumn.URL.Template,
    ...
    $scope.SettingReport = function ($event, win) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.REP,
            method: _REPCOOPSPlan_DetailColumn.URL.SettingList,
    ...
    $scope.SettingReport_SaveClick = function ($event, win, vform) {
        ...
        if (vform()) {
            ...
            if (!error) {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.REP,
                    method: _REPCOOPSPlan_DetailColumn.URL.SettingSave,
    ...
    $scope.SettingDelete = function (win, datasend) {
        $rootScope.Message({
            ...
            Ok: function () {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.REP,
                    method: _REPCOOPSPlan_DetailColumn.URL.SettingDelete,
                    data: { lst: datasend },
                    success: function (res) {
                        $rootScope.Message({
                            Type: Common.Message.Type.Notify,
    ...
    $scope.SettingReport_ActionClick = function ($event, data) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.REP,
            method: _REPCOOPSPlan_DetailColumn.URL.SettingAction,
    ...
    $scope.customerNotIn_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.REP,
            method: _REPCOOPSPlan_DetailColumn.URL.SettingCusNotInList,
    ...
    $scope.customerNotIn_Save_Click = function ($event, win, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.REP,
                method: _REPCOOPSPlan_DetailColumn.URL.SettingCusNotInSave,
    ...
    $scope.customer_Delete = function ($event, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.REP,
                method: _REPCOOPSPlan_DetailColumn.URL.SettingCusDeleteList,
                data: { item: $scope.SettingItem, lst: datasend },
                success: function (res) {
                    $scope.SettingItem = res;
                    if (Common.HasValue(res.ListCustomer)) {
    ...
    $scope.ProvinceNotIn_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.REP,
            method: _REPCOOPSPlan_DetailColumn.URL.SettingProvinceInList,
    ...
    $scope.ProvinNotIn_Save_Click = function ($event, win, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.REP,
                method: _REPCOOPSPlan_DetailColumn.URL.SettingProvinceNotInSave,
    ...
    $scope.Province_Delete = function ($event, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.REP,
                method: _REPCOOPSPlan_DetailColumn.URL.SettingProvinceDeleteList,
                data: { item: $scope.SettingItem, lstProvinceID: datasend },
                success: function (res) {
                    $scope.SettingItem = res;
                    if (Common.HasValue(res.ListProvince)) {
    ...
    $scope.ServiceOfOrderNotIn_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.REP,
            method: _REPCOOPSPlan_DetailColumn.URL.SettingServiceOfOrderInList,
    ...
    $scope.ServiceOfOrderNotIn_Save_Click = function ($event, win, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.REP,
                method: _REPCOOPSPlan_DetailColumn.URL.SettingServiceOfOrderNotInSave,
    ...
    $scope.ServiceOfOrder_Delete = function ($event, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.REP,
                method: _REPCOOPSPlan_DetailColumn.URL.SettingServiceOfOrderDeleteList,
                data: { item: $scope.SettingItem, lstServiceOfOrderID: datasend },
                success: function (res) {
                    $scope.SettingItem = res;
                    if (Common.HasValue(res.ListServiceOfOrder)) {
    ...
    $scope.Excel_Export = function ($event) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.REP,
            method: _REPCOOPSPlan_DetailColumn.URL.Excel_Export,
            data: { lstid: $scope.Item.lstCustomerID, dtfrom: $scope.Item.DateFrom, dtto: $scope.Item.DateTo, statusID: $scope.Item.statusID },
            success: function (res) {
                $rootScope.IsLoading = false;
                $rootScope.DownloadFile(res);
