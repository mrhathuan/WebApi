...
var _ORDOrder_FCLLOEmpty = {
    URL: {
        ...
        Update: 'ORDOrder_FCLLOEmpty_Save',
...
angular.module('myapp').controller('ORDOrder_FCLLOEmptyCtrl', ['$rootScope', '$scope', '$http', '$location', '$state', '$timeout', 'openMapV2', function ($rootScope, $scope, $http, $location, $state, $timeout, openMapV2) {
    if ($rootScope.IsPageComplete != true) return;
    Common.Log('ORDOrder_FCLLOEmptyCtrl');
    ...
    _ORDOrder_FCLLOEmpty.Param = $.extend(true, _ORDOrder_FCLLOEmpty.Param, $state.params);
    if (_ORDOrder_FCLLOEmpty.Param.OrderID == "" || !angular.isNumber(parseInt(_ORDOrder_FCLLOEmpty.Param.OrderID))
        || _ORDOrder_FCLLOEmpty.Param.CustomerID == "" || !angular.isNumber(parseInt(_ORDOrder_FCLLOEmpty.Param.CustomerID))
        || _ORDOrder_FCLLOEmpty.Param.ServiceID == "" || !angular.isNumber(parseInt(_ORDOrder_FCLLOEmpty.Param.ServiceID))
        || _ORDOrder_FCLLOEmpty.Param.TransportID == "" || !angular.isNumber(parseInt(_ORDOrder_FCLLOEmpty.Param.TransportID))
        || _ORDOrder_FCLLOEmpty.Param.ContractID == "" || !angular.isNumber(parseInt(_ORDOrder_FCLLOEmpty.Param.ContractID))
        || _ORDOrder_FCLLOEmpty.Param.TermID == "" || !angular.isNumber(parseInt(_ORDOrder_FCLLOEmpty.Param.TermID))) {
    ...
    Common.Services.Call($http, {
        ...
        method: _ORDOrder_FCLLOEmpty.URL.Data,
        data: { CusID: _ORDOrder_FCLLOEmpty.Param.CustomerID },
        success: function (res) {
            $rootScope.Loading.Change("Lấy dữ liệu đơn hàng...", 50);
            $scope.hor_splitter.resize();
            if (Common.HasValue(res)) {
                _ORDOrder_FCLLOEmpty.Data.ListSeaPort = res.ListSeaPort;
                $timeout(function () {
                    $scope.fcllo_cboPartnerOptions.dataSource.data(_ORDOrder_FCLLOEmpty.Data.ListSeaPort);
                }, 1)
                _ORDOrder_FCLLOEmpty.Data.ListLocation = {};
                Common.Data.Each(res.ListLocation, function (o) {
                    if (Common.HasValue(_ORDOrder_FCLLOEmpty.Data.ListLocation[o.CusPartID]))
                        _ORDOrder_FCLLOEmpty.Data.ListLocation[o.CusPartID].push(o);
                    else
                        _ORDOrder_FCLLOEmpty.Data.ListLocation[o.CusPartID] = [o];
                })

                Common.Services.Call($http, {
                    url: Common.Services.url.ORD,
                    method: _ORDOrder_FCLLOEmpty.URL.GetItem,
                    data: { ID: _ORDOrder_FCLLOEmpty.Param.OrderID, CustomerID: _ORDOrder_FCLLOEmpty.Param.CustomerID, ServiceOfOrderID: _ORDOrder_FCLLOEmpty.Param.ServiceID, TransportModeID: _ORDOrder_FCLLOEmpty.Param.TransportID, ContractID: _ORDOrder_FCLLOEmpty.Param.ContractID, TermID: _ORDOrder_FCLLOEmpty.Param.TermID },
                    success: function (res) {
                        ...
                        $scope.ContainerNew.ETA = Common.Date.FromJson($scope.Item.ETA);
                        $scope.ContainerNew.ETD = Common.Date.FromJson($scope.Item.ETD);
                        //Binding
                        if ($scope.Item.ID < 1) {
                            var obj = _ORDOrder_FCLLOEmpty.Data.ListSeaPort[0];
                            ...
                            $timeout(function () {
                                $scope.service_gridOptions.dataSource.data(_ORDOrder_FCLLOEmpty.Data.ListService);
    ...
    Common.Services.Call($http, {
        url: Common.Services.url.ORD,
        method: _ORDOrder_FCLLOEmpty.URL.GroupProduct,
        data: { CusID: _ORDOrder_FCLLOEmpty.Param.CustomerID },
        success: function (res) {
            _ORDOrder_FCLLOEmpty.Data.ListGroupProduct = res.Data;
            _ORDOrder_FCLLOEmpty.Data.ListGroupProduct.splice(0, 0, { ID: "", GroupName: "" });
            $timeout(function () {
                $scope.cbbGroupOfProductOptions.dataSource.data(_ORDOrder_FCLLOEmpty.Data.ListGroupProduct);
            }, 1)
        }
    });
        ...
        change: function (e) {
            ...
            if (Common.HasValue(obj)) {
                if (obj.CUSLocationID == $scope.Item.LocationToID) {
                    ...
                    var dataCbo = _ORDOrder_FCLLOEmpty.Data.ListLocation[$scope.Item.PartnerID];
                    var data = [];
    ...
    $scope.LoadLocation = function (flag) {
        ...
        $timeout(function () {
            var data = _ORDOrder_FCLLOEmpty.Data.ListLocation[partnerID];
    ...
    $scope.ORD_FCLLO_Container_Edit = function ($event, grid) {
        ...
        $timeout(function () {
            ...
            _ORDOrder_FCLLOEmpty.Data.ItemContainerBackUp = $.extend(true, {}, $scope.ContainerEdit);
            grid.editRow(tr);
    ...
    $scope.ORD_FCLLO_Container_Cancel = function ($event, grid) {
        ...
        while (i < data.length) {
            var obj = data[i];
            if (obj.ID == _ORDOrder_FCLLOEmpty.Data.ItemContainerBackUp.ID) {
                data.splice(i, 1);
                data.splice(i, 0, $.extend(true, {}, _ORDOrder_FCLLOEmpty.Data.ItemContainerBackUp))
            }
            i++;
        }
        $rootScope.IsLoading = false;
    ...
    $scope.ORD_FCLLO_Product_AddNew = function ($event, grid) {
        ...
        _ORDOrder_FCLLOEmpty.Data.ItemProductNew.ID = data.length > 0 ? -(data.length + 1) : -1;
        data.splice(0, 0, $.extend(true, {}, _ORDOrder_FCLLOEmpty.Data.ItemProductNew));
        ...
        $timeout(function () {
            ...
            _ORDOrder_FCLLOEmpty.Data.ItemProductBackUp = $.extend(true, {}, $scope.ProductEdit);
    ...
    $scope.ORD_FCLLO_Product_Cancel = function ($event, grid) {
        ...
        while (i < data.length) {
            var obj = data[i];
            if (obj.ID == _ORDOrder_FCLLOEmpty.Data.ItemProductBackUp.ID) {
                data.splice(i, 1);
                data.splice(i, 0, $.extend(true, {}, _ORDOrder_FCLLOEmpty.Data.ItemProductBackUp))
            }
            i++;
        }
        $rootScope.IsLoading = false;
    ...
    Common.Services.Call($http, {
        url: Common.Services.url.ORD,
        method: _ORDOrder_FCLLOEmpty.URL.COService,
        data: { ContractID: _ORDOrder_FCLLOEmpty.Param.ContractID },
        success: function (res) {
            _ORDOrder_FCLLOEmpty.Data.ListService = res.Data;
            $.each(_ORDOrder_FCLLOEmpty.Data.ListService, function (i, v) {
                v.IsChoose = false;
                v.ServiceID = v.ID;
            })
            $timeout(function () {
    ...
    $scope.price_gridOptions = {
        ...
        columns: [
            ...
            { field: 'Quantity', width: 200, title: '{{RS.ORDOrder_FCLLOEmpty.Quantity}}' },
            { field: 'TotalPrice', title: '{{RS.ORDOrder_FCLLOEmpty.TotalPrice}}' }
        ],
        save: function (e) {
            e.preventDefault();
    ...
    $scope.LoadPriceContainer = function () {
        ...
        $.each(data, function (i, v) {
            ...
            if (Common.HasValue(objPrice[f]) && objPrice[f] >= 0) {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.ORD,
                    method: _ORDOrder_FCLLOEmpty.URL.PriceContainer,
                    data: {
    ...
    $scope.CreateMap = function () {
        ...
        Common.Data.Each(_ORDOrder_FCLLOEmpty.Data.ListLocation, function (o) {
    ...
    Common.Services.Call($http, {
        url: Common.Services.url.ORD,
        method: _ORDOrder_FCLLOEmpty.URL.Contract,
        data: _ORDOrder_FCLLOEmpty.Param,
        success: function (res) {
        ...
        if (Common.HasValue(obj)) {
            $rootScope.Message({
                ...
                Ok: function (pars) {
                    ...
                    _ORDOrder_FCLLOEmpty.Param.ContractID = pars.ID;
                    if ($scope.Item.ID > 0) {
                        Common.Services.Call($http, {
                            url: Common.Services.url.ORD,
                            method: _ORDOrder_FCLLOEmpty.URL.Contract_Change,
                            data: _ORDOrder_FCLLOEmpty.Param,
                            success: function (res) {
                                Common.Services.Error(res, function (res) {
                                    $state.go("main.ORDOrder.FCLLOEmpty", _ORDOrder_FCLLOEmpty.Param);
                                })
                            }
                        });
                    } else {
    ...
    $scope.Contract_Update_None_Click = function ($event, win) {
        ...
        $rootScope.Message({
            ...
            Ok: function () {
                ...
                _ORDOrder_FCLLOEmpty.Param.ContractID = -1;
                if ($scope.Item.ID > 0) {
                    Common.Services.Call($http, {
                        url: Common.Services.url.ORD,
                        method: _ORDOrder_FCLLOEmpty.URL.Contract_Change,
    ...
    Common.ALL.Get($http, {
        ...
        success: function (res) {
            _ORDOrder_FCLLOEmpty.Data.ListContainer = res;
            $scope.cbo_CO_PackingOptions.dataSource.data(_ORDOrder_FCLLOEmpty.Data.ListContainer);
            $scope.cbo_coGrid_PackingOptions.dataSource.data(_ORDOrder_FCLLOEmpty.Data.ListContainer);
            var obj = _ORDOrder_FCLLOEmpty.Data.ListContainer[0];
        ...
        if ($scope.CheckItem()) {
            $rootScope.Message({
                ...
                Ok: function () {
                    ...
                    Common.Services.Call($http, {
                        url: Common.Services.url.ORD,
                        method: _ORDOrder_FCLLOEmpty.URL.Update,
                        data: { item: $scope.Item },
                        success: function (res) {
                            $rootScope.IsLoading = false;
                            Common.Services.Error(res, function (res) {
                                $rootScope.Message({ Msg: "Đã cập nhật!" });
                                if (_ORDOrder_FCLLOEmpty.Param.OrderID != res) {
                                    _ORDOrder_FCLLOEmpty.Param.OrderID = res;
                                    if ($scope.Auth.ActAddAndApproved) {
                                        $rootScope.Message({
                                            ...
                                            Ok: function () {
                                                ...
                                                Common.Services.Call($http, {
                                                    url: Common.Services.url.ORD,
                                                    method: _ORDOrder_FCLLOEmpty.URL.Container_OPS_Check,
                                                    data: { data: [_ORDOrder_FCLLOEmpty.Param.OrderID] },
                                                    success: function (res) {
                                                        Common.Services.Error(res, function (res) {
                                                            $rootScope.IsLoading = false;
                                                            if (res.length > 0) {
                                                                $rootScope.Message({ Msg: "Thiếu dữ liệu container! Không thể gửi!" });
                                                                $state.go("main.ORDOrder.FCLLOEmpty", {
                                                                    OrderID: _ORDOrder_FCLLOEmpty.Param.OrderID,
                                                                    CustomerID: _ORDOrder_FCLLOEmpty.Param.CustomerID,
                                                                    ServiceID: _ORDOrder_FCLLOEmpty.Param.ServiceID,
                                                                    TransportID: _ORDOrder_FCLLOEmpty.Param.TransportID,
                                                                    ContractID: _ORDOrder_FCLLOEmpty.Param.ContractID != null ? _ORDOrder_FCLLOEmpty.Param.ContractID : -1,
                                                                    TermID: _ORDOrder_FCLLOEmpty.Param.TermID != null ? _ORDOrder_FCLLOEmpty.Param.TermID : -1
                                                                });
                                                            } else {
                                                                $rootScope.IsLoading = true;
                                                                Common.Services.Call($http, {
                                                                    url: Common.Services.url.ORD,
                                                                    method: _ORDOrder_FCLLOEmpty.URL.OPS_Check,
                                                                    data: { data: [_ORDOrder_FCLLOEmpty.Param.OrderID] },
                                                                    success: function (res) {
                                                                        Common.Services.Error(res, function (res) {
                                                                            $rootScope.IsLoading = false;
                                                                            if (res.length > 0) {
                                                                                ...
                                                                                Common.Services.Call($http, {
                                                                                    url: Common.Services.url.ORD,
                                                                                    method: _ORDOrder_FCLLOEmpty.URL.ToOPS,
                                                                                    data: { lst: [_ORDOrder_FCLLOEmpty.Param.OrderID] },
                                                                                    success: function (res) {
                                                                                        Common.Services.Error(res, function (res) {
                                                                                            $rootScope.IsLoading = false;
                                                                                            $state.go('main.ORDOrder.Index');
    ...
    $scope.ORD_FCLLO_Delete = function ($event) {
        ...
        $rootScope.Message({
            ...
            Ok: function () {
                Common.Services.Call($http, {
                    url: Common.Services.url.ORD,
                    method: _ORDOrder_FCLLOEmpty.URL.Delete,
                    data: { id: _ORDOrder_FCLLOEmpty.Param.OrderID },
                    success: function (res) {
                        Common.Services.Error(res, function (res) {
    ...
    $scope.ORD_FCLLO_Back = function ($event) {
        $event.preventDefault();
        if (_ORDOrder_FCLLOEmpty.Param.OrderID > 0) {
            $state.go('main.ORDOrder.Index');
        } else {
            $state.go("main.ORDOrder.New");
        }
