...
var _SYSUser_Index = {
    URL: {
        ...
        Get: 'SYSUser_Get',
        Group: 'SYSUser_Group',
        Customer: 'SYSUser_Customer',
        CheckData: 'SYSUser_CheckData',
        Save: 'SYSUser_Save',
        Delete: 'SYSUser_Delete',

        Export: 'SYSUser_Export',
        ImportCheck: 'SYSUser_ImportCheck',
        Import: 'SYSUser_Import',
        DriverList: 'SYSUser_Driver',
        SetDefaultByUser: 'SYSUserResource_SetDefaultByUser',
...
angular.module('myapp').controller('SYSUser_IndexCtrl', ['$rootScope', '$scope', '$http', '$location', '$state', '$timeout', '$stateParams', function ($rootScope, $scope, $http, $location, $state, $timeout, $stateParams) {
    if ($rootScope.IsPageComplete != true) return;
    Common.Log('SYSUser_IndexCtrl');
    ...
    Common.Services.Call($http, {
        ...
        method: _SYSUser_Index.URL.CheckAdmin,
        data: { },
    ...
    $scope.sysuser_gridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.SYS,
            method: _SYSUser_Index.URL.Read,
            model: {
                id: 'ID',
                fields: {
                    ID: { type: 'number' },
    ...
    Common.Services.Call($http, {
        url: Common.Services.url.SYS,
        method: _SYSUser_Index.URL.Customer,
        data: { },
        success: function (res) {
    ...
    Common.Services.Call($http, {
        url: Common.Services.url.SYS,
        method: _SYSUser_Index.URL.DriverList,
        data: {},
        success: function (res) {
            if (Common.HasValue(res)) {
                $timeout(function () {
    ...
    $scope.LoadItem = function (win, id, vform) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.SYS,
            method: _SYSUser_Index.URL.Group,
            data: { id: id },
            success: function (res) {
                if (Common.HasValue(res)) {
                    $timeout(function () {
        ...
        if (lstid.length > 0) {
            $rootScope.Message({
                ...
                Ok: function (pars) {
                    Common.Services.Call($http, {
                        url: Common.Services.url.SYS,
                        method: _SYSUser_Index.URL.Delete,
                        data: pars,
                        success: function (res) {
    ...
    $scope.Save_Click = function ($event, win, grid, vform) {
        ...
        if (vform()) {
            ...
            if (flag == true) {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.SYS,
                    method: _SYSUser_Index.URL.CheckData,
                    ...
                    success: function (res) {
                        ...
                        if (res > 0) {
                            ...
                            if (flag) {
                                ...
                                Common.Services.Call($http, {
                                    url: Common.Services.url.SYS,
                                    method: _SYSUser_Index.URL.Save,
    ...
    $scope.Excel_Click = function ($event, grid) {
        ...
        $rootScope.UploadExcel({
            ...
            Download: function ($event) {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.SYS,
                    method: _SYSUser_Index.URL.Export,
                    data: {},
                    success: function (res) {
                        $rootScope.IsLoading = false;
            ...
            Upload: function (file, success) {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.SYS,
                    method: _SYSUser_Index.URL.ImportCheck,
                    data: { file: file },
                    success: function (res) {
                        success(res);
                        $rootScope.IsLoading = false;
            ...
            Complete: function (file, data) {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.SYS,
                    method: _SYSUser_Index.URL.Import,
                    data: { lst: data },
                    success: function (res) {
                        $rootScope.IsLoading = false;
                    }
    ...
    $scope.SetDefault = function ($event) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.SYS,
            method: _SYSUser_Index.URL.SetDefaultByUser,
