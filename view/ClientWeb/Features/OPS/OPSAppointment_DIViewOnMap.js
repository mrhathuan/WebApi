...
var _OPSAppointment_DIViewOnMap = {
    URL: {
...
angular.module('myapp').controller('OPSAppointment_DIViewOnMapCtrl', ['$rootScope', '$scope', '$http', '$location', '$state', '$timeout', '$compile', 'openMapV2', function ($rootScope, $scope, $http, $location, $state, $timeout, $compile, openMapV2) {
    if ($rootScope.IsPageComplete != true) return;
    Common.Log('OPSAppointment_DIViewOnMapCtrl');
    ...
    Common.Services.Call($http, {
        ...
        method: _OPSAppointment_DIViewOnMap.URL.Setting,
        success: function (res) {
            if (Common.HasValue(res)) {
                _OPSAppointment_DIViewOnMap.Data.Location.LocationStartID = res.LocationStartID;
                _OPSAppointment_DIViewOnMap.Data.Location.LocationStartName = res.LocationStartName;
                _OPSAppointment_DIViewOnMap.Data.Location.LocationEndID = res.LocationEndID;
                _OPSAppointment_DIViewOnMap.Data.Location.LocationEndName = res.LocationEndName;
                _OPSAppointment_DIViewOnMap.Data.Location.LocationEndLat = res.LocationEndLat;
                _OPSAppointment_DIViewOnMap.Data.Location.LocationEndLng = res.LocationEndLng;
                _OPSAppointment_DIViewOnMap.Data.Location.LocationStartLat = res.LocationStartLat;
                _OPSAppointment_DIViewOnMap.Data.Location.LocationStartLng = res.LocationStartLng;
            }
        }
    });
            ...
            if (val > 0.001 && dataItem.Ton - val > 0.001) {
                $rootScope.Message({
                    ...
                    Ok: function () {
                        ...
                        Common.Services.Call($http, {
                            url: Common.Services.url.OPS,
                            method: _OPSAppointment_DIViewOnMap.URL.Split,
                            data: {
    ...
    $scope.gop_Grid_Options = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.OPS,
            method: _OPSAppointment_DIViewOnMap.URL.Order_List,
            pageSize: 20,
            readparam: function () {
                return {
    ...
    $scope.vehicle_Grid_Options = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.OPS,
            method: _OPSAppointment_DIViewOnMap.URL.Vehicle_List,
            readparam: function () {
                return {
    ...
    $scope.GroupProduct_Cancel = function ($event, item, grid) {
        ...
        $rootScope.Message({
            ...
            Ok: function () {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.OPS,
                    method: _OPSAppointment_DIViewOnMap.URL.Cancel,
                    data: {
                        data: [item.ID]
                    },
                    success: function (res) {
        ...
        if (flag) {
            $rootScope.Message({
                ...
                Ok: function () {
                    ...
                    Common.Services.Call($http, {
                        url: Common.Services.url.OPS,
                        method: _OPSAppointment_DIViewOnMap.URL.Split_Cancel,
                        data: {
    ...
    $scope.location_Grid_Options = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.OPS,
            method: _OPSAppointment_DIViewOnMap.URL.Location_List,
            pageSize: 20,
            model: {
                id: 'ID',
                fields: {
    ...
    $scope.gridChooseFTL_Change = function ($event, grid) {
        ...
        if (uid > 0 && tmp) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.OPS,
                method: _OPSAppointment_DIViewOnMap.URL.TripByID,
                data: {
                    masterID: uid
                },
                success: function (res) {
    ...
    $scope.ViewVehicleInfo = function ($event, item, type) {
        ...
        if (!Common.HasValue(_OPSAppointment_DIViewOnMap.Data.VehicleInfo[item.ID])) {
            _OPSAppointment_DIViewOnMap.Data.VehicleInfo[item.ID] = {
                IsLoaded: false, ListTrip: []
            }
            ...
            $scope.LoadVehicleTrip(new Date(), item.ID,  3, true, true, function (res) {
                ...
                var obj = _OPSAppointment_DIViewOnMap.Data.VehicleInfo[item.ID];
                $scope.VehicleInfo = {
    ...
    $scope.LoadVehicleTrip = function (requestDate, vehicleID, total, isapproved, istendered, callback) {
        Common.Services.Call($http, {
            url: Common.Services.url.OPS,
            method: _OPSAppointment_DIViewOnMap.URL.TripByVehicle_List,
            data: {
    ...
    $scope.vehicleByVendor_Grid_Options = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.OPS,
            method: _OPSAppointment_DIViewOnMap.URL.VehicleVendor_List,
            readparam: function () {
                return {
    ...
    $scope.VehicleVendor_New_OK_Click = function ($event, grid, win) {
        ...
        $rootScope.Message({
            ...
            Ok: function () {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.OPS,
                    method: _OPSAppointment_DIViewOnMap.URL.Vehicle_New,
                    data: {
                        vendorID: $scope.VehicleVendorID,
    ...
    $scope.Accept_Click = function ($event, grid, win, vwin) {
        ...
        if ($scope.ViewOrderLTL) {
            ...
            $scope.TripItem.LocationStartID = _OPSAppointment_DIViewOnMap.Data.Location.LocationStartID;
            $scope.TripItem.LocationStartName = _OPSAppointment_DIViewOnMap.Data.Location.LocationStartName;
            $scope.TripItem.LocationEndID = _OPSAppointment_DIViewOnMap.Data.Location.LocationEndID;
            $scope.TripItem.LocationEndName = _OPSAppointment_DIViewOnMap.Data.Location.LocationEndName;
            $scope.TripItem.LocationEndLat = _OPSAppointment_DIViewOnMap.Data.Location.LocationEndLat;
            $scope.TripItem.LocationEndLng = _OPSAppointment_DIViewOnMap.Data.Location.LocationEndLng;
            $scope.TripItem.LocationStartLat = _OPSAppointment_DIViewOnMap.Data.Location.LocationStartLat;
            $scope.TripItem.LocationStartLng = _OPSAppointment_DIViewOnMap.Data.Location.LocationStartLng;
        }
        if ((data.length == 0 && $scope.TripItem.ID < 1) || $scope.TripItem.VehicleID < 1 || $scope.TripItem.ETA == null || $scope.TripItem.ETD == null) {
            ...
            if ($scope.IsVehicleVendor) {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.OPS,
                    method: _OPSAppointment_DIViewOnMap.URL.DriverVendor_List,
                    data: {
                        vendorID: $scope.VehicleVendorID
                    },
                    success: function (res) {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.OPS,
                    method: _OPSAppointment_DIViewOnMap.URL.CheckVehicleAvailable,
                    data: {
        ...
        if (flag) {
            $rootScope.Message({
                ...
                Ok: function () {
                    ...
                    Common.Services.Call($http, {
                        url: Common.Services.url.OPS,
                        method: _OPSAppointment_DIViewOnMap.URL.Save,
                        data: {
                            item: $scope.TripItem
                        },
                        success: function (res) {
    ...
    Common.Services.Call($http, {
        url: Common.Services.url.OPS,
        method: _OPSAppointment_DIViewOnMap.URL.Driver_List,
        success: function (res) {
            var data = [];
            $.each(res, function (i, v) {
                data.push({ 'ID': v.ID, 'Text': v.LastName + ' ' + v.FirstName + ' (' + v.EmployeeCode + ')', 'DriverName': v.LastName + ' ' + v.FirstName, 'DriverTel': v.Cellphone });
    ...
    Common.Services.Call($http, {
        url: Common.Services.url.OPS,
        method: _OPSAppointment_DIViewOnMap.URL.Vendor_List,
        success: function (res) {
            _OPSAppointment_DIViewOnMap.Data.VendorList = res;
    ...
    $scope.Tender_Click = function ($event, grid, win) {
        ...
        var dataVen = [];
        var cboVenData = $.extend(true, [], _OPSAppointment_DIViewOnMap.Data.VendorList);
        var vID = '';
        ...
        if (flag) {
            $rootScope.Message({
                ...
                Ok: function () {
                    ...
                    Common.Services.Call($http, {
                        url: Common.Services.url.OPS,
                        method: _OPSAppointment_DIViewOnMap.URL.ToVendor,
                        data: {
            ...
            if ($scope.DataFTLMerge.length < 2) {
                ...
                $rootScope.Message({
                    ...
                    Ok: function () {
                        ...
                        Common.Services.Call($http, {
                            url: Common.Services.url.OPS,
                            method: _OPSAppointment_DIViewOnMap.URL.FTLMerge,
    ...
    $scope.FTLSplit_Click = function ($event, grid, win) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.OPS,
            method: _OPSAppointment_DIViewOnMap.URL.GroupByTrip_List,
            data: {
    ...
    $scope.splitGop_GridOptions = {
        ...
        columns: [
            ...
            {
                field: 'TempMax', width: 100, title: 'N.Độ tối đa', template: '#=TempMax!=null?TempMax:""#',
                filterable: { cell: { operator: 'gte', showOperators: false } }
            },
        ...
        if (temp.length > 1) {
            $rootScope.Message({
                ...
                Ok: function () {
                    ...
                    Common.Services.Call($http, {
                        url: Common.Services.url.OPS,
                        method: _OPSAppointment_DIViewOnMap.URL.FTLSplit,
    ...
    $scope.new_trip_Grid_Options = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.OPS,
            method: _OPSAppointment_DIViewOnMap.URL.DITOGroupProduct_List,
            pageSize: 100,
        ...
        if ($scope.NewTripViewAction == 0) {
            ...
            $rootScope.Message({
                ...
                Ok: function () {
                    ...
                    Common.Services.Call($http, {
                        url: Common.Services.url.OPS,
                        method: _OPSAppointment_DIViewOnMap.URL.ToMon,
                        data: {
                            data: data
                        },
                        success: function (res) {
        ...
        if ($scope.NewTripViewAction == 0) {
            ...
            $rootScope.Message({
                ...
                Ok: function () {
                    ...
                    Common.Services.Call($http, {
                        url: Common.Services.url.OPS,
                        method: _OPSAppointment_DIViewOnMap.URL.ToOPS,
                        data: {
                            data: data
                        },
                        success: function (res) {
        ...
        if ($scope.NewTripViewAction == 0) {
            ...
            $rootScope.Message({
                ...
                Ok: function () {
                    ...
                    Common.Services.Call($http, {
                        url: Common.Services.url.OPS,
                        method: _OPSAppointment_DIViewOnMap.URL.Delete,
                        data: {
                            data: data
                        },
                        success: function (res) {
    ...
    $scope.gopTOTon_Options = {
        ...
        change: function (e) {
            ...
            if (val > dataItem.Ton + 0.001) {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.OPS,
                    method: _OPSAppointment_DIViewOnMap.URL.DI2View_Master_Update_Check4Update,
                    data: {
                            ...
                            if (res == true) {
                                $rootScope.Message({
                                    ...
                                    Ok: function () {
                                        ...
                                        Common.Services.Call($http, {
                                            url: Common.Services.url.OPS,
                                            method: _OPSAppointment_DIViewOnMap.URL.DI2View_Master_Update_Group_Quantity,
                                            data: {
                                                gopID: dataItem.ID, mID: dataItem.TOMasterID, value: val, packingType: 1
                                            },
                                            success: function (res) {
    ...
    $scope.new2view_trip_Grid_Options = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.OPS,
            method: _OPSAppointment_DIViewOnMap.URL.DI2View_GroupProduct_List,
        ...
        change: function (e) {
            ...
            if (val > 0) {
                ...
                if (!flag || toMasterID < 1) {
                    $rootScope.Message({
                        ...
                        Ok: function () {
                            ...
                            $scope.NewTripItem = {
                                ...
                                ListOPSGOPName: [],
                                LocationStartID: _OPSAppointment_DIViewOnMap.Data.Location.LocationStartID,
                                LocationStartName: _OPSAppointment_DIViewOnMap.Data.Location.LocationStartName,
                                LocationEndID: _OPSAppointment_DIViewOnMap.Data.Location.LocationEndID,
                                LocationEndName: _OPSAppointment_DIViewOnMap.Data.Location.LocationEndName,
                                LocationStartLat: _OPSAppointment_DIViewOnMap.Data.Location.LocationStartLat,
                                LocationStartLng: _OPSAppointment_DIViewOnMap.Data.Location.LocationStartLng,
                                LocationEndLat: _OPSAppointment_DIViewOnMap.Data.Location.LocationEndLat,
                                LocationEndLng: _OPSAppointment_DIViewOnMap.Data.Location.LocationEndLng,
                    ...
                    Common.Services.Call($http, {
                        url: Common.Services.url.OPS,
                        method: _OPSAppointment_DIViewOnMap.URL.DI2View_Master_Update_Check4Consolidate,
                            ...
                            if (res == true) {
                                $rootScope.Message({
                                    ...
                                    Ok: function () {
                                        ...
                                        Common.Services.Call($http, {
                                            url: Common.Services.url.OPS,
                                            method: _OPSAppointment_DIViewOnMap.URL.DI2View_Master_Update_Group,
                                            data: {
            ...
            $rootScope.Message({
                ...
                Ok: function () {
                    ...
                    if ($scope.NewTripItem.ID < 1) {
                        ...
                        Common.Services.Call($http, {
                            url: Common.Services.url.OPS,
                            method: _OPSAppointment_DIViewOnMap.URL.DI2View_Master_Update,
                            data: {
                                item: $scope.NewTripItem
                            },
                            success: function (res) {
        ...
        save: function (e) {
            ...
            $rootScope.Message({
                ...
                Ok: function () {
                    ...
                    Common.Services.Call($http, {
                        url: Common.Services.url.OPS,
                        method: _OPSAppointment_DIViewOnMap.URL.DI2View_Master_Update_TimeLine,
    ...
    $scope.new_timeline_vehicle_select_Grid_Options = {
        ...
        selectable: 'row', filterable: { mode: 'row', visible: false }, reorderable: true, auboBind: false, auboBind: false,
        dataBound: function () {
            var grid = this;
            angular.forEach(grid.items(), function (tr) {
                var item = grid.dataItem(tr);
    ...
    $scope.LoadNewTimeLineData = function () {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.OPS,
            method: _OPSAppointment_DIViewOnMap.URL.Schedule_Data,
