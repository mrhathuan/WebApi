...
var _OPSAppointment_DIViewOnMapV2 = {
    URL: {
...
angular.module('myapp').controller('OPSAppointment_DIViewOnMapV2Ctrl', ['$rootScope', '$scope', '$http', '$location', '$state', '$timeout', '$compile', 'openMapV2', function ($rootScope, $scope, $http, $location, $state, $timeout, $compile, openMapV2) {
    if ($rootScope.IsPageComplete != true) return;
    Common.Log('OPSAppointment_DIViewOnMapV2Ctrl');
    ...
    var objCookie = Common.Cookie.Get("DIViewOnMapV2_View");
    if (objCookie != $state.params.view) {
        $state.go("main.OPSAppointment.DIViewOnMapV2", { view: objCookie });
    }
    ...
    $scope.viewSplitter_Options = {
        ...
        panes: [
            ...
            { collapsible: true, resizable: true, size: $scope.ViewVertical ? '300px' : '530px', min: $scope.ViewVertical ? '200px' : '530px' }
        ],
        resize: function (e) {
            try {
                openMapV2.Resize();
    ...
    Common.Services.Call($http, {
        ...
        method: _OPSAppointment_DIViewOnMapV2.URL.Setting,
        success: function (res) {
            if (Common.HasValue(res)) {
                _OPSAppointment_DIViewOnMapV2.Data.Location.LocationStartID = res.LocationStartID;
                _OPSAppointment_DIViewOnMapV2.Data.Location.LocationStartName = res.LocationStartName;
                _OPSAppointment_DIViewOnMapV2.Data.Location.LocationEndID = res.LocationEndID;
                _OPSAppointment_DIViewOnMapV2.Data.Location.LocationEndName = res.LocationEndName;
                _OPSAppointment_DIViewOnMapV2.Data.Location.LocationEndLat = res.LocationEndLat;
                _OPSAppointment_DIViewOnMapV2.Data.Location.LocationEndLng = res.LocationEndLng;
                _OPSAppointment_DIViewOnMapV2.Data.Location.LocationStartLat = res.LocationStartLat;
                _OPSAppointment_DIViewOnMapV2.Data.Location.LocationStartLng = res.LocationStartLng;
            }
        }
    });
            ...
            if (val > 0.001 && dataItem.Ton - val > 0.001) {
                $rootScope.Message({
                    ...
                    Ok: function () {
                        ...
                        Common.Services.Call($http, {
                            url: Common.Services.url.OPS,
                            method: _OPSAppointment_DIViewOnMapV2.URL.Split,
                            data: {
    ...
    $scope.gop_Grid_Options = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.OPS,
            method: _OPSAppointment_DIViewOnMapV2.URL.Order_List,
            pageSize: 20,
            readparam: function () {
                return {
    ...
    $scope.vehicle_Grid_Options = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.OPS,
            method: _OPSAppointment_DIViewOnMapV2.URL.Vehicle_List,
            readparam: function () {
                return {
        ...
        columns: [
            ...
            {
                field: 'StatusOfVehicleName', title: 'T/trạng',
    ...
    $scope.GroupProduct_Cancel = function ($event, item, grid) {
        ...
        $rootScope.Message({
            ...
            Ok: function () {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.OPS,
                    method: _OPSAppointment_DIViewOnMapV2.URL.Cancel,
                    data: {
                        data: [item.ID]
                    },
                    success: function (res) {
        ...
        if (flag) {
            $rootScope.Message({
                ...
                Ok: function () {
                    ...
                    Common.Services.Call($http, {
                        url: Common.Services.url.OPS,
                        method: _OPSAppointment_DIViewOnMapV2.URL.Split_Cancel,
                        data: {
    ...
    $scope.location_Grid_Options = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.OPS,
            method: _OPSAppointment_DIViewOnMapV2.URL.Location_List,
            pageSize: 20,
            model: {
                id: 'ID',
                fields: {
    ...
    $scope.gridChooseFTL_Change = function ($event, grid) {
        ...
        if (uid > 0 && tmp) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.OPS,
                method: _OPSAppointment_DIViewOnMapV2.URL.TripByID,
                data: {
                    masterID: uid
                },
                success: function (res) {
    ...
    $scope.ViewVehicleInfo = function ($event, item, type) {
        ...
        if (!Common.HasValue(_OPSAppointment_DIViewOnMapV2.Data.VehicleInfo[item.ID])) {
            _OPSAppointment_DIViewOnMapV2.Data.VehicleInfo[item.ID] = {
                IsLoaded: false, ListTrip: []
            }
            ...
            $scope.LoadVehicleTrip(new Date(), item.ID,  3, true, true, function (res) {
                ...
                var obj = _OPSAppointment_DIViewOnMapV2.Data.VehicleInfo[item.ID];
                $scope.VehicleInfo = {
    ...
    $scope.LoadVehicleTrip = function (requestDate, vehicleID, total, isapproved, istendered, callback) {
        Common.Services.Call($http, {
            url: Common.Services.url.OPS,
            method: _OPSAppointment_DIViewOnMapV2.URL.TripByVehicle_List,
            data: {
    ...
    $scope.$watch('IsVehicleVendor', function () {
        ...
        $scope.TripItem.VehicleMaxWeight = 0;
        $timeout(function () {
            if ($scope.IsVehicleVendor) {
                try {
    ...
    $scope.vehicleByVendor_Grid_Options = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.OPS,
            method: _OPSAppointment_DIViewOnMapV2.URL.VehicleVendor_List,
            readparam: function () {
                return {
    ...
    $scope.VehicleVendor_New_OK_Click = function ($event, grid, win) {
        ...
        $rootScope.Message({
            ...
            Ok: function () {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.OPS,
                    method: _OPSAppointment_DIViewOnMapV2.URL.Vehicle_New,
                    data: {
                        vendorID: $scope.VehicleVendorID,
    ...
    $scope.Accept_Click = function ($event, grid, win, vwin) {
        ...
        if ($scope.ViewOrderLTL) {
            ...
            $scope.TripItem.LocationStartID = _OPSAppointment_DIViewOnMapV2.Data.Location.LocationStartID;
            $scope.TripItem.LocationStartName = _OPSAppointment_DIViewOnMapV2.Data.Location.LocationStartName;
            $scope.TripItem.LocationEndID = _OPSAppointment_DIViewOnMapV2.Data.Location.LocationEndID;
            $scope.TripItem.LocationEndName = _OPSAppointment_DIViewOnMapV2.Data.Location.LocationEndName;
            $scope.TripItem.LocationEndLat = _OPSAppointment_DIViewOnMapV2.Data.Location.LocationEndLat;
            $scope.TripItem.LocationEndLng = _OPSAppointment_DIViewOnMapV2.Data.Location.LocationEndLng;
            $scope.TripItem.LocationStartLat = _OPSAppointment_DIViewOnMapV2.Data.Location.LocationStartLat;
            $scope.TripItem.LocationStartLng = _OPSAppointment_DIViewOnMapV2.Data.Location.LocationStartLng;
        }
        if ((data.length == 0 && $scope.TripItem.ID < 1) || $scope.TripItem.VehicleID < 1 || $scope.TripItem.ETA == null || $scope.TripItem.ETD == null) {
            ...
            if ($scope.IsVehicleVendor) {
                Common.Services.Call($http, {
                    url: Common.Services.url.OPS,
                    method: _OPSAppointment_DIViewOnMapV2.URL.DriverVendor_List,
                    data: {
                        vendorID: $scope.VehicleVendorID
                    },
                    success: function (res) {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.OPS,
                    method: _OPSAppointment_DIViewOnMapV2.URL.CheckVehicleAvailable,
                    data: {
        ...
        if (flag) {
            $rootScope.Message({
                ...
                Ok: function () {
                    ...
                    Common.Services.Call($http, {
                        url: Common.Services.url.OPS,
                        method: _OPSAppointment_DIViewOnMapV2.URL.Save,
                        data: {
                            item: $scope.TripItem
                        },
                        success: function (res) {
    ...
    Common.Services.Call($http, {
        url: Common.Services.url.OPS,
        method: _OPSAppointment_DIViewOnMapV2.URL.Driver_List,
        success: function (res) {
            var data = [];
            $.each(res, function (i, v) {
                data.push({ 'ID': v.ID, 'Text': v.LastName + ' ' + v.FirstName + ' (' + v.EmployeeCode + ')', 'DriverName': v.LastName + ' ' + v.FirstName, 'DriverTel': v.Cellphone });
                        ...
                        Common.Services.Error(res, function (res) {
                            ...
                            if (res.IsOverWeight) {
                                ...
                                if (res.IsVehicleAvailable) {
                                    if ($scope.TripItem.DriverTel == null || $scope.TripItem.DriverTel == "")
                                        $scope.TripItem.DriverTel = res.DriverTel;
                                    if ($scope.TripItem.DriverName == null || $scope.TripItem.DriverName == "")
                                        $scope.TripItem.DriverName = res.DriverName;
    ...
    Common.Services.Call($http, {
        url: Common.Services.url.OPS,
        method: _OPSAppointment_DIViewOnMapV2.URL.Vendor_List,
        success: function (res) {
            _OPSAppointment_DIViewOnMapV2.Data.VendorList = res;
    ...
    $scope.Tender_Click = function ($event, grid, win) {
        ...
        var dataVen = [];
        var cboVenData = $.extend(true, [], _OPSAppointment_DIViewOnMapV2.Data.VendorList);
        var vID = '';
        ...
        if (flag) {
            $rootScope.Message({
                ...
                Ok: function () {
                    ...
                    Common.Services.Call($http, {
                        url: Common.Services.url.OPS,
                        method: _OPSAppointment_DIViewOnMapV2.URL.ToVendor,
                        data: {
            ...
            if ($scope.DataFTLMerge.length < 2) {
                ...
                $rootScope.Message({
                    ...
                    Ok: function () {
                        ...
                        Common.Services.Call($http, {
                            url: Common.Services.url.OPS,
                            method: _OPSAppointment_DIViewOnMapV2.URL.FTLMerge,
    ...
    $scope.FTLSplit_Click = function ($event, grid, win) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.OPS,
            method: _OPSAppointment_DIViewOnMapV2.URL.FTLSplit_Check,
            data: {
                    ...
                    if (res == true) {
                        $rootScope.Message({
                            ...
                            Ok: function () {
                                ...
                                Common.Services.Call($http, {
                                    url: Common.Services.url.OPS,
                                    method: _OPSAppointment_DIViewOnMapV2.URL.FTLSplit,
                        ...
                        Common.Services.Call($http, {
                            url: Common.Services.url.OPS,
                            method: _OPSAppointment_DIViewOnMapV2.URL.GroupByTrip_List,
                            data: {
    ...
    $scope.SwitchView_Click = function ($event) {
        ...
        try {
            ...
            if (view == 'ver') {
                Common.Cookie.Clear("DIViewOnMapV2_View");
                $state.go("main.OPSAppointment.DIViewOnMapV2", { view: undefined });
            } else {
                Common.Cookie.Set("DIViewOnMapV2_View", 'ver');
                $state.go("main.OPSAppointment.DIViewOnMapV2", { view: 'ver' });
            }
        } catch (e) {
        }
    }
    ...
    $scope.new_trip_Grid_Options = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.OPS,
            method: _OPSAppointment_DIViewOnMapV2.URL.DITOGroupProduct_List,
            pageSize: 100,
        ...
        height: '99%', groupable: false, pageable: Common.PageSize, columnMenu: false, resizable: true, reorderable: true, sortable: true, filterable: { mode: 'row' },
        dataBound: function () {
            $scope.NewTripChoose = false;
        ...
        if ($scope.NewTripViewAction == 0) {
            ...
            $rootScope.Message({
                ...
                Ok: function () {
                    ...
                    Common.Services.Call($http, {
                        url: Common.Services.url.OPS,
                        method: _OPSAppointment_DIViewOnMapV2.URL.ToMon,
                        data: {
                            data: data
                        },
                        success: function (res) {
        ...
        if ($scope.NewTripViewAction == 0) {
            ...
            $rootScope.Message({
                ...
                Ok: function () {
                    ...
                    Common.Services.Call($http, {
                        url: Common.Services.url.OPS,
                        method: _OPSAppointment_DIViewOnMapV2.URL.ToOPS,
                        data: {
                            data: data
                        },
                        success: function (res) {
        ...
        if ($scope.NewTripViewAction == 0) {
            ...
            $rootScope.Message({
                ...
                Ok: function () {
                    ...
                    Common.Services.Call($http, {
                        url: Common.Services.url.OPS,
                        method: _OPSAppointment_DIViewOnMapV2.URL.Delete,
                        data: {
                            data: data
                        },
                        success: function (res) {
    ...
    $scope.gopTOTon_Options = {
        ...
        change: function (e) {
            ...
            if (val > dataItem.Ton + 0.001) {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.OPS,
                    method: _OPSAppointment_DIViewOnMapV2.URL.DI2View_Master_Update_Check4Update,
                    data: {
                            ...
                            if (res == true) {
                                $rootScope.Message({
                                    ...
                                    Ok: function () {
                                        ...
                                        Common.Services.Call($http, {
                                            url: Common.Services.url.OPS,
                                            method: _OPSAppointment_DIViewOnMapV2.URL.DI2View_Master_Update_Group_Quantity,
                                            data: {
                                                gopID: dataItem.ID, mID: dataItem.TOMasterID, value: val, packingType: 1
                                            },
                                            success: function (res) {
    ...
    $scope.new2view_trip_Grid_Options = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.OPS,
            method: _OPSAppointment_DIViewOnMapV2.URL.DI2View_GroupProduct_List,
        ...
        change: function (e) {
            ...
            if (val > 0) {
                ...
                if (!flag || toMasterID < 1) {
                    $rootScope.Message({
                        ...
                        Ok: function () {
                            ...
                            $scope.NewTripItem = {
                                ...
                                ListOPSGOPName: [],
                                LocationStartID: _OPSAppointment_DIViewOnMapV2.Data.Location.LocationStartID,
                                LocationStartName: _OPSAppointment_DIViewOnMapV2.Data.Location.LocationStartName,
                                LocationEndID: _OPSAppointment_DIViewOnMapV2.Data.Location.LocationEndID,
                                LocationEndName: _OPSAppointment_DIViewOnMapV2.Data.Location.LocationEndName,
                                LocationStartLat: _OPSAppointment_DIViewOnMapV2.Data.Location.LocationStartLat,
                                LocationStartLng: _OPSAppointment_DIViewOnMapV2.Data.Location.LocationStartLng,
                                LocationEndLat: _OPSAppointment_DIViewOnMapV2.Data.Location.LocationEndLat,
                                LocationEndLng: _OPSAppointment_DIViewOnMapV2.Data.Location.LocationEndLng,
                    ...
                    Common.Services.Call($http, {
                        url: Common.Services.url.OPS,
                        method: _OPSAppointment_DIViewOnMapV2.URL.DI2View_Master_Update_Check4Consolidate,
                            ...
                            if (res == true) {
                                $rootScope.Message({
                                    ...
                                    Ok: function () {
                                        ...
                                        Common.Services.Call($http, {
                                            url: Common.Services.url.OPS,
                                            method: _OPSAppointment_DIViewOnMapV2.URL.DI2View_Master_Update_Group,
                                            data: {
    ...
    $scope.$watch('NewTripItem.VendorOfVehicleID', function (nval, oval) {
        ...
        if ($scope.NewTripDetail) {
            Common.Log("NewTripItem.VendorOfVehicleID- -NewTripDetail")
            ...
            $rootScope.Message({
                ...
                Ok: function () {
                    ...
                    if ($scope.NewTripItem.ID < 1) {
                        ...
                        Common.Services.Call($http, {
                            url: Common.Services.url.OPS,
                            method: _OPSAppointment_DIViewOnMapV2.URL.DI2View_Master_Update,
                            data: {
                                item: $scope.NewTripItem
                            },
                            success: function (res) {
        ...
        save: function (e) {
            ...
            $rootScope.Message({
                ...
                Ok: function () {
                    ...
                    Common.Services.Call($http, {
                        url: Common.Services.url.OPS,
                        method: _OPSAppointment_DIViewOnMapV2.URL.DI2View_Master_Update_TimeLine,
    ...
    $scope.LoadNewTimeLineData = function () {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.OPS,
            method: _OPSAppointment_DIViewOnMapV2.URL.Schedule_Data,
