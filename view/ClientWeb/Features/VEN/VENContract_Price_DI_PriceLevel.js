...
var _VENContract_Price_DI_PriceLevel = {
    URL: {
        ...
        GroupVehicleLV_Save: 'VENPrice_DI_PriceGVLevel_Save',
        GroupVehicle_DetailData: 'VENPrice_DI_PriceGVLevel_DetailData',
        GroupVehicle_ExcelExport: 'VENPrice_DI_PriceGVLevel_ExcelExport',
        GroupVehicle_ExcelCheck: 'VENPrice_DI_PriceGVLevel_ExcelCheck',
        GroupVehicle_ExcelImport: 'VENPrice_DI_PriceGVLevel_ExcelImport',

        PriceLevel_Save: 'VENPrice_DI_PriceLevel_Save',
        PriceLevel_DetailData: 'VENPrice_DI_PriceLevel_DetailData',
        PriceLevel_ExcelExport: 'VENPrice_DI_PriceLevel_ExcelExport',
        PriceLevel_ExcelImport: 'VENPrice_DI_PriceLevel_ExcelImport',
        PriceLevel_ExcelCheck: 'VENPrice_DI_PriceLevel_ExcelCheck',

        GOV_ExcelInit: 'VENPrice_DI_PriceGVLevel_ExcelInit',
        GOV_ExcelChange: 'VENPrice_DI_PriceGVLevel_ExcelChange',
        GOV_ExcelImport: 'VENPrice_DI_PriceGVLevel_ExcelOnImport',
        GOV_ExcelApprove: 'VENPrice_DI_PriceGVLevel_ExcelApprove',

        ExcelInit: 'VENPrice_DI_PriceLevel_ExcelInit',
        ExcelChange: 'VENPrice_DI_PriceLevel_ExcelChange',
        ExcelImport: 'VENPrice_DI_PriceLevel_OnExcelImport',
        ExcelApprove: 'VENPrice_DI_PriceLevel_ExcelApprove',
    },
    Data: {
        ListPriceOfGOP: null,
...
angular.module('myapp').controller('VENContract_Price_DI_PriceLevelCtrl', ['$rootScope', '$scope', '$http', '$location', '$state', '$timeout', '$stateParams', function ($rootScope, $scope, $http, $location, $state, $timeout, $stateParams) {
    Common.Log('VENContract_Price_DI_PriceLevelCtrl');
    $rootScope.IsLoading = false;

    $scope.Item = null;
    _VENContract_Price_DI_PriceLevel.Params = $.extend(true, _VENContract_Price_DI_PriceLevel.Params, $state.params);
    $scope.IsFrame = false;


    Common.Services.Call($http, {
        url: Common.Services.url.VEN,
        method: _VENContract_Price_DI_PriceLevel.URL.Data,
        data: { contractTermID: _VENContract_Price_DI_PriceLevel.Params.TermID },
        success: function (res) {
            _VENContract_Price_DI_PriceLevel.Data.ListGroupVehicle = res.ListGroupOfVehicle;
            _VENContract_Price_DI_PriceLevel.Data.ListGroupProduct = res.ListGroupOfProduct;
            _VENContract_Price_DI_PriceLevel.Data.ListRouting = res.ListRouting;
            _VENContract_Price_DI_PriceLevel.Data.ListLevel = res.ListLevel;

            Common.Services.Call($http, {
                url: Common.Services.url.VEN,
                method: _VENContract_Price_DI_PriceLevel.URL.Get,
                data: { priceID: _VENContract_Price_DI_PriceLevel.Params.PriceID },
                success: function (res) {
                    $scope.Item = res;
                    if ($scope.Item.ID > 0) {
                        $timeout(function () {
    ...
    $scope.Back_Click = function ($event) {
        ...
        $state.go("main.VENContract.PriceDI", _VENContract_Price_DI_PriceLevel.Params)
    }
    ...
    $scope.InitView_PriceLevel = function () {
        Common.Services.Call($http, {
            url: Common.Services.url.VEN,
            method: _VENContract_Price_DI_PriceLevel.URL.PriceLevel_DetailData,
            data: { priceID: _VENContract_Price_DI_PriceLevel.Params.PriceID },
            success: function (res) {
                ...
                Common.Data.Each(_VENContract_Price_DI_PriceLevel.Data.ListLevel, function (level) {
                    if (_VENContract_Price_DI_PriceLevel.Data.ListGroupProduct.length > 0) {
                        var listCol = [];
                        Common.Data.Each(_VENContract_Price_DI_PriceLevel.Data.ListGroupProduct, function (pro) {
                ...
                Common.Data.Each(_VENContract_Price_DI_PriceLevel.Data.ListRouting, function (route) {
                    var item = {};
    ...
    $scope.GOPLevel_Save_Click = function ($event, grid) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.VEN,
            method: _VENContract_Price_DI_PriceLevel.URL.PriceLevel_Save,
            data: { lst: dataSave, priceID: _VENContract_Price_DI_PriceLevel.Params.PriceID },
            success: function (res) {
                $scope.InitView_PriceLevel();
                $rootScope.IsLoading = false;
    ...
    $scope.PriceLevel_Excel_Click = function ($event, win) {
        ...
        $rootScope.UploadExcel({
            ...
            Download: function () {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.VEN,
                    method: _VENContract_Price_DI_PriceLevel.URL.PriceLevel_ExcelExport,
                    data: { priceID: _VENContract_Price_DI_PriceLevel.Params.PriceID, contractTermID: _VENContract_Price_DI_PriceLevel.Params.TermID },
                    success: function (res) {
                        $rootScope.IsLoading = false;
            ...
            Upload: function (e, callback) {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.VEN,
                    method: _VENContract_Price_DI_PriceLevel.URL.PriceLevel_ExcelCheck,
                    data: { file: e, priceID: _VENContract_Price_DI_PriceLevel.Params.PriceID, contractTermID: _VENContract_Price_DI_PriceLevel.Params.TermID },
            ...
            Complete: function (e, data) {
                if (!$scope.Item.TermClosed) {
                    ...
                    Common.Services.Call($http, {
                        url: Common.Services.url.VEN,
                        method: _VENContract_Price_DI_PriceLevel.URL.PriceLevel_ExcelImport,
                        data: { lst: data, priceID: _VENContract_Price_DI_PriceLevel.Params.PriceID },
                        success: function (res) {
                            $rootScope.Message({ Msg: 'Thành công', NotifyType: Common.Message.NotifyType.SUCCESS });
                            $scope.InitView_PriceLevel()
                        },
    ...
    $scope.InitView_GroupVehicleLV = function (isframe) {
        Common.Services.Call($http, {
            url: Common.Services.url.VEN,
            method: _VENContract_Price_DI_PriceLevel.URL.GroupVehicle_DetailData,
            data: { id: _VENContract_Price_DI_PriceLevel.Params.PriceID },
            success: function (res) {
    ...
    $scope.GOVLevel_Save_Click = function ($event, grid) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.VEN,
            method: _VENContract_Price_DI_PriceLevel.URL.GroupVehicleLV_Save,
            data: { lst: dataSave, priceID: _VENContract_Price_DI_PriceLevel.Params.PriceID },
            success: function (res) {
    ...
    $scope.GOV_Excel_Click = function ($event, win) {
        ...
        $rootScope.UploadExcel({
            ...
            Download: function () {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.VEN,
                    method: _VENContract_Price_DI_PriceLevel.URL.GroupVehicle_ExcelExport,
                    data: { priceID: _VENContract_Price_DI_PriceLevel.Params.PriceID, contractTermID: _VENContract_Price_DI_PriceLevel.Params.TermID, isFrame: $scope.IsFrame },
                    success: function (res) {
                        $rootScope.IsLoading = false;
                        $rootScope.DownloadFile(res);
                    },
            ...
            Upload: function (e, callback) {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.VEN,
                    method: _VENContract_Price_DI_PriceLevel.URL.GroupVehicle_ExcelCheck,
                    data: { file: e, priceID: _VENContract_Price_DI_PriceLevel.Params.PriceID, contractTermID: _VENContract_Price_DI_PriceLevel.Params.TermID, isFrame: $scope.IsFrame },
                    success: function (data) {
                        $rootScope.IsLoading = false;
                        callback(data);
                    }
            ...
            Complete: function (e, data) {
                if (!$scope.Item.TermClosed) {
                    ...
                    Common.Services.Call($http, {
                        url: Common.Services.url.VEN,
                        method: _VENContract_Price_DI_PriceLevel.URL.GroupVehicle_ExcelImport,
                        data: { lst: data, priceID: _VENContract_Price_DI_PriceLevel.Params.PriceID },
                        success: function (res) {
                            $rootScope.IsLoading = false;
                            $rootScope.Message({ Msg: 'Thành công', NotifyType: Common.Message.NotifyType.SUCCESS });
    ...
    $scope.GOV_ExcelOnline_Click = function ($event) {
        ...
        $rootScope.excelShare.Init({
            ...
            params: {
                priceID: _VENContract_Price_DI_PriceLevel.Params.PriceID,
                contractTermID: _VENContract_Price_DI_PriceLevel.Params.TermID,
                isFrame: $scope.IsFrame
            },
            rowStart: 1,
            colCheckChange: 6,
            url: Common.Services.url.VEN,
            methodInit: _VENContract_Price_DI_PriceLevel.URL.GOV_ExcelInit,
            methodChange: _VENContract_Price_DI_PriceLevel.URL.GOV_ExcelChange,
            methodImport: _VENContract_Price_DI_PriceLevel.URL.GOV_ExcelImport,
            methodApprove: _VENContract_Price_DI_PriceLevel.URL.GOV_ExcelApprove,
    ...
    $scope.PriceLevel_ExcelOnline_Click = function ($event) {
        ...
        $rootScope.excelShare.Init({
            ...
            colCheckChange: 6,
            url: Common.Services.url.VEN,
            methodInit: _VENContract_Price_DI_PriceLevel.URL.ExcelInit,
            methodChange: _VENContract_Price_DI_PriceLevel.URL.ExcelChange,
            methodImport: _VENContract_Price_DI_PriceLevel.URL.ExcelImport,
            methodApprove: _VENContract_Price_DI_PriceLevel.URL.ExcelApprove,
            lstMessageError: lstMessageError,
            Changed: function () {
