...
var _VENVendor_Contract = {
    URL: {
        Get: 'VENContract_Get',
        Save: 'VENContract_Save',
        Delete: 'VENContract_Delete',
        TypeOfSGroupProductChangeSave: "VENContract_Setting_TypeOfSGroupProductChangeSave",
        Data: 'VENContract_Data',

        CODefault_List: 'VENContract_CODefault_List',
        CODefault_Save: 'VENContract_CODefault_Update',
        CODefault_NotIn_List: 'VENContract_CODefault_NotInList',
        CODefault_NotIn_Save: 'VENContract_CODefault_NotIn_SaveList',
        CODefault_Delete: 'VENContract_CODefault_Delete',
        ...
        RoutingExcelOnline_Init: 'VENContract_Routing_ExcelOnline_Init',
        RoutingExcelOnline_Change: 'VENContract_Routing_ExcelOnline_Change',
        RoutingExcelOnline_Import: 'VENContract_Routing_ExcelOnline_Import',
        RoutingExcelOnline_Approve: 'VENContract_Routing_ExcelOnline_Approve',
        ...
        Read_LocationNotIn: 'VENContract_NewRouting_LocationList',
        Read_AreaNotIn: 'VENContract_NewRouting_AreaList',
        Save_Area: 'VENContract_NewRouting_AreaSave',
        Delete_Area: 'VENContract_NewRouting_AreaDelete',
        Refresh_RoutingArea: 'VENContract_NewRouting_AreaRefresh',
        Get_Area: 'VENContract_NewRouting_AreaGet',
        Read_AreaDetail: 'VENContract_NewRouting_AreaDetailList',
        Get_AreaDetail: 'VENContract_NewRouting_AreaDetailGet',
        Delete_AreaDetail: 'VENContract_NewRouting_AreaDetailDelete',
        Save_AreaDetail: 'VENContract_NewRouting_AreaDetailSave',
        Save_Routing: 'VENContract_NewRouting_Save',
        Get_Routing: 'VENContract_NewRouting_Get',

        AreaLocation_List: 'VENContract_NewRouting_AreaLocation_List',
        AreaLocation_NotInList: 'VENContract_NewRouting_AreaLocationNotIn_List',
        AreaLocation_NotInSave: 'VENContract_NewRouting_AreaLocationNotIn_Save',
        AreaLocation_Delete: 'VENContract_NewRouting_AreaLocation_Delete',
        AreaLocation_Copy: 'VENContract_NewRouting_AreaLocation_Copy',

        ContractRouting_Delete: 'VENContract_Routing_NotIn_Delete',

        Routing_search_List: 'VENContract_Routing_CATNotIn_List',
        Routing_search_save: 'VENContract_Routing_CATNotIn_Save',

        TypeOfRunLevelSave: 'VENContract_Setting_TypeOfRunLevelSave',
        contractSetting_save: "VenContractSetting_Save",

        GOVListSetting: 'VENContract_Setting_Level_GOVList',

        GOVList: 'VENContract_Setting_GOVList',
        GOVGet: 'VENContract_Setting_GOVGet',
        GOVSave: 'VENContract_Setting_GOVSave',
        GOVDeleteList: 'VENContract_Setting_GOVDeleteList',
        GOVNotInList: 'VENContract_Setting_GOVNotInList',
        GOVNotInSave: 'VENContract_Setting_GOVNotInSave',

        LevelList: 'VENContract_Setting_LevelList',
        LevelGet: 'VENContract_Setting_LevelGet',
        LevelSave: 'VENContract_Setting_LevelSave',
        LevelDeleteList: 'VENContract_Setting_LevelDeleteList',

        Term_List: 'VENContract_ContractTerm_List',
        Term_Get: 'VENContract_ContractTerm_Get',
        Term_Save: 'VENContract_ContractTerm_Save',
        Term_Delete: 'VENContract_ContractTerm_Delete',
        Term_Price_List: 'VENContract_ContractTerm_Price_List',
        Term_Lock: 'VENContract_ContractTerm_Close',
        Term_UnLock: 'VENContract_ContractTerm_Open',
        Term_RemoveWarning: 'VENTerm_Change_RemoveWarning',
        Routing_ContractTerm: 'VENContract_Routing_ContractTermList',

        GroupOfProduct_ExcelInit: 'VENContract_GroupOfProduct_ExcelInit',
        GroupOfProduct_ExcelChange: 'VENContract_GroupOfProduct_ExcelChange',
        GroupOfProduct_ExcelImport: 'VENContract_GroupOfProduct_ExcelImport',
        GroupOfProduct_ExcelApprove: 'VENContract_GroupOfProduct_ExcelApprove',
    },
    Data: {
        ListCustomer: null,
        ListMaterial: null,
    ...
    ExcelKey: {
        Resource: "VENCustomer_Contract_Excel",
        ContractRouting: "VENContractRouting",
        GroupOfProduct: "CUSContractGroupOfProduct",
        ResourceGroupOfProduct: "CUSContract_GroupOfProduct_Excel",
    }
}

angular.module('myapp').controller('VENVendor_ContractCtrl', ['$rootScope', '$scope', '$http', '$location', '$state', '$timeout', '$stateParams', function ($rootScope, $scope, $http, $location, $state, $timeout, $stateParams) {
    if ($rootScope.IsPageComplete != true) return;
    Common.Log('VENVendor_ContractCtrl');
    $rootScope.IsLoading = false;
    $rootScope.Loading.Show('Thông tin hợp đồng đối tác');
    var LoadingStep = 40;
    $scope.TabIndex = 0;
    $scope.TabIndexM = 0;
    ...
    if ($scope.ID <= 0) {
        if (Common.HasValue($scope.CustomerID) && $scope.CustomerID > 0) {
            if (!$rootScope.CheckView("ActAdd", "main.VENVendor.Detail", { id: $scope.CustomerID })) return;
        }
        else {
            if (!$rootScope.CheckView("ActAdd", "main.VENContract.Index")) return;
        }
    }
    ...
    $scope.TypeOf_ladenempty_Click = function ($event) {
        ...
        $.each(_VENVendor_Contract.Data.ListSetting, function (i, v) {
        ...
        Common.Services.Call($http, {
            ...
            method: _VENVendor_Contract.URL.contractSetting_save,
            data: { contractID: $scope.ID, setting: _VENVendor_Contract.Data.ListSetting },
    ...
    $scope.gop_cbo_GroupOfProductOptions = {
        ...
        change: function (e) {
            ...
            if (e.sender.selectedIndex >= 0) {
                $timeout(function () {
                    $scope.gop_cbo_ProductOptions.dataSource.data(_VENVendor_Contract.Data.ListProduct[val]);
        ...
        change: function (e) {
            ...
            if (e.sender.selectedIndex >= 0) {
                $timeout(function () {
                    ...
                    if (Common.HasValue(_VENVendor_Contract.Data.ListProduct[val])) {
                        $.each(_VENVendor_Contract.Data.ListProduct[val], function (i, v) {
                            datacbo.push(v);
                        });
                    }
    ...
    Common.Services.Call($http, {
        url: Common.Services.url.VEN,
        method: _VENVendor_Contract.URL.Data,
        data: { ID: $scope.ID },
        success: function (res) {
            _VENVendor_Contract.Data.ListCustomer = res.ListCustomer;
            _VENVendor_Contract.Data.ListCompany = {};
            _VENVendor_Contract.Data.ListKPI = res.ListKPI;
            _VENVendor_Contract.Data.ListGOP = res.ListGroupOfProduct;

            _VENVendor_Contract.Data.ListGOPHasEmpty = [];
            _VENVendor_Contract.Data.ListGOPHasEmpty.push({ ID: -1, Code: ' ', GroupName: ' ' });
            _VENVendor_Contract.Data.ListProduct = {};
            var itemProEmpty = { ID: -1, Code: ' ', ProductName: ' ' };

            Common.Data.Each(_VENVendor_Contract.Data.ListGOP, function (o) {
                _VENVendor_Contract.Data.ListGOPHasEmpty.push(o);
                if (!Common.HasValue(_VENVendor_Contract.Data.ListProduct[o.ID])) {
                    _VENVendor_Contract.Data.ListProduct[o.ID] = [];
                    _VENVendor_Contract.Data.ListProduct[o.ID].push(itemProEmpty);
                }
            })
            _VENVendor_Contract.Data.ListProduct['-1'] = [];
            _VENVendor_Contract.Data.ListProduct['-1'].push(itemProEmpty);
            $scope.gop_cbo_GroupOfProductChangeOptions.dataSource.data(_VENVendor_Contract.Data.ListGOPHasEmpty);

            Common.Data.Each(res.ListProduct, function (o) {
                _VENVendor_Contract.Data.ListProduct[o.GroupOfProductID].push(o);
            })
            ...
            Common.Data.Each(res.ListCustomer, function (o) {
                _VENVendor_Contract.Data.ListCompany[o.ID] = [];
                _VENVendor_Contract.Data.ListCompany[o.ID].push({ CustomerRelateName: ' ', ID: -1 })
            })
            Common.Data.Each(res.ListCompany, function (o) {
                _VENVendor_Contract.Data.ListCompany[o.CustomerOwnID].push(o);
            })
            _VENVendor_Contract.Data.ListMaterial = res.ListMaterial;
            //$scope.cboMaterial_Options.dataSource.data(_VENVendor_Contract.Data.ListMaterial);
            Common.Services.Call($http, {
                url: Common.Services.url.VEN,
                method: _VENVendor_Contract.URL.Get,
                data: { ID: $scope.ID },
                success: function (res) {
                    $scope.Item = res;
                    _VENVendor_Contract.Data.ListSetting = res.ListSetting;
                    ...
                    if ($scope.Item.ID < 1) {
                        ...
                        _VENVendor_Contract.Const.CustomerID = $scope.Item.CustomerID;
                        _VENVendor_Contract.Const.CompanyID = $scope.Item.CompanyID;
    ...
    $scope.LoadDataCompany = function (isChange) {
        ...
        var data = _VENVendor_Contract.Data.ListCompany[cusID]
    ...
    $scope.codefault_gridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.VEN,
            method: _VENVendor_Contract.URL.CODefault_List,
            readparam: function () {
                return {
                    contractID: $scope.ID
                }
    ...
    $scope.codefault_notin_gridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.VEN,
            method: _VENVendor_Contract.URL.CODefault_NotIn_List,
            readparam: function () {
                return {
                    contractID: $scope.ID
                }
    ...
    $scope.CODefault_Save_Click = function ($event, grid) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.VEN,
            method: _VENVendor_Contract.URL.CODefault_Save,
    ...
    $scope.CODefault_NotIn_Save_Click = function ($event, grid, win) {
        ...
        if (data.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.VEN,
                method: _VENVendor_Contract.URL.CODefault_NotIn_Save,
                data: { data: data, contractID: $scope.ID },
                success: function (res) {
                    Common.Services.Error(res, function (res) {
                        $rootScope.Message({ Msg: "Đã cập nhật." });
        ...
        if (data.length > 0) {
            $rootScope.Message({
                ...
                Ok: function () {
                    ...
                    Common.Services.Call($http, {
                        url: Common.Services.url.VEN,
                        method: _VENVendor_Contract.URL.CODefault_Delete,
                        data: { data: lst },
                        success: function (res) {
                            Common.Services.Error(res, function (res) {
                                $rootScope.Message({ Msg: "Đã cập nhật." });
    ...
    //    Common.Services.Call($http, {
    //        url: Common.Services.url.VEN,
    //        method: _VENVendor_Contract.URL.Routing_List,
    ...
    //            var objCol = {};
    //            Common.Data.Each(_VENVendor_Contract.Data.ListKPI, function (o) {
    //                columns.push({
    ...
    $scope.Routing_CATAreaDetail_Click = function ($event, data, win) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.VEN,
            method: _VENVendor_Contract.URL.Get_Routing,
    ...
    $scope.AreaLocationFrom_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.VEN,
            method: _VENVendor_Contract.URL.AreaLocation_List,
    ...
    $scope.AreaLocationFromNotIn_Save_Click = function ($event, win, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.VEN,
                method: _VENVendor_Contract.URL.AreaLocation_NotInSave,
    ...
    $scope.AreaLocationFrom_Delete = function ($event, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.VEN,
                method: _VENVendor_Contract.URL.AreaLocation_Delete,
                data: { lstID: datasend },
                success: function (res) {
                    $rootScope.IsLoading = false;
                    $scope.AreaLocationFrom_GridOptions.dataSource.read();
    ...
    $scope.Routing_Edit_Click = function ($event, item, win) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.VEN,
            method: _VENVendor_Contract.URL.Routing_ContractTerm,
            data: { contractID: $scope.ID },
            success: function (res) {
    ...
    $scope.Routing_Delete_Click = function ($event, item) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.VEN,
            method: _VENVendor_Contract.URL.Routing_Delete,
            data: { ID: item.ID },
            success: function (res) {
                Common.Services.Error(res, function (res) {
    ...
    $scope.routing_notin_gridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.VEN,
            method: _VENVendor_Contract.URL.Routing_NotIn_List,
            readparam: function () {
                return {
                    contractID: $scope.ID
                }
        ...
        columns: [
            {
                ...
                template: '<input class="chkChoose" type="checkbox" #= IsChoose ? "checked=checked" : "" # ng-click="gridChoose_Check($event,routing_notin_grid)" />' +
                    ...
                    '<a href="/" ng-click="RoutingCUSDelete_Click($event,dataItem)" class="k-button" ng-show="Auth.ActDel"><i class="fa fa-trash"></i></a>',
                filterable: false, sortable: false
            },
            {
                field: 'Code', title: 'Mã cung đường', width: 150, filterable: { cell: { operator: 'contains', showOperators: false } }
    ...
    $scope.RoutingCUSDelete_Click = function ($event, data) {
        ...
        $rootScope.Message({
            ...
            Ok: function () {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.VEN,
                    method: _VENVendor_Contract.URL.ContractRouting_Delete,
    ...
    $scope.Routing_NotIn_Submit_Click = function ($event, grid, win) {
        ...
        if (data.length > 0) {
            Common.Services.Call($http, {
                url: Common.Services.url.VEN,
                method: _VENVendor_Contract.URL.Routing_Insert,
                data: { data: data, contractID: $scope.ID },
                success: function (res) {
                    Common.Services.Error(res, function (res) {
                        $rootScope.IsLoading = false;
    ...
    $scope.Routing_Info_Save = function (grid, win) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.VEN,
            method: _VENVendor_Contract.URL.Routing_Save,
    ...
    $scope.Routing_Excel_Click = function ($event, win) {
        ...
        $rootScope.UploadExcel({
            ...
            Download: function () {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.VEN,
                    method: _VENVendor_Contract.URL.Routing_Excel_Export,
                    data: { contractID: $scope.ID },
                    success: function (res) {
            ...
            Upload: function (e, callback) {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.VEN,
                    method: _VENVendor_Contract.URL.Routing_Excel_Check,
            ...
            Complete: function (e, data) {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.VEN,
                    method: _VENVendor_Contract.URL.Routing_Excel_Import,
                    data: { data: data, contractID: $scope.ID },
                    success: function (res) {
                        $rootScope.IsLoading = false;
                        $rootScope.Message({ Msg: "Đã cập nhật!" });
    ...
    $scope.KPI_SaveChanges_Click = function ($event, grid) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.VEN,
            method: _VENVendor_Contract.URL.KPI_Save,
    ...
    $scope.KPI_Check_Expression_Click = function ($event) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.VEN,
            method: _VENVendor_Contract.URL.KPI_Check_Expression,
            data: {
    ...
    $scope.KPI_Check_KPI_Click = function ($event) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.VEN,
            method: _VENVendor_Contract.URL.KPI_Check_KPI,
            data: {
                Expression: $scope.KPIItemCheck.Expression,
    ...
    $scope.kpi_routing_gridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.VEN,
            method: _VENVendor_Contract.URL.KPI_Routing_List,
            readparam: function () {
                return {
    ...
    $scope.KPI_Routing_Submit_Click = function ($event, grid, win) {
        ...
        if (data.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.VEN,
                method: _VENVendor_Contract.URL.KPI_Routing_Apply,
                data: { data: data, routingID: $scope.RoutingItem.ID },
                success: function (res) {
                    Common.Services.Error(res, function (res) {
                        $rootScope.Message({ Msg: "Đã cập nhật." });
    ...
    $scope.LocationNotIn_win_gridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.VEN,
            method: _VENVendor_Contract.URL.Read_LocationNotIn,
    ...
    $scope.AreaNotIn_win_gridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.VEN,
            method: _VENVendor_Contract.URL.Read_AreaNotIn,
            readparam: function () { return {} },
            model: {
                id: 'ID',
                fields: {
        ...
        columns: [
            {
                ...
                template: '<a href="/" ng-click="AreaNotInEdit_Click($event,AreaEdit_winPopup,AreaNotIn_win_grid)" class="k-button"><i class="fa fa-pencil"></i></a>' +
                    '<a href="/" ng-click="AreaNotInDestroy_Click($event,AreaNotIn_win_grid)" class="k-button"><i class="fa fa-trash"></i></a>' +
        ...
        if (Common.HasValue(item)) {
            ...
            $rootScope.Message({
                ...
                Ok: function () {
                    Common.Services.Call($http, {
                        url: Common.Services.url.VEN,
                        method: _VENVendor_Contract.URL.Refresh_RoutingArea,
                        data: { 'item': item },
                        success: function (res) {
                            $rootScope.Message({
    ...
    $scope.AreaNotInDestroy_Click = function ($event, grid) {
        ...
        if (Common.HasValue(item)) {
            if (confirm('Bạn muốn xóa các dữ liệu đã chọn ?')) {
                Common.Services.Call($http, {
                    url: Common.Services.url.VEN,
                    method: _VENVendor_Contract.URL.Delete_Area,
                    data: { 'item': item },
                    success: function (res) {
    ...
    $scope.AreaLoadItem = function (win, id) {
        Common.Services.Call($http, {
            url: Common.Services.url.VEN,
            method: _VENVendor_Contract.URL.Get_Area,
            data: { 'ID': id },
            success: function (res) {
        ...
        $rootScope.Message({
            ...
            Ok: function () {
                if (vform()) {
                    Common.Services.Call($http, {
                        url: Common.Services.url.VEN,
                        method: _VENVendor_Contract.URL.Save_Area,
    ...
    $scope.AreaNotInDetail_gridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.VEN,
            method: _VENVendor_Contract.URL.Read_AreaDetail,
        ...
        columns: [
            {
                ...
                template: '<a href="/" ng-click="AreaNotInDetail_EditClick($event,AreaDetailEdit_winPopup,AreaNotInDetail_grid)" class="k-button"><i class="fa fa-pencil"></i></a>' +
                    '<a href="/" ng-click="AreaNotInDetail_DestroyClick($event,AreaNotInDetail_grid)" class="k-button"><i class="fa fa-trash"></i></a>',
                filterable: false, sortable: false
            },
        ...
        if (Common.HasValue(item)) {
            ...
            $rootScope.Message({
                ...
                Ok: function () {
                    ...
                    Common.Services.Call($http, {
                        url: Common.Services.url.VEN,
                        method: _VENVendor_Contract.URL.Delete_AreaDetail,
                        data: { 'item': item },
                        success: function (res) {
                            $scope.AreaNotInDetail_gridOptions.dataSource.read();
                            $rootScope.IsLoading = false;
    ...
    $scope.AreaDetailLoadItem = function (win, id) {
        Common.Services.Call($http, {
            url: Common.Services.url.VEN,
            method: _VENVendor_Contract.URL.Get_AreaDetail,
            data: { 'ID': id },
            success: function (res) {
    ...
    $scope.LoadRegionData = function (item) {
        ...
        try {
            ...
            var data = _VENVendor_Contract.Data.Province[countryID];
            ...
            data = _VENVendor_Contract.Data.District[provinceID];
    ...
    Common.ALL.Get($http, {
        ...
        success: function (data) {
            _VENVendor_Contract.Data.Province = {};
            angular.forEach(data, function (obj, indx) {
                if (Common.HasValue(_VENVendor_Contract.Data.Province[obj.CountryID]))
                    _VENVendor_Contract.Data.Province[obj.CountryID].push(obj);
                else _VENVendor_Contract.Data.Province[obj.CountryID] = [obj];
            })
        }
    })
    ...
    Common.ALL.Get($http, {
        ...
        success: function (data) {
            _VENVendor_Contract.Data.District = {};
            angular.forEach(data, function (obj, indx) {
                if (Common.HasValue(_VENVendor_Contract.Data.District[obj.ProvinceID]))
                    _VENVendor_Contract.Data.District[obj.ProvinceID].push(obj);
                else _VENVendor_Contract.Data.District[obj.ProvinceID] = [obj];
            })
        }
    })
    ...
    $scope.AreaDetailEdit_winPopupSave_Click = function ($event, win, vform) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.VEN,
            method: _VENVendor_Contract.URL.Save_AreaDetail,
    ...
    $scope.CUSRoutingEditSave_Click = function ($event, win, vform) {
        ...
        if (vform()) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.VEN,
                method: _VENVendor_Contract.URL.Save_Routing,
    ...
    $scope.AreaLocationAreaNotIn_AddChooseClick = function ($event, win, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.VEN,
                method: _VENVendor_Contract.URL.AreaLocation_Copy,
                data: { areaID: $scope.CurrentAreaLocationID, lstID: datasend },
                success: function (res) {
                    $rootScope.IsLoading = false;
                    $scope.AreaLocation_win_gridOptions.dataSource.read();
    ...
    $scope.routing_search_gridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.VEN,
            method: _VENVendor_Contract.URL.Routing_search_List,
            readparam: function () {
                return {
                    contractID: $scope.ID
                }
    ...
    $scope.Routing_Search_Save_Click = function ($event, grid, win) {
        ...
        if (data.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.VEN,
                method: _VENVendor_Contract.URL.Routing_search_save,
    ...
    //    dataSource: Common.DataSource.Grid($http, {
    //        url: Common.Services.url.VEN,
    //        method: _VENVendor_Contract.URL.Material_List,
    //        readparam: function () {
    //            return {
    //                contractID: $scope.ID
    //            }
    ...
    //                '<a href="/" ng-show="dataItem.IsWarning" ng-click="Material_Detail_Click($event,dataItem)" class="k-button"><i class="fa fa-file"></i></a>',
    //            filterable: false, sortable: false
    //        },
    //        {
    ...
    //    $event.preventDefault();
    //    $state.go("main.VENContract.Material", { ContractMaterialID: data.ID, StatusID: 2 });
    //};
    ...
    //    Common.Services.Call($http, {
    //        url: Common.Services.url.VEN,
    //        method: _VENVendor_Contract.URL.Material_Delete,
    //        data: { id: item.ID },
    //        success: function (res) {
    //            $rootScope.IsLoading = false;
    //            $scope.material_gridOptions.dataSource.read();
    ...
    //    Common.Services.Call($http, {
    //        url: Common.Services.url.VEN,
    //        method: _VENVendor_Contract.URL.Material_Get,
    //        data: { id: id },
    //        success: function (res) {
    //            vform
    //            $rootScope.IsLoading = false;
    ...
    //    dataSource: Common.DataSource.Grid($http, {
    //        url: Common.Services.url.VEN,
    //        method: _VENVendor_Contract.URL.Material_RoutingList,
    ...
    //    dataSource: Common.DataSource.Grid($http, {
    //        url: Common.Services.url.VEN,
    //        method: _VENVendor_Contract.URL.Material_RoutingNotList,
    //        readparam: function () { return { contractMaterialID: $scope.ItemMaterial.ID } },
    //        model: {
    //            id: 'ID',
    //            fields: {
    ...
    //        Common.Services.Call($http, {
    //            url: Common.Services.url.VEN,
    //            method: _VENVendor_Contract.URL.Material_Save,
    ...
    //        Common.Services.Call($http, {
    //            url: Common.Services.url.VEN,
    //            method: _VENVendor_Contract.URL.Material_RoutingNotInSave,
    ...
    $scope.price_gridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.VEN,
            method: _VENVendor_Contract.URL.Price_List,
            readparam: function () {
                return {
                    contractID: $scope.ID
                }
        ...
        columns: [
            ...
            },
            {
                ...
                template: '<a href="/" ng-click="Price_Edit_Click($event,dataItem,price_win,price_win_vform)" class="k-button"><i class="fa fa-pencil"></i></a>' +
                    '<a href="/" ng-click="Price_Delete_Click($event,dataItem)" class="k-button" ng-show="Auth.ActDel"><i class="fa fa-trash"></i></a>' +
    ...
    //            ID: -1, ContractID: $scope.ID, CustomerID: _VENVendor_Contract.Const.CustomerID
    //        });
    //    } else {
    ...
    $scope.PriceLoadItem = function (id, win, vform) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.VEN,
            method: _VENVendor_Contract.URL.Price_Get,
            data: { priceID: id },
            success: function (res) {
                $rootScope.IsLoading = false;
                $scope.ItemPrice = res;
    ...
    $scope.Price_win_Submit_Click = function ($event, win) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.VEN,
            method: _VENVendor_Contract.URL.Price_Save,
    ...
    $scope.Price_Detail_Click = function ($event, item) {
        ...
        if ($scope.Item.TypeOfMode == 1) {
            $state.go('main.VENContract.PriceCO', {
                ID: item.ID, ContractID: $scope.ID, CustomerID: _VENVendor_Contract.Const.CustomerID
            });
        } else {
            $state.go('main.VENContract.PriceDI', {
                ID: item.ID, ContractID: $scope.ID, CustomerID: _VENVendor_Contract.Const.CustomerID
    ...
    $scope.Price_Delete_Click = function ($event, item) {
        ...
        $rootScope.Message({
            ...
            Ok: function () {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.VEN,
                    method: _VENVendor_Contract.URL.Price_Delete,
                    data: { ID: item.ID },
                    success: function (res) {
        ...
        if (!flag) {
            ...
            $rootScope.Message({
                ...
                Ok: function () {
                    ...
                    Common.Services.Call($http, {
                        url: Common.Services.url.VEN,
                        method: _VENVendor_Contract.URL.Price_Copy,
                        data: { data: data },
                        success: function (res) {
                            $rootScope.IsLoading = false;
                            Common.Services.Error(res, function (res) {
    ...
    $scope.Update_Click = function ($event, vform) {
        ...
        if (Common.HasValue($scope.Item.CustomerID) && $scope.Item.CustomerID > 0) {
            if (vform()) {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.VEN,
                    method: _VENVendor_Contract.URL.Save,
                    ...
                    success: function (res) {
                        ...
                        if (Common.HasValue($scope.CustomerID) && $scope.CustomerID > 0) {
                            $state.go('main.VENVendor.Contract', { ID: res, CustomerID: $scope.CustomerID }, { reload: true });
                        }
                        else {
                            $state.go('main.VENVendor.Contract', { ID: res, CustomerID: 0 }, { reload: true });
                        }
                    },
                    error: function () {
                        $rootScope.IsLoading = false;
            ...
            $rootScope.Message({ Msg: "Không tìm thấy nhà vận tải" });
    };
    ...
    $scope.Delete_Click = function ($event) {
        ...
        $rootScope.Message({
            ...
            Ok: function () {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.VEN,
                    method: _VENVendor_Contract.URL.Delete,
                    ...
                    success: function (res) {
                        Common.Services.Error(res, function (res) {
                            ...
                            $rootScope.Message({ Msg: "Đã xóa!" });
                            if (Common.HasValue($scope.CustomerID) && $scope.CustomerID > 0) {
                                $state.go('main.VENVendor.Detail', { id: $scope.CustomerID });
                            }
                            else {
    ...
    $scope.gop_gridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.VEN,
            method: _VENVendor_Contract.URL.GroupOfProduct_List,
            readparam: function () {
                return {
                    contractID: $scope.ID
                }
    ...
    $scope.GOP_Delete_Click = function ($event, dataItem, grid) {
        ...
        if (dataItem.ID > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.VEN,
                method: _VENVendor_Contract.URL.GroupOfProduct_Delete,
                data: { lstid: lstid },
                success: function (res) {
                    Common.Services.Error(res, function (res) {
                        grid.dataSource.read();
    ...
    $scope.GOP_LoadItem = function (win, id, vform) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.VEN,
            method: _VENVendor_Contract.URL.GroupOfProduct_Get,
            data: { id: id, contractID: $scope.ID },
            success: function (res) {
                if (Common.HasValue(res)) {
                    $timeout(function () {
                        $scope.GOPItem = res;
                        $scope.gop_cbo_ProductOptions.dataSource.data(_VENVendor_Contract.Data.ListProduct[$scope.GOPItem.GroupOfProductID]);
                    }, 1);
                }
            }
        });
    ...
    $scope.GOP_Save_Click = function ($event, win, grid, vform) {
        ...
        if (vform()) {
            if ($scope.GOPItem.ExpressionInput != "" && $scope.GOPItem.ExpressionInput != null) {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.VEN,
                    method: _VENVendor_Contract.URL.GroupOfProduct_Save,
    ...
    $scope.GOP_Check_Expression_Click = function ($event, win, grid, vform) {
        ...
        if (vform()) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.VEN,
                method: _VENVendor_Contract.URL.GroupOfProduct_Check,
    ...
    $scope.ContractGroupOfProduct_Excel_Online = function ($event, grid) {
        ...
        var lstMessageError = [];
        for (var i = 0; i < 30; i++) {
            var resource = $rootScope.RS[_VENVendor_Contract.ExcelKey.ResourceGroupOfProduct + '_' + i];
        ...
        $rootScope.excelShare.Init({
            functionkey: _VENVendor_Contract.ExcelKey.GroupOfProduct,
            params: { contractID: $scope.ID },
            rowStart: 2,
            colCheckChange: 15,
            url: Common.Services.url.VEN,
            methodInit: _VENVendor_Contract.URL.GroupOfProduct_ExcelInit,
            methodChange: _VENVendor_Contract.URL.GroupOfProduct_ExcelChange,
            methodImport: _VENVendor_Contract.URL.GroupOfProduct_ExcelImport,
            methodApprove: _VENVendor_Contract.URL.GroupOfProduct_ExcelApprove,
        ...
        if (data.length > 0) {
            $rootScope.Message({
                ...
                Ok: function () {
                    ...
                    Common.Services.Call($http, {
                        url: Common.Services.url.VEN,
                        method: _VENVendor_Contract.URL.Material_RoutingDelete,
                        data: { lst: data },
                        success: function (res) {
                            $rootScope.IsLoading = false;
                            $scope.material_routing_GridOptions.dataSource.read();
            ...
            if ($scope.Item.TypeOfRunLevelID != $scope.TypeOfRunIDBackup) {
                $rootScope.Message({
                    ...
                    Ok: function () {
                        ...
                        Common.Services.Call($http, {
                            url: Common.Services.url.VEN,
                            method: _VENVendor_Contract.URL.TypeOfRunLevelSave,
    ...
    $scope.TypeOfSGroupProduct_Click = function ($event, vform) {
        ...
        if (vform()) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.VEN,
                method: _VENVendor_Contract.URL.TypeOfSGroupProductChangeSave,
    ...
    $scope.gov_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.VEN,
            method: _VENVendor_Contract.URL.GOVList,
            readparam: function () { return { contractID: $scope.ID } },
            model: {
                id: 'ID',
                fields: {
    ...
    $scope.govEdit_Click = function ($event, win, data, vform) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.VEN,
            method: _VENVendor_Contract.URL.GOVGet,
            data: { id: data.ID },
            success: function (res) {
                $rootScope.IsLoading = false;
                $scope.ItemGOV = res;
    ...
    $scope.GOV_Save_Click = function ($event, win, vform) {
        ...
        if (vform()) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.VEN,
                method: _VENVendor_Contract.URL.GOVSave,
    ...
    $scope.GOV_Choose_DeleteClick = function ($event, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.VEN,
                method: _VENVendor_Contract.URL.GOVDeleteList,
    ...
    $scope.gov_NotIn_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.VEN,
            method: _VENVendor_Contract.URL.GOVNotInList,
            readparam: function () { return { contractID: $scope.ID } },
            model: {
                id: 'ID',
                fields: {
    ...
    $scope.gov_Save_Click = function ($event, win, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.VEN,
                method: _VENVendor_Contract.URL.GOVNotInSave,
    ...
    $scope.gov_level_win_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.VEN,
            method: _VENVendor_Contract.URL.LevelList,
            readparam: function () { return { contractID: $scope.ID } },
            model: {
                id: 'ID',
                fields: {
    ...
    $scope.gov_level_LoadItem = function (id, win, vform) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.VEN,
            method: _VENVendor_Contract.URL.LevelGet,
            data: { id: id },
            success: function (res) {
    ...
    $scope.gov_level_winDetail_SaveClick = function ($event, win, vform) {
        ...
        if (vform()) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.VEN,
                method: _VENVendor_Contract.URL.LevelSave,
    ...
    $scope.LoadCboGOV = function () {
        Common.Services.Call($http, {
            url: Common.Services.url.VEN,
            method: _VENVendor_Contract.URL.GOVListSetting,
            data: { contractID: $scope.ID },
            success: function (res) {
    ...
    $scope.gov_level_Choose_DeleteClick = function ($event, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.VEN,
                method: _VENVendor_Contract.URL.LevelDeleteList,
                data: { lst: datasend, contractID: $scope.ID },
                success: function (res) {
                    $rootScope.IsLoading = false;
                    $scope.gov_level_win_GridOptions.dataSource.read();
    ...
    $scope.term_gridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.VEN,
            method: _VENVendor_Contract.URL.Term_List,
            readparam: function () {
                return {
                    contractID: $scope.ID
                }
        ...
        if (Common.HasValue(data)) {
            $rootScope.Message({
                ...
                Ok: function () {
                    ...
                    Common.Services.Call($http, {
                        url: Common.Services.url.VEN,
                        method: _VENVendor_Contract.URL.Term_RemoveWarning,
                        data: { ID: data.ID },
                        success: function (res) {
                            $scope.term_gridOptions.dataSource.read();
                            $rootScope.IsLoading = false;
        ...
        if (Common.HasValue(data)) {
            $rootScope.Message({
                ...
                Ok: function () {
                    ...
                    Common.Services.Call($http, {
                        url: Common.Services.url.VEN,
                        method: _VENVendor_Contract.URL.Term_Lock,
                        data: { ID: data.ID },
                        success: function (res) {
                            $scope.term_gridOptions.dataSource.read();
                            $rootScope.IsLoading = false;
        ...
        if (Common.HasValue(data)) {
            $rootScope.Message({
                ...
                Ok: function () {
                    ...
                    Common.Services.Call($http, {
                        url: Common.Services.url.VEN,
                        method: _VENVendor_Contract.URL.Term_UnLock,
                        data: { ID: data.ID },
                        success: function (res) {
                            $scope.term_gridOptions.dataSource.read();
                            $rootScope.IsLoading = false;
    ...
    //        Common.Services.Call($http, {
    //            url: Common.Services.url.VEN,
    //            method: _VENVendor_Contract.URL.Term_Delete,
    //            data: { ID: data.ID },
    //            success: function (res) {
    //                $scope.term_gridOptions.dataSource.read();
    //                $rootScope.IsLoading = false;
                ...
                Ok: function () {
                    ...
                    Common.Services.Call($http, {
                        ...
                        success: function (res) {
                            ...
                            $rootScope.Message({ Msg: 'Thành công', NotifyType: Common.Message.NotifyType.SUCCESS });
                            if (Common.HasValue($scope.CustomerID) && $scope.CustomerID > 0) {
                                $state.go('main.VENVendor.Contract', { ID: $scope.ID, CustomerID: $scope.CustomerID }, { reload: true });
                            }
                            else {
                                $state.go('main.VENVendor.Contract', { ID: $scope.ID, CustomerID: 0 }, { reload: true });
                            }
                        },
                        error: function (res) {
                            $rootScope.IsLoading = false;
    ...
    $scope.Term_Add_Click = function myfunction($event) {
        ...
        $state.go('main.VENContract.Term', $scope.ParamEdit);
    }
    ...
    $scope.Term_Edit_Click = function myfunction($event, data) {
        ...
        $state.go('main.VENContract.Term', newParam);
    }
    ...
    $scope.Routing_ExcelOnline_Click = function ($event) {
        ...
        var lstMessageError = [];
        for (var i = 0; i < 15; i++) {
            var resource = $rootScope.RS[_VENVendor_Contract.ExcelKey.Resource + '_' + i];
            if (Common.HasValue(resource))
                lstMessageError.push(resource);
        }
        if (lstMessageError.length == 0) {
        ...
        $rootScope.excelShare.Init({
            functionkey: _VENVendor_Contract.ExcelKey.ContractRouting + $scope.ID,
            params: { contractID: $scope.ID, customerID: $scope.Item.CustomerID },
            rowStart: 1,
            colCheckChange: 15,
            url: Common.Services.url.VEN,
            methodInit: _VENVendor_Contract.URL.RoutingExcelOnline_Init,
            methodChange: _VENVendor_Contract.URL.RoutingExcelOnline_Change,
            methodImport: _VENVendor_Contract.URL.RoutingExcelOnline_Import,
            methodApprove: _VENVendor_Contract.URL.RoutingExcelOnline_Approve,
            lstMessageError: lstMessageError,
