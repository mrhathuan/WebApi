...
var VENContract_Price_DI_LoadTypeOfPartner = {
    URL: {
        Get: 'VENContract_Price_Get',
        Data: 'VENContract_Price_Data',


        Loading_List: 'VENPrice_DI_LoadPartner_List',
        Loading_Delete: 'VENPrice_DI_Load_Delete',
        Loading_SaveList: 'VENPrice_DI_LoadPartner_SaveList',
        Loading_DeleteList: 'VENPrice_DI_Load_DeleteList',
        Loading_Location_NotIn_List: 'VENPrice_DI_LoadPartner_PartnerNotIn_List',
        Loading_Location_NotIn_SaveList: 'VENPrice_DI_LoadPartner_PartnerNotIn_SaveList',

        Loading_Export: 'VENPrice_DI_LoadPartner_ExcelExport',
        Loading_Check: 'VENPrice_DI_LoadPartner_ExcelCheck',
        Loading_Import: 'VENPrice_DI_LoadPartner_Import',
...
angular.module('myapp').controller('VENContract_Price_DI_LoadTypeOfPartnerCtrl', ['$rootScope', '$scope', '$http', '$location', '$state', '$timeout', '$stateParams', function ($rootScope, $scope, $http, $location, $state, $timeout, $stateParams) {
    Common.Log('VENContract_Price_DI_LoadTypeOfPartnerCtrl');
    $rootScope.IsLoading = false;

    $scope.Item = null;
    VENContract_Price_DI_LoadTypeOfPartner.Params = $.extend({}, true, $state.params);
    ...
    Common.ALL.Get($http, {
        ...
        success: function (res) {
            VENContract_Price_DI_LoadTypeOfPartner.Data.ListPriceOfGOP = res;
        }
    })
    ...
    Common.Services.Call($http, {
        ...
        method: VENContract_Price_DI_LoadTypeOfPartner.URL.Data,
        data: { contractTermID: VENContract_Price_DI_LoadTypeOfPartner.Params.TermID },
        success: function (res) {
            VENContract_Price_DI_LoadTypeOfPartner.Data.ListGroupProduct = res.ListGroupOfProduct;

            Common.Services.Call($http, {
                url: Common.Services.url.VEN,
                method: VENContract_Price_DI_LoadTypeOfPartner.URL.Get,
                data: { priceID: VENContract_Price_DI_LoadTypeOfPartner.Params.PriceID },
                success: function (res) {
                    $scope.Item = res;
    ...
    $scope.Back_Click = function ($event) {
        ...
        $state.go("main.VENContract.PriceDI", VENContract_Price_DI_LoadTypeOfPartner.Params)
    }
    ...
    $scope.InitView_Loading = function () {
        ...
        for (var i = 0; i < VENContract_Price_DI_LoadTypeOfPartner.Data.ListGroupProduct.length; i++) {
            var item = VENContract_Price_DI_LoadTypeOfPartner.Data.ListGroupProduct[i];
                            ...
                            $('<input data-bind="value:' + options.field + '" />').appendTo(container)
                                .kendoComboBox({
                                    ...
                                    dataSource: Common.DataSource.Local({
                                        data: VENContract_Price_DI_LoadTypeOfPartner.Data.ListPriceOfGOP,
                                        model: {
                                            id: 'ID',
                                            fields: {
                                                ID: { type: 'number' },
    ...
    $scope.Loading_Delete_Click = function ($event, item, grid) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.VEN,
            method: VENContract_Price_DI_LoadTypeOfPartner.URL.Loading_Delete,
            data: { ID: item.ID },
            success: function (res) {
    ...
    $scope.Loading_DeleteAll_Click = function ($event, grid) {
        ...
        $rootScope.Message({
            ...
            Ok: function () {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.VEN,
                    method: VENContract_Price_DI_LoadTypeOfPartner.URL.Loading_DeleteList,
                    data: { data: data },
                    success: function (res) {
    ...
    $scope.Loading_Location_NotIn_Submit_Click = function ($event, grid, win) {
        ...
        if (data.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.VEN,
                method: VENContract_Price_DI_LoadTypeOfPartner.URL.Loading_Location_NotIn_SaveList,
    ...
    $scope.Loading_Update_Click = function ($event, grid) {
        ...
        for (var i = 0; i < dataSource.length; i++) {
            ...
            if (dataitem.dirty) {
                ...
                for (var j = 0; j < VENContract_Price_DI_LoadTypeOfPartner.Data.ListGroupProduct.length; j++) {
                    var product = VENContract_Price_DI_LoadTypeOfPartner.Data.ListGroupProduct[j];
        ...
        if (data.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.VEN,
                method: VENContract_Price_DI_LoadTypeOfPartner.URL.Loading_SaveList,
                data: { data: data },
                success: function (res) {
                    $scope.LoadData_Loading();
                    $rootScope.Message({ Msg: "Đã cập nhật!" });
    ...
    $scope.Loading_Excel_Click = function ($event, win) {
        ...
        $rootScope.UploadExcel({
            ...
            Download: function () {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.VEN,
                    method: VENContract_Price_DI_LoadTypeOfPartner.URL.Loading_Export,
                    data: { contractTermID: VENContract_Price_DI_LoadTypeOfPartner.Params.TermID, priceID: VENContract_Price_DI_LoadTypeOfPartner.Params.PriceID },
                    success: function (res) {
                        $rootScope.IsLoading = false;
            ...
            Upload: function (e, callback) {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.VEN,
                    method: VENContract_Price_DI_LoadTypeOfPartner.URL.Loading_Check,
                    data: { file: e, priceID: VENContract_Price_DI_LoadTypeOfPartner.Params.PriceID, contractTermID: VENContract_Price_DI_LoadTypeOfPartner.Params.TermID },
            ...
            Complete: function (e, data) {
                if (!$scope.Item.TermClosed) {
                    ...
                    if (o.length > 0) {
                        ...
                        Common.Services.Call($http, {
                            url: Common.Services.url.VEN,
                            method: VENContract_Price_DI_LoadTypeOfPartner.URL.Loading_Import,
                            data: { lst: o, priceID: VENContract_Price_DI_LoadTypeOfPartner.Params.PriceID },
                            success: function (res) {
                                $rootScope.Message({ Msg: "Đã cập nhật!" });
    ...
    $scope.LoadData_Loading = function () {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.VEN,
            method: VENContract_Price_DI_LoadTypeOfPartner.URL.Loading_List,
                ...
                Common.Services.Error(res, function (res) {
                    ...
                    for (var i = 0; i < res.length; i++) {
                        ...
                        for (var j = 0; j < VENContract_Price_DI_LoadTypeOfPartner.Data.ListGroupProduct.length; j++) {
                            ...
                            var gop = VENContract_Price_DI_LoadTypeOfPartner.Data.ListGroupProduct[j];
                            var field = "F_" + gop.ID
    ...
    $scope.loading_location_notin_gridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.VEN,
            method: VENContract_Price_DI_LoadTypeOfPartner.URL.Loading_Location_NotIn_List,
            readparam: function () {
                return {
