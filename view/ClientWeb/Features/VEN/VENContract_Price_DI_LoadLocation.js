...
var _VENContract_Price_DI_LoadLocation = {
    URL: {
        Get: 'VENContract_Price_Get',
        Data: 'VENContract_Price_Data',


        Loading_List: 'VENPrice_DI_LoadLocation_List',
        Loading_Delete: 'VENPrice_DI_Load_Delete',
        Loading_SaveList: 'VENPrice_DI_LoadLocation_SaveList',
        Loading_DeleteList: 'VENPrice_DI_Load_DeleteList',
        Loading_Location_NotIn_List: 'VENPrice_DI_LoadLocation_LocationNotIn_List',
        Loading_Location_NotIn_SaveList: 'VENPrice_DI_LoadLocation_LocationNotIn_SaveList',

        Loading_Export: 'VENPrice_DI_LoadLocation_ExcelExport',
        Loading_Check: 'VENPrice_DI_LoadLocation_ExcelCheck',
        Loading_Import: 'VENPrice_DI_LoadLocation_Import',
...
angular.module('myapp').controller('VENContract_Price_DI_LoadLocationCtrl', ['$rootScope', '$scope', '$http', '$location', '$state', '$timeout', '$stateParams', function ($rootScope, $scope, $http, $location, $state, $timeout, $stateParams) {
    Common.Log('VENContract_Price_DI_LoadLocationCtrl');
    $rootScope.IsLoading = false;

    $scope.Item = null;
    _VENContract_Price_DI_LoadLocation.Params = $.extend(true, _VENContract_Price_DI_LoadLocation.Params, $state.params);
    ...
    Common.ALL.Get($http, {
        ...
        success: function (res) {
            _VENContract_Price_DI_LoadLocation.Data.ListPriceOfGOP = res;
        }
    })
    ...
    $scope.Back_Click = function ($event) {
        ...
        $state.go("main.VENContract.PriceDI", _VENContract_Price_DI_LoadLocation.Params)
    }

    $rootScope.IsLoading = true;
    Common.Services.Call($http, {
        url: Common.Services.url.VEN,
        method: _VENContract_Price_DI_LoadLocation.URL.Data,
        data: { contractTermID: _VENContract_Price_DI_LoadLocation.Params.TermID },
        success: function (res) {
            _VENContract_Price_DI_LoadLocation.Data.ListGroupProduct = res.ListGroupOfProduct;

            Common.Services.Call($http, {
                url: Common.Services.url.VEN,
                method: _VENContract_Price_DI_LoadLocation.URL.Get,
                data: { priceID: _VENContract_Price_DI_LoadLocation.Params.PriceID },
                success: function (res) {
                    $scope.Item = res;
    ...
    $scope.InitView_Loading = function () {
        ...
        var columns = [
            {
                title: ' ', width: '50px',
                template: '<a href="/" ng-click="Loading_Delete_Click($event,dataItem,loading_grid)" ng-show="!Item.TermClosed" class="k-button"><i class="fa fa-trash"></i></a>',
        ...
        for (var i = 0; i < _VENContract_Price_DI_LoadLocation.Data.ListGroupProduct.length; i++) {
            var item = _VENContract_Price_DI_LoadLocation.Data.ListGroupProduct[i];
                            ...
                            $('<input data-bind="value:' + options.field + '" />').appendTo(container)
                                .kendoComboBox({
                                    ...
                                    dataSource: Common.DataSource.Local({
                                        data: _VENContract_Price_DI_LoadLocation.Data.ListPriceOfGOP,
                                        model: {
                                            id: 'ID',
                                            fields: {
                                                ID: { type: 'number' },
    ...
    $scope.Loading_Delete_Click = function ($event, item, grid) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.VEN,
            method: _VENContract_Price_DI_LoadLocation.URL.Loading_Delete,
            data: { ID: item.ID },
            success: function (res) {
    ...
    $scope.Loading_DeleteAll_Click = function ($event, grid) {
        ...
        $rootScope.Message({
            ...
            Ok: function () {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.VEN,
                    method: _VENContract_Price_DI_LoadLocation.URL.Loading_DeleteList,
                    data: { data: data },
                    success: function (res) {
    ...
    $scope.Loading_Location_NotIn_Submit_Click = function ($event, grid, win) {
        ...
        if (data.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.VEN,
                method: _VENContract_Price_DI_LoadLocation.URL.Loading_Location_NotIn_SaveList,
    ...
    $scope.Loading_Update_Click = function ($event, grid) {
        ...
        for (var i = 0; i < dataSource.length; i++) {
            ...
            if (dataitem.dirty) {
                ...
                for (var j = 0; j < _VENContract_Price_DI_LoadLocation.Data.ListGroupProduct.length; j++) {
                    var product = _VENContract_Price_DI_LoadLocation.Data.ListGroupProduct[j];
        ...
        if (data.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.VEN,
                method: _VENContract_Price_DI_LoadLocation.URL.Loading_SaveList,
                data: { data: data },
                success: function (res) {
                    $scope.LoadData_Loading();
                    $rootScope.Message({ Msg: "Đã cập nhật!" });
    ...
    $scope.Loading_Excel_Click = function ($event, win) {
        ...
        $rootScope.UploadExcel({
            ...
            Download: function () {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.VEN,
                    method: _VENContract_Price_DI_LoadLocation.URL.Loading_Export,
                    data: { priceID: _VENContract_Price_DI_LoadLocation.Params.PriceID, contractTermID: _VENContract_Price_DI_LoadLocation.Params.TermID, },
                    success: function (res) {
                        $rootScope.IsLoading = false;
            ...
            Upload: function (e, callback) {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.VEN,
                    method: _VENContract_Price_DI_LoadLocation.URL.Loading_Check,
                    data: { file: e, priceID: _VENContract_Price_DI_LoadLocation.Params.PriceID, contractTermID: _VENContract_Price_DI_LoadLocation.Params.TermID },
            ...
            Complete: function (e, data) {
                if (!$scope.Item.TermClosed) {
                    ...
                    if (o.length > 0) {
                        ...
                        Common.Services.Call($http, {
                            url: Common.Services.url.VEN,
                            method: _VENContract_Price_DI_LoadLocation.URL.Loading_Import,
                            data: { lst: o, priceID: _VENContract_Price_DI_LoadLocation.Params.PriceID },
                            success: function (res) {
                                $rootScope.Message({ Msg: "Đã cập nhật!" });
    ...
    $scope.LoadData_Loading = function () {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.VEN,
            method: _VENContract_Price_DI_LoadLocation.URL.Loading_List,
                ...
                Common.Services.Error(res, function (res) {
                    ...
                    for (var i = 0; i < res.length; i++) {
                        ...
                        for (var j = 0; j < _VENContract_Price_DI_LoadLocation.Data.ListGroupProduct.length; j++) {
                            ...
                            var gop = _VENContract_Price_DI_LoadLocation.Data.ListGroupProduct[j];
                            var field = "F_" + gop.ID
    ...
    $scope.loading_location_notin_gridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.VEN,
            method: _VENContract_Price_DI_LoadLocation.URL.Loading_Location_NotIn_List,
            readparam: function () {
                return {
        ...
        columns: [
            ...
            {
                field: 'GroupName', title: 'Loại', width: 120,
                filterable: { cell: { operator: 'contains', showOperators: false } }
            },
            {
