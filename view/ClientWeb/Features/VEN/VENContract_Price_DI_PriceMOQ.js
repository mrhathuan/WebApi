...
var _VENContract_Price_DI_PriceMOQ = {
    URL: {
        //#region price moq
        PriceMOQ_List: 'VENPrice_DI_PriceMOQ_List',
        PriceMOQ_Get: 'VENPrice_DI_PriceMOQ_Get',
        PriceMOQ_Save: 'VENPrice_DI_PriceMOQ_Save',
        PriceMOQ_Delete: 'VENPrice_DI_PriceMOQ_Delete',

        PriceMOQ_GroupLocation_List: 'VENPrice_DI_PriceMOQ_GroupLocation_List',
        PriceMOQ_GroupLocation_Delete: 'VENPrice_DI_PriceMOQ_GroupLocation_DeleteList',
        PriceMOQ_GroupLocation_Save: 'VENPrice_DI_PriceMOQ_GroupLocation_SaveList',
        PriceMOQ_GroupLocation_NotInList: 'VENPrice_DI_PriceMOQ_GroupLocation_GroupNotInList',

        PriceMOQ_GroupProduct_List: 'VENPrice_DI_PriceMOQ_GroupProduct_List',
        PriceMOQ_GroupProduct_Delete: 'VENPrice_DI_PriceMOQ_GroupProduct_DeleteList',
        PriceMOQ_GroupProduct_Save: 'VENPrice_DI_PriceMOQ_GroupProduct_Save',
        PriceMOQ_GroupProduct_Get: 'VENPrice_DI_PriceMOQ_GroupProduct_Get',
        PriceMOQ_GroupProduct_GOPList: 'VENPrice_DI_PriceMOQ_GroupProduct_GOPList',

        PriceMOQ_Location_List: 'VENPrice_DI_PriceMOQ_Location_List',
        PriceMOQ_Location_Delete: 'VENPrice_DI_PriceMOQ_Location_DeleteList',
        PriceMOQ_Location_Save: 'VENPrice_DI_PriceMOQ_Location_Save',
        PriceMOQ_Location_Get: 'VENPrice_DI_PriceMOQ_Location_Get',
        PriceMOQ_Location_NotInSave: 'VENPrice_DI_PriceMOQ_Location_LocationNotInSaveList',
        PriceMOQ_Location_NotInList: 'VENPrice_DI_PriceMOQ_Location_LocationNotInList',

        PriceMOQ_Route_List: 'VENPrice_DI_PriceMOQ_Route_List',
        PriceMOQ_Route_Delete: 'VENPrice_DI_PriceMOQ_Route_DeleteList',
        PriceMOQ_Route_Save: 'VENPrice_DI_PriceMOQ_Route_SaveList',
        PriceMOQ_Route_NotInList: 'VENPrice_DI_PriceMOQ_Route_RouteNotInList',

        PriceMOQ_ParentRoute_List: 'VENPrice_DI_PriceMOQ_ParentRoute_List',
        PriceMOQ_ParentRoute_Delete: 'VENPrice_DI_PriceMOQ_ParentRoute_DeleteList',
        PriceMOQ_ParentRoute_Save: 'VENPrice_DI_PriceMOQ_ParentRoute_SaveList',
        PriceMOQ_ParentRoute_NotInList: 'VENPrice_DI_PriceMOQ_ParentRoute_RouteNotInList',

        PriceMOQ_Parent_List: 'VENPrice_DI_PriceMOQ_Partner_List',
        PriceMOQ_Parent_Delete: 'VENPrice_DI_PriceMOQ_Partner_DeleteList',
        PriceMOQ_Parent_Save: 'VENPrice_DI_PriceMOQ_Partner_SaveList',
        PriceMOQ_Parent_NotInList: 'VENPrice_DI_PriceMOQ_Partner_PartnerNotInList',

        PriceMOQ_Province_List: 'VENPrice_DI_PriceMOQ_Province_List',
        PriceMOQ_Province_Delete: 'VENPrice_DI_PriceMOQ_Province_DeleteList',
        PriceMOQ_Province_Save: 'VENPrice_DI_PriceMOQ_Province_SaveList',
        PriceMOQ_Province_NotInList: 'VENPrice_DI_PriceMOQ_Province_NotInList',
        //#endregion
    },
    Data: {
    },
...
angular.module('myapp').controller('VENContract_Price_DI_PriceMOQCtrl', ['$rootScope', '$scope', '$http', '$location', '$state', '$timeout', '$stateParams', function ($rootScope, $scope, $http, $location, $state, $timeout, $stateParams) {
    Common.Log('VENContract_Price_DI_PriceMOQCtrl');
    $rootScope.IsLoading = false;

    _VENContract_Price_DI_PriceMOQ.Params = $.extend({}, true, $state.params);
    ...
    $scope.price_MOQ_grid_Options = {
        dataSource: Common.DataSource.Grid($http, {
            ...
            method: _VENContract_Price_DI_PriceMOQ.URL.PriceMOQ_List,
            readparam: function () { return { priceID: _VENContract_Price_DI_PriceMOQ.Params.PriceID } },
            model: {
                id: 'ID',
                fields: {
    ...
    $scope.PriceMOQLoadItem = function (id, win, vform) {
        Common.Services.Call($http, {
            url: Common.Services.url.VEN,
            method: _VENContract_Price_DI_PriceMOQ.URL.PriceMOQ_Get,
            data: { priceID: id },
    ...
    $scope.priceMOQ_GridDestroy_Click = function ($event, data) {
        ...
        $rootScope.Message({
            ...
            Ok: function () {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.VEN,
                    method: _VENContract_Price_DI_PriceMOQ.URL.PriceMOQ_Delete,
                    data: { id: data.ID },
                    success: function (res) {
                        $rootScope.IsLoading = false;
    ...
    $scope.Back_Click = function ($event) {
        ...
        $state.go("main.VENContract.PriceDI", _VENContract_Price_DI_PriceMOQ.Params)
    }
    ...
    $scope.priceMOQ_SaveInfo_Click = function ($event, vform) {
        ...
        if (vform()) {
            if ($scope.ItemPriceMOQ.DIMOQSumID > 0 && $scope.ItemPriceMOQ.TypeOfPriceDIExID > 0) {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.VEN,
                    method: _VENContract_Price_DI_PriceMOQ.URL.PriceMOQ_Save,
                    data: { priceID: _VENContract_Price_DI_PriceMOQ.Params.PriceID, item: $scope.ItemPriceMOQ },
                    success: function (res) {
                        Common.Services.Call($http, {
                            url: Common.Services.url.VEN,
                            method: _VENContract_Price_DI_PriceMOQ.URL.PriceMOQ_Get,
    ...
    $scope.priceMOQ_GroupLocation_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.VEN,
            method: _VENContract_Price_DI_PriceMOQ.URL.PriceMOQ_GroupLocation_List,
    ...
    $scope.priceMOQ_GroupLocation_Delete = function ($event, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.VEN,
                method: _VENContract_Price_DI_PriceMOQ.URL.PriceMOQ_GroupLocation_Delete,
                data: { lst: datasend },
                success: function (res) {
                    $rootScope.IsLoading = false;
                    $scope.priceMOQ_GroupLocation_GridOptions.dataSource.read();
    ...
    $scope.price_MOQ_GroupNotIn_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.VEN,
            method: _VENContract_Price_DI_PriceMOQ.URL.PriceMOQ_GroupLocation_NotInList,
            readparam: function () { return { priceMOQID: $scope.ItemPriceMOQ.ID } },
            model: {
                id: 'ID',
                fields: {
    ...
    $scope.price_MOQ_GroupNotIn_Save_Click = function ($event, win, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.VEN,
                method: _VENContract_Price_DI_PriceMOQ.URL.PriceMOQ_GroupLocation_Save,
    ...
    $scope.priceMOQ_Route_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.VEN,
            method: _VENContract_Price_DI_PriceMOQ.URL.PriceMOQ_Route_List,
            readparam: function () { return { priceMOQID: $scope.ItemPriceMOQ.ID } },
            model: {
                id: 'ID',
                fields: {
    ...
    $scope.price_MOQ_RouteNotIn_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.VEN,
            method: _VENContract_Price_DI_PriceMOQ.URL.PriceMOQ_Route_NotInList,
            readparam: function () { return { priceMOQID: $scope.ItemPriceMOQ.ID, contractTermID: _VENContract_Price_DI_PriceMOQ.Params.TermID } },
            model: {
                id: 'ID',
                fields: {
                    ID: { type: 'number', editable: false, nullable: true },
    ...
    $scope.price_MOQ_RouteNotIn_Save_Click = function ($event, win, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.VEN,
                method: _VENContract_Price_DI_PriceMOQ.URL.PriceMOQ_Route_Save,
                data: { priceMOQID: $scope.ItemPriceMOQ.ID, lst: datasend },
                success: function (res) {
                    $rootScope.IsLoading = false;
                    $scope.priceMOQ_Route_GridOptions.dataSource.read();
    ...
    $scope.priceMOQ_Route_Delete = function ($event, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.VEN,
                method: _VENContract_Price_DI_PriceMOQ.URL.PriceMOQ_Route_Delete,
                data: { lst: datasend },
                success: function (res) {
                    $rootScope.IsLoading = false;
                    $scope.priceMOQ_Route_GridOptions.dataSource.read();
    ...
    $scope.priceMOQ_GroupProduct_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.VEN,
            method: _VENContract_Price_DI_PriceMOQ.URL.PriceMOQ_GroupProduct_List,
            readparam: function () { return { priceMOQID: $scope.ItemPriceMOQ.ID } },
            model: {
                id: 'ID',
                fields: {
    ...
    $scope.MOQGOPLoadItem = function (id, win, vform) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.VEN,
            method: _VENContract_Price_DI_PriceMOQ.URL.PriceMOQ_GroupProduct_Get,
            data: { id: id, cusID: _VENContract_Price_DI_PriceMOQ.Params.CustomerID },
            success: function (res) {
                $rootScope.IsLoading = false;
    ...
    $scope.priceMOQ_GroupProduct_GridDestroy_Click = function ($event, data) {
        ...
        if (lst.length > 0) {
            Common.Services.Call($http, {
                url: Common.Services.url.VEN,
                method: _VENContract_Price_DI_PriceMOQ.URL.PriceMOQ_GroupProduct_Delete,
                data: { lst: lst },
                success: function (res) {
                    $rootScope.IsLoading = false;
                    $scope.priceMOQ_GroupProduct_GridOptions.dataSource.read();
    ...
    $scope.price_MOQ_GOP_Save_Click = function ($event, win, vform) {
        ...
        if (vform()) {
            if ($scope.ItemPriceMOQGOP.GroupOfProductID > 0) {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.VEN,
                    method: _VENContract_Price_DI_PriceMOQ.URL.PriceMOQ_GroupProduct_Save,
    ...
    Common.Services.Call($http, {
        url: Common.Services.url.VEN,
        method: _VENContract_Price_DI_PriceMOQ.URL.PriceMOQ_GroupProduct_GOPList,
        data: { cusID: _VENContract_Price_DI_PriceMOQ.Params.CustomerID },
        success: function (res) {
    ...
    $scope.priceMOQ_Location_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.VEN,
            method: _VENContract_Price_DI_PriceMOQ.URL.PriceMOQ_Location_List,
            readparam: function () { return { priceMOQID: $scope.ItemPriceMOQ.ID } },
            model: {
                id: 'ID',
                fields: {
    ...
    $scope.priceMOQ_Location_Delete = function ($event, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.VEN,
                method: _VENContract_Price_DI_PriceMOQ.URL.PriceMOQ_Location_Delete,
                data: { lst: datasend },
                success: function (res) {
                    $rootScope.IsLoading = false;
                    $scope.priceMOQ_Location_GridOptions.dataSource.read();
    ...
    $scope.price_MOQ_LocationNotIn_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.VEN,
            method: _VENContract_Price_DI_PriceMOQ.URL.PriceMOQ_Location_NotInList,
            readparam: function () { return { priceMOQID: $scope.ItemPriceMOQ.ID, customerID: _VENContract_Price_DI_PriceMOQ.Params.CustomerID } },
            model: {
                id: 'ID',
                fields: {
                    ID: { type: 'number', editable: false, nullable: true },
    ...
    $scope.price_MOQ_LocationNotIn_Save_Click = function ($event, win, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.VEN,
                method: _VENContract_Price_DI_PriceMOQ.URL.PriceMOQ_Location_NotInSave,
                data: { priceMOQID: $scope.ItemPriceMOQ.ID, lst: datasend },
                success: function (res) {
                    $rootScope.IsLoading = false;
                    $scope.priceMOQ_Location_GridOptions.dataSource.read();
    ...
    $scope.priceMOQ_Location_GridEdit_Click = function ($event, win, data) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.VEN,
            method: _VENContract_Price_DI_PriceMOQ.URL.PriceMOQ_Location_Get,
            data: { id: data.ID },
            success: function (res) {
                $rootScope.IsLoading = false;
    ...
    $scope.price_MOQ_Location_Save_Click = function ($event, win) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.VEN,
            method: _VENContract_Price_DI_PriceMOQ.URL.PriceMOQ_Location_Save,
    ...
    $scope.priceMOQ_ParentRoute_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.VEN,
            method: _VENContract_Price_DI_PriceMOQ.URL.PriceMOQ_ParentRoute_List,
            readparam: function () { return { priceMOQID: $scope.ItemPriceMOQ.ID } },
            model: {
                id: 'ID',
                fields: {
    ...
    $scope.price_MOQ_ParentRouteNotIn_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.VEN,
            method: _VENContract_Price_DI_PriceMOQ.URL.PriceMOQ_ParentRoute_NotInList,
            readparam: function () { return { priceMOQID: $scope.ItemPriceMOQ.ID, contractTermID: _VENContract_Price_DI_PriceMOQ.Params.TermID } },
            model: {
                id: 'ID',
                fields: {
    ...
    $scope.price_MOQ_ParentRouteNotIn_Save_Click = function ($event, win, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.VEN,
                method: _VENContract_Price_DI_PriceMOQ.URL.PriceMOQ_ParentRoute_Save,
                data: { priceMOQID: $scope.ItemPriceMOQ.ID, lst: datasend },
                success: function (res) {
                    $rootScope.IsLoading = false;
                    $scope.priceMOQ_ParentRoute_GridOptions.dataSource.read();
    ...
    $scope.priceMOQ_ParentRoute_Delete = function ($event, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.VEN,
                method: _VENContract_Price_DI_PriceMOQ.URL.PriceMOQ_ParentRoute_Delete,
                data: { lst: datasend },
                success: function (res) {
                    $rootScope.IsLoading = false;
                    $scope.priceMOQ_ParentRoute_GridOptions.dataSource.read();
    ...
    $scope.priceEx_Parent_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.VEN,
            method: _VENContract_Price_DI_PriceMOQ.URL.PriceMOQ_Parent_List,
    ...
    $scope.price_ex_ParentNotIn_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.VEN,
            method: _VENContract_Price_DI_PriceMOQ.URL.PriceMOQ_Parent_NotInList,
            readparam: function () { return { priceExID: $scope.ItemPriceMOQ.ID, contractTermID: _VENContract_Price_DI_PriceMOQ.Params.TermID, CustomerID: _VENContract_Price_DI_PriceMOQ.Params.CustomerID } },
            model: {
                id: 'ID',
                fields: {
                    ID: { type: 'number', editable: false, nullable: true },
    ...
    $scope.price_exParent_NotIn_Save_Click = function ($event, win, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.VEN,
                method: _VENContract_Price_DI_PriceMOQ.URL.PriceMOQ_Parent_Save,
    ...
    $scope.priceEx_Parent_Delete = function ($event, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.VEN,
                method: _VENContract_Price_DI_PriceMOQ.URL.PriceMOQ_Parent_Delete,
                data: { lst: datasend },
                success: function (res) {
                    $rootScope.IsLoading = false;
                    $scope.priceEx_Parent_GridOptions.dataSource.read();
    ...
    $scope.priceEx_Province_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.VEN,
            method: _VENContract_Price_DI_PriceMOQ.URL.PriceMOQ_Province_List,
            readparam: function () { return { priceExID: $scope.ItemPriceMOQ.ID } },
            model: {
                id: 'ID',
                fields: {
    ...
    $scope.price_ex_ProvinceNotIn_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.VEN,
            method: _VENContract_Price_DI_PriceMOQ.URL.PriceMOQ_Province_NotInList,
            readparam: function () { return { priceExID: $scope.ItemPriceMOQ.ID, contractTermID: _VENContract_Price_DI_PriceMOQ.Params.TermID, CustomerID: _VENContract_Price_DI_PriceMOQ.Params.CustomerID } },
            model: {
                id: 'ID',
                fields: {
    ...
    $scope.price_exProvince_NotIn_Save_Click = function ($event, win, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.VEN,
                method: _VENContract_Price_DI_PriceMOQ.URL.PriceMOQ_Province_Save,
                data: { priceExID: $scope.ItemPriceMOQ.ID, lst: datasend },
                success: function (res) {
                    $rootScope.IsLoading = false;
                    $scope.priceEx_Province_GridOptions.dataSource.read();
    ...
    $scope.priceEx_Province_Delete = function ($event, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.VEN,
                method: _VENContract_Price_DI_PriceMOQ.URL.PriceMOQ_Province_Delete,
                data: { lst: datasend },
                success: function (res) {
                    $rootScope.IsLoading = false;
                    $scope.priceEx_Province_GridOptions.dataSource.read();
