...
var _VENContract_Price_CO_Ex = {
    URL: {
        //#region price ex
        PriceEx_Get: 'VENPrice_CO_Ex_Get',
        PriceEx_Save: 'VENPrice_CO_Ex_Save',

        PriceEx_Location_List: 'VENPrice_CO_Ex_Location_List',
        PriceEx_Location_Delete: 'VENPrice_CO_Ex_Location_DeleteList',
        PriceEx_Location_Save: 'VENPrice_CO_Ex_Location_Save',
        PriceEx_Location_Get: 'VENPrice_CO_Ex_Location_Get',
        PriceEx_Location_NotInSave: 'VENPrice_CO_Ex_Location_LocationNotInSaveList',
        PriceEx_Location_NotInList: 'VENPrice_CO_Ex_Location_LocationNotInList',

        PriceEx_Route_List: 'VENPrice_CO_Ex_Route_List',
        PriceEx_Route_Delete: 'VENPrice_CO_Ex_Route_DeleteList',
        PriceEx_Route_Save: 'VENPrice_CO_Ex_Route_SaveList',
        PriceEx_Route_NotInList: 'VENPrice_CO_Ex_Route_RouteNotInList',

        PriceEx_ParentRoute_List: 'VENPrice_CO_Ex_ParentRoute_List',
        PriceEx_ParentRoute_Delete: 'VENPrice_CO_Ex_ParentRoute_DeleteList',
        PriceEx_ParentRoute_Save: 'VENPrice_CO_Ex_ParentRoute_SaveList',
        PriceEx_ParentRoute_NotInList: 'VENPrice_CO_Ex_ParentRoute_RouteNotInList',

        PriceEx_Parent_List: 'VENPrice_CO_Ex_Partner_List',
        PriceEx_Parent_Delete: 'VENPrice_CO_Ex_Partner_DeleteList',
        PriceEx_Parent_Save: 'VENPrice_CO_Ex_Partner_SaveList',
        PriceEx_Parent_NotInList: 'VENPrice_CO_Ex_Partner_PartnerNotInList',
        //#endregion
    },
    Data: {
    },
...
angular.module('myapp').controller('VENContract_Price_CO_ExCtrl', ['$rootScope', '$scope', '$http', '$location', '$state', '$timeout', '$stateParams', function ($rootScope, $scope, $http, $location, $state, $timeout, $stateParams) {
    Common.Log('VENContract_Price_CO_ExCtrl');
    $rootScope.IsLoading = false;

    _VENContract_Price_CO_Ex.Params = $.extend({}, true, $state.params);
    ...
    Common.Services.Call($http, {
        ...
        method: _VENContract_Price_CO_Ex.URL.PriceEx_Get,
        data: { id: _VENContract_Price_CO_Ex.Params.PriceIDEx },
    ...
    $scope.priceEX_SaveInfo_Click = function ($event, vform) {
        ...
        if (vform()) {
            if ($scope.ItemPriceEx.TypeOfPriceCOExID > 0 && $scope.ItemPriceEx.COExSumID > 0) {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.VEN,
                    method: _VENContract_Price_CO_Ex.URL.PriceEx_Save,
                    data: { priceID: _VENContract_Price_CO_Ex.Params.PriceID, item: $scope.ItemPriceEx },
                    success: function (res) {
                        Common.Services.Call($http, {
                            url: Common.Services.url.VEN,
                            method: _VENContract_Price_CO_Ex.URL.PriceEx_Get,
    ...
    $scope.priceEx_Route_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.VEN,
            method: _VENContract_Price_CO_Ex.URL.PriceEx_Route_List,
    ...
    $scope.price_ex_RouteNotIn_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.VEN,
            method: _VENContract_Price_CO_Ex.URL.PriceEx_Route_NotInList,
            readparam: function () { return { priceExID: $scope.ItemPriceEx.ID, contractTermID: _VENContract_Price_CO_Ex.Params.TermID } },
            model: {
                id: 'ID',
                fields: {
                    ID: { type: 'number', editable: false, nullable: true },
    ...
    $scope.price_ex_RouteNotIn_Save_Click = function ($event, win, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.VEN,
                method: _VENContract_Price_CO_Ex.URL.PriceEx_Route_Save,
    ...
    $scope.priceEx_Route_Delete = function ($event, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.VEN,
                method: _VENContract_Price_CO_Ex.URL.PriceEx_Route_Delete,
                data: { lst: datasend },
                success: function (res) {
                    $rootScope.IsLoading = false;
                    $scope.priceEx_Route_GridOptions.dataSource.read();
    ...
    $scope.priceEx_Location_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.VEN,
            method: _VENContract_Price_CO_Ex.URL.PriceEx_Location_List,
            readparam: function () { return { priceExID: $scope.ItemPriceEx.ID } },
            model: {
                id: 'ID',
                fields: {
    ...
    $scope.priceEx_Location_Delete = function ($event, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.VEN,
                method: _VENContract_Price_CO_Ex.URL.PriceEx_Location_Delete,
                data: { lst: datasend },
                success: function (res) {
                    $rootScope.IsLoading = false;
                    $scope.priceEx_Location_GridOptions.dataSource.read();
    ...
    $scope.price_ex_LocationNotIn_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.VEN,
            method: _VENContract_Price_CO_Ex.URL.PriceEx_Location_NotInList,
            readparam: function () { return { priceExID: $scope.ItemPriceEx.ID, customerID: _VENContract_Price_CO_Ex.Params.CustomerID } },
            model: {
                id: 'ID',
                fields: {
                    ID: { type: 'number', editable: false, nullable: true },
    ...
    $scope.price_ex_LocationNotIn_Save_Click = function ($event, win, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.VEN,
                method: _VENContract_Price_CO_Ex.URL.PriceEx_Location_NotInSave,
                data: { priceExID: $scope.ItemPriceEx.ID, lst: datasend },
                success: function (res) {
                    $rootScope.IsLoading = false;
                    $scope.priceEx_Location_GridOptions.dataSource.read();
    ...
    $scope.priceEx_Location_GridEdit_Click = function ($event, win, data) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.VEN,
            method: _VENContract_Price_CO_Ex.URL.PriceEx_Location_Get,
            data: { id: data.ID },
            success: function (res) {
                $rootScope.IsLoading = false;
    ...
    $scope.price_ex_Location_Save_Click = function ($event, win) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.VEN,
            method: _VENContract_Price_CO_Ex.URL.PriceEx_Location_Save,
    ...
    $scope.priceEx_ParentRoute_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.VEN,
            method: _VENContract_Price_CO_Ex.URL.PriceEx_ParentRoute_List,
            readparam: function () { return { priceExID: $scope.ItemPriceEx.ID } },
            model: {
                id: 'ID',
                fields: {
    ...
    $scope.price_ex_ParentRouteNotIn_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.VEN,
            method: _VENContract_Price_CO_Ex.URL.PriceEx_ParentRoute_NotInList,
            readparam: function () { return { priceExID: $scope.ItemPriceEx.ID, contractTermID: _VENContract_Price_CO_Ex.Params.TermID } },
            model: {
                id: 'ID',
                fields: {
    ...
    $scope.price_exParent_RouteNotIn_Save_Click = function ($event, win, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.VEN,
                method: _VENContract_Price_CO_Ex.URL.PriceEx_ParentRoute_Save,
                data: { priceExID: $scope.ItemPriceEx.ID, lst: datasend },
                success: function (res) {
                    $rootScope.IsLoading = false;
                    $scope.priceEx_ParentRoute_GridOptions.dataSource.read();
    ...
    $scope.priceEx_ParentRoute_Delete = function ($event, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.VEN,
                method: _VENContract_Price_CO_Ex.URL.PriceEx_ParentRoute_Delete,
                data: { lst: datasend },
                success: function (res) {
                    $rootScope.IsLoading = false;
                    $scope.priceEx_ParentRoute_GridOptions.dataSource.read();
    ...
    $scope.priceEx_Parent_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.VEN,
            method: _VENContract_Price_CO_Ex.URL.PriceEx_Parent_List,
            readparam: function () { return { priceExID: $scope.ItemPriceEx.ID } },
            model: {
                id: 'ID',
                fields: {
    ...
    $scope.price_ex_ParentNotIn_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.VEN,
            method: _VENContract_Price_CO_Ex.URL.PriceEx_Parent_NotInList,
            readparam: function () { return { priceExID: $scope.ItemPriceEx.ID, contractTermID: _VENContract_Price_CO_Ex.Params.TermID, CustomerID: _VENContract_Price_CO_Ex.Params.CustomerID } },
            model: {
                id: 'ID',
                fields: {
                    ID: { type: 'number', editable: false, nullable: true },
    ...
    $scope.price_exParent_NotIn_Save_Click = function ($event, win, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.VEN,
                method: _VENContract_Price_CO_Ex.URL.PriceEx_Parent_Save,
                data: { priceExID: $scope.ItemPriceEx.ID, lst: datasend },
                success: function (res) {
                    $rootScope.IsLoading = false;
                    $scope.priceEx_Parent_GridOptions.dataSource.read();
    ...
    $scope.priceEx_Parent_Delete = function ($event, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.VEN,
                method: _VENContract_Price_CO_Ex.URL.PriceEx_Parent_Delete,
                data: { lst: datasend },
                success: function (res) {
                    $rootScope.IsLoading = false;
                    $scope.priceEx_Parent_GridOptions.dataSource.read();
    ...
    $scope.Back_Click = function ($event) {
        ...
        $state.go("main.VENContract.PriceCO", _VENContract_Price_CO_Ex.Params)
    }
