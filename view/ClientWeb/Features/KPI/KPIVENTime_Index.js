...
//#region URL
var _KPIVENTime_Index = {
    URL: {
        Time_List: 'KPIVENTime_List',
        Time_Save: 'KPIVENTime_Save',
        Time_Excel: 'KPIVENTime_Excel',
        Time_Generate: 'KPIVENTime_Generate',
        Time_Reason_List: 'KPITimeReason_List',

        KPI_List: 'KPIKPI_List',
        Reason_List: 'KPIReason_List',
        Reason_Save: 'KPIReason_Save',
        Reason_Delete: 'KPIReason_Delete',
        Reason_Export: 'KPIReason_Export',
        Reason_Import: 'KPIReason_Import',
        Reason_Check: 'KPIReason_Check',

        DashBoard_DN: 'Dashboard_DN_VENData',
        DashBoard_Reason: 'Dashboard_Reason_VENData',
...
angular.module('myapp').controller('KPIVENTime_IndexCtrl', ['$rootScope', '$scope', '$http', '$location', '$state', '$timeout', '$stateParams', function ($rootScope, $scope, $http, $location, $state, $timeout, $stateParams) {
    if ($rootScope.IsPageComplete != true) return;
    Common.Log('KPIVENTime_IndexCtrl');
    ...
    $scope.DashBoardDN_Item = {
        ...
        VendorID: -1, KPIID: -1, CustomerName: 'Tất cả vendor', KPIName: '', IsRadialGauge: false
    };

    $scope.DashBoardReason_Item = {
        KPIID: -1, VendorID: -1, CustomerName: 'Tất cả vendor', KPIName: '',
        StrFrom: Common.Date.ToString(new Date().addDays(-3), Common.Date.Format.DMY),
        StrTo: Common.Date.ToString(new Date().addDays(3), Common.Date.Format.DMY),
    ...
    $scope.OnDashBoardDN_CusChange = function ($event) {
        ...
        var obj = cbo.dataItem(cbo.select());
        if (Common.HasValue(obj)) {
            $scope.DashBoardDN_Item.VendorName = obj.CustomerName;
        }
    }
    ...
    $scope.OnDashBoardReason_CusChange = function ($event) {
        ...
        var obj = cbo.dataItem(cbo.select());
        if (Common.HasValue(obj)) {
            $scope.DashBoardReason_Item.VendorName = obj.CustomerName;
        }
    }
            ...
            $timeout(function () {
                ...
                switch (obj.ID) {
                    ...
                    case 1:
                        ...
                        data = _KPIVENTime_Index.Data.DashBoard_Reason_1;
                        break;
                    case 2:
                        options = {
                            series: [{
                        ...
                        data = _KPIVENTime_Index.Data.DashBoard_Reason_100;
                        break;
                    case 3:
                        options = {
                            series: [{
    ...
    $scope.DashBoard_DN_Setting_OK = function ($event) {
        ...
        Common.Services.Call($http, {
            ...
            method: _KPIVENTime_Index.URL.DashBoard_DN,
            data: {
                venID: $scope.DashBoardDN_Item.CustomerID, kpiID: $scope.DashBoardDN_Item.KPIID,
    ...
    $scope.DashBoard_Reason_Setting_OK = function ($event) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.KPI,
            method: _KPIVENTime_Index.URL.DashBoard_Reason,
            data: {
                venID: $scope.DashBoardReason_Item.CustomerID, kpiID: $scope.DashBoardReason_Item.KPIID,
            ...
            success: function (res) {
                ...
                _KPIVENTime_Index.Data.DashBoard_Reason_1 = data_1;
                _KPIVENTime_Index.Data.DashBoard_Reason_100 = data_100;
                $timeout(function () {
    ...
    Common.Services.Call($http, {
        url: Common.Services.url.KPI,
        method: _KPIVENTime_Index.URL.Vendor_List,
        success: function (res) {
            var data = [{ ID: -1, CustomerName: "Tất cả đối tác" }];
    ...
    $scope.kpi_gridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.KPI,
            method: _KPIVENTime_Index.URL.Time_List,
            readparam: function () {
                return {
        ...
        columns: [
            ...
            {
                field: 'VendorName', title: 'Đối tác', width: '100px',
                filterable: { cell: { operator: 'contains', showOperators: false } }
            },
            {
            ...
            {
                field: 'DateData', title: '<b>Ngày y/c ĐH</b><br>[DateData]', width: '120px', template: '#=Common.Date.FromJsonDMYHM(DateData)#',
            ...
            {
                field: 'DateDN', title: '<b>Ngày DN</b><br>[DateDN]', width: '120px', template: '#=Common.Date.FromJsonDMYHM(DateDN)#',
                filterable: { cell: { template: function (e) { e.element.kendoDatePicker({ format: Common.Date.Format.DMY }); }, operator: 'equal', showOperators: false } },
            },
            {
                field: 'DateFromCome', title: '<b>Đến kho</b><br>[DateFromCome]', width: '120px', template: '#=Common.Date.FromJsonDMYHM(DateFromCome)#',
                filterable: { cell: { template: function (e) { e.element.kendoDatePicker({ format: Common.Date.Format.DMY }); }, operator: 'equal', showOperators: false } },
            },
            {
                field: 'DateFromLeave', title: '<b>Rời kho</b><br>[DateFromLeave]', width: '120px', template: '#=Common.Date.FromJsonDMYHM(DateFromLeave)#',
                filterable: { cell: { template: function (e) { e.element.kendoDatePicker({ format: Common.Date.Format.DMY }); }, operator: 'equal', showOperators: false } },
            },
            {
                field: 'DateFromLoadStart', title: '<b>TG vào máng</b><br>[DateFromLoadStart]', width: '130px', template: '#=Common.Date.FromJsonDMYHM(DateFromLoadStart)#',
                filterable: { cell: { template: function (e) { e.element.kendoDatePicker({ format: Common.Date.Format.DMY }); }, operator: 'equal', showOperators: false } },
            },
            {
                field: 'DateFromLoadEnd', title: '<b>TG ra máng</b><br>[DateFromLoadEnd]', width: '130px', template: '#=Common.Date.FromJsonDMYHM(DateFromLoadEnd)#',
                filterable: { cell: { template: function (e) { e.element.kendoDatePicker({ format: Common.Date.Format.DMY }); }, operator: 'equal', showOperators: false } },
            },
            {
                field: 'DateToCome', title: '<b>TG đến NPP</b><br>[DateToCome]', width: '120px', template: '#=Common.Date.FromJsonDMYHM(DateToCome)#',
                filterable: { cell: { template: function (e) { e.element.kendoDatePicker({ format: Common.Date.Format.DMY }); }, operator: 'equal', showOperators: false } },
            },
            {
                field: 'DateToLeave', title: '<b>TG rời NPP</b><br>[DateToLeave]', width: '120px', template: '#=Common.Date.FromJsonDMYHM(DateToLeave)#',
                filterable: { cell: { template: function (e) { e.element.kendoDatePicker({ format: Common.Date.Format.DMY }); }, operator: 'equal', showOperators: false } },
            },
            {
                field: 'DateToLoadStart', title: '<b>TG BĐ dỡ hàng</b><br>[DateToLoadStart]', width: '130px', template: '#=Common.Date.FromJsonDMYHM(DateToCome)#',
                filterable: { cell: { template: function (e) { e.element.kendoDatePicker({ format: Common.Date.Format.DMY }); }, operator: 'equal', showOperators: false } },
            },
            {
                field: 'DateToLoadEnd', title: '<b>TG KT dỡ hàng</b><br>[DateToLoadEnd]', width: '130px', template: '#=Common.Date.FromJsonDMYHM(DateToLeave)#',
                filterable: { cell: { template: function (e) { e.element.kendoDatePicker({ format: Common.Date.Format.DMY }); }, operator: 'equal', showOperators: false } },
            },
            {
                field: 'DateInvoice', title: '<b>Ngày hóa đơn</b><br>[DateInvoice]', width: '120px', template: '#=Common.Date.FromJsonDMYHM(DateInvoice)#',
                filterable: { cell: { template: function (e) { e.element.kendoDatePicker({ format: Common.Date.Format.DMY }); }, operator: 'equal', showOperators: false } },
            },
            {
    ...
    $scope.Generate_Click = function ($event) {
        ...
        $rootScope.Message({
            ...
            Ok: function (pars) {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.KPI,
                    method: _KPIVENTime_Index.URL.Time_Generate,
                    data: pars,
                    success: function (res) {
                        $rootScope.IsLoading = false;
    ...
    $scope.LoadData_Reason = function () {
        Common.Services.Call($http, {
            url: Common.Services.url.KPI,
            method: _KPIVENTime_Index.URL.Time_Reason_List,
    ...
    $scope.Time_Reason_Submit_Click = function ($event, win) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.KPI,
            method: _KPIVENTime_Index.URL.Time_Save,
    ...
    $scope.KPI_Excel_Click = function ($event) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.KPI,
            method: _KPIVENTime_Index.URL.Time_Excel,
            data: {
                venID: $scope.ViewItem.VenID, kpiID: $scope.ViewItem.KPIID,
                from: $scope.ViewItem.DateFrom, to: $scope.ViewItem.DateTo
            },
    ...
    Common.Services.Call($http, {
        url: Common.Services.url.KPI,
        method: _KPIVENTime_Index.URL.KPI_List,
        success: function (res) {
            _KPIVENTime_Index.Data.KPI = res;
            Common.Data.Each(res, function (o) {
                if (_KPIVENTime_Index.Item.Reason.KPIID < 1)
                    _KPIVENTime_Index.Item.Reason.KPIID = o.ID;
            ...
            $timeout(function () {
                $scope.cboReasonKPI_Options.dataSource.data(_KPIVENTime_Index.Data.KPI);
                $scope.cboTime_KPIOptions.dataSource.data(_KPIVENTime_Index.Data.KPI);
                $scope.cboDashBoard_KPIOptions.dataSource.data(_KPIVENTime_Index.Data.KPI);
    ...
    $scope.reason_gridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.KPI,
            method: _KPIVENTime_Index.URL.Reason_List,
            model: {
                id: 'ID',
                fields: {
                    ID: { type: 'number' }
        ...
        height: '99%', pageable: true, sortable: true, columnMenu: false, resizable: true, reorderable: true, filterable: { mode: 'row' },
        toolbar: kendo.template($('#reason_grid_toolbar').html()),
        columns: [
            {
                title: ' ', width: '85px',
                template: '<a href="/" ng-click="Reason_Edit_Click($event,dataItem,reason_win)" class="k-button"><i class="fa fa-pencil"></i></a>' +
                    '<a href="/" ng-click="Reason_Delete_Click($event,dataItem,reason_grid)" class="k-button"><i class="fa fa-trash"></i></a>',
                filterable: false, sortable: false
            },
            { field: 'Code', title: 'Mã', width: '200px', filterable: { cell: { operator: 'contains', showOperators: false } } },
            { field: 'ReasonName', title: 'Tên lý do', filterable: { cell: { operator: 'contains', showOperators: false } } },
            { field: 'KPIName', title: 'KPI', width: '250px', filterable: { cell: { operator: 'contains', showOperators: false } } }
        ]
    };

    $scope.Reason_Add_Click = function ($event, grid, win) {
        $event.preventDefault();

        $scope.ReasonItem = $.extend({}, true, _KPIVENTime_Index.Item.Reason);
        win.center().open();
    }

    $scope.Reason_Edit_Click = function ($event, item, win) {
        $event.preventDefault();

        $scope.ReasonItem = $.extend({}, true, item);
        win.center().open();
    }

    $scope.Reason_Delete_Click = function ($event, item, grid) {
        $event.preventDefault();

        Common.Services.Call($http, {
            url: Common.Services.url.KPI,
            method: _KPIVENTime_Index.URL.Reason_Delete,
            data: { id: item.ID },
            success: function (res) {
    ...
    $scope.Reason_Submit_Click = function ($event, grid, win, vform) {
        $event.preventDefault();
        if (vform()) {
            Common.Services.Call($http, {
                url: Common.Services.url.KPI,
                method: _KPIVENTime_Index.URL.Reason_Save,
                data: { item: $scope.ReasonItem },
                success: function (res) {
                    Common.Services.Error(res, function (res) {
                        $rootScope.Message({ Msg: "Đã cập nhật!" });
                        grid.dataSource.read();
    ...
    $scope.Reason_Excel_Click = function ($event, win) {
        $event.preventDefault();

        $rootScope.UploadExcel({
            Path: Common.FolderUpload.Import,
            columns: [
                { field: 'Code', width: 150, title: 'Mã', filterable: { cell: { showOperators: false, operator: "contains" } } },
                { field: 'ReasonName', width: 350, title: 'Tên lý do', filterable: { cell: { showOperators: false, operator: "contains" } } },
                { field: 'KPIName', width: 250, title: 'KPI', filterable: { cell: { showOperators: false, operator: "contains" } } }
            ],
            Download: function () {
                Common.Services.Call($http, {
                    url: Common.Services.url.KPI,
                    method: _KPIVENTime_Index.URL.Reason_Export,
                    success: function (res) {
                        $rootScope.DownloadFile(res);
                    }
                })
            ...
            Upload: function (e, callback) {
                Common.Services.Call($http, {
                    url: Common.Services.url.KPI,
                    method: _KPIVENTime_Index.URL.Reason_Check,
            ...
            Complete: function (e, data) {
                Common.Services.Call($http, {
                    url: Common.Services.url.KPI,
                    method: _KPIVENTime_Index.URL.Reason_Import,
                    data: { data: data },
                    success: function (res) {
                        $rootScope.Message({ Msg: "Đã cập nhật!" });
