...
var _KPITime_Index = {
    URL: {
        Time_List: 'KPITime_List',
        Time_Save: 'KPITime_Save',
        Time_Excel: 'KPITime_Excel',
        Time_Generate: 'KPITime_Generate',
...
angular.module('myapp').controller('KPITime_IndexCtrl', ['$rootScope', '$scope', '$http', '$location', '$state', '$timeout', '$stateParams', function ($rootScope, $scope, $http, $location, $state, $timeout, $stateParams) {
            ...
            $timeout(function () {
                ...
                switch (obj.ID) {
                    ...
                    case 1:
                        ...
                        data = _KPITime_Index.Data.DashBoard_Reason_1;
                        break;
                    case 2:
                        options = {
                            series: [{
                        ...
                        data = _KPITime_Index.Data.DashBoard_Reason_100;
                        break;
                    case 3:
                        options = {
                            series: [{
    ...
    $scope.DashBoard_DN_Setting_OK = function ($event) {
        ...
        Common.Services.Call($http, {
            ...
            method: _KPITime_Index.URL.DashBoard_DN,
            data: {
    ...
    $scope.DashBoard_Reason_Setting_OK = function ($event) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.KPI,
            method: _KPITime_Index.URL.DashBoard_Reason,
            data: {
            ...
            success: function (res) {
                ...
                _KPITime_Index.Data.DashBoard_Reason_1 = data_1;
                _KPITime_Index.Data.DashBoard_Reason_100 = data_100;
                $timeout(function () {
    ...
    Common.Services.Call($http, {
        url: Common.Services.url.KPI,
        method: _KPITime_Index.URL.Customer_List,
        success: function (res) {
    ...
    $scope.kpi_gridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.KPI,
            method: _KPITime_Index.URL.Time_List,
            readparam: function () {
                return {
    ...
    $scope.Generate_Click = function ($event) {
        ...
        $rootScope.Message({
            ...
            Ok: function (pars) {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.KPI,
                    method: _KPITime_Index.URL.Time_Generate,
                    data: pars,
                    success: function (res) {
                        $rootScope.IsLoading = false;
    ...
    $scope.LoadData_Reason = function () {
        Common.Services.Call($http, {
            url: Common.Services.url.KPI,
            method: _KPITime_Index.URL.Time_Reason_List,
    ...
    $scope.Time_Reason_Submit_Click = function ($event, win) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.KPI,
            method: _KPITime_Index.URL.Time_Save,
    ...
    $scope.KPI_Excel_Click = function ($event) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.KPI,
            method: _KPITime_Index.URL.Time_Excel,
            data: {
                cusID: $scope.ViewItem.CusID, kpiID: $scope.ViewItem.KPIID,
                from: $scope.ViewItem.DateFrom, to: $scope.ViewItem.DateTo
            },
    ...
    Common.Services.Call($http, {
        ...
        success: function (res) {
            ...
            $timeout(function () {
                $scope.cboReasonKPI_Options.dataSource.data(_KPITime_Index.Data.KPI);
    ...
    $scope.reason_gridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.KPI,
            method: _KPITime_Index.URL.Reason_List,
            model: {
                id: 'ID',
                fields: {
                    ID: { type: 'number' }
    ...
    $scope.Reason_Add_Click = function ($event, grid, win) {
        ...
        $scope.ReasonItem = $.extend({}, true, _KPITime_Index.Item.Reason);
        win.center().open();
    }
    ...
    $scope.Reason_Delete_Click = function ($event, item, grid) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.KPI,
            method: _KPITime_Index.URL.Reason_Delete,
            data: { id: item.ID },
            success: function (res) {
    ...
    $scope.Reason_Submit_Click = function ($event, grid, win, vform) {
        ...
        if (vform()) {
            Common.Services.Call($http, {
                url: Common.Services.url.KPI,
                method: _KPITime_Index.URL.Reason_Save,
    ...
    $scope.Reason_Excel_Click = function ($event, win) {
        ...
        $rootScope.UploadExcel({
            ...
            Download: function () {
                Common.Services.Call($http, {
                    url: Common.Services.url.KPI,
                    method: _KPITime_Index.URL.Reason_Export,
                    success: function (res) {
                        $rootScope.DownloadFile(res);
                    }
                })
            ...
            Upload: function (e, callback) {
                Common.Services.Call($http, {
                    url: Common.Services.url.KPI,
                    method: _KPITime_Index.URL.Reason_Check,
            ...
            Complete: function (e, data) {
                Common.Services.Call($http, {
                    url: Common.Services.url.KPI,
                    method: _KPITime_Index.URL.Reason_Import,
                    data: { data: data },
                    success: function (res) {
                        $rootScope.Message({ Msg: "Đã cập nhật!" });
