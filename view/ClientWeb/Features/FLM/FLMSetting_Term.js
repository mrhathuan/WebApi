...
var _FLMSetting_Term = {
    URL: {
        Get: 'FLMContract_ContractTerm_Get',
        Save: 'FLMContract_ContractTerm_Save',
        Delete: 'FLMContract_ContractTerm_Delete',
        Price_List: 'FLMContract_ContractTerm_Price_List',

        Get_Material: 'MaterialAll_List',

        Price_Copy: 'FLMContract_Price_Copy',
        Price_Delete: 'FLMContract_Price_Delete',
        Price_Get: 'FLMContract_Price_Get',
        Price_Save: 'FLMContract_Price_Save',

        TermKPITime_List: 'FLMContract_ContractTerm_KPITime_List',
        TermKPITime_Save: 'FLMContract_ContractTerm_KPITime_SaveExpr',
        TermKPITime_NoTInList: 'FLMContract_ContractTerm_KPITime_NotInList',
        TermKPITime_SaveNoiInList: 'FLMContract_ContractTerm_KPITime_SaveNotInList',
        KPI_Check_Expression: 'FLMContract_KPITime_Check_Expression',
        KPI_Check_KPI: 'FLMContract_KPITime_Check_Hit',
        KPIQuantity_Check_Expression: 'FLMContract_KPIQuantity_Check_Expression',
        KPIQuantity_Check_KPI: 'FLMContract_KPIQuantity_Check_Hit',

        TermKPIQuantity_List: 'FLMContract_ContractTerm_KPIQuantity_List',
        TermKPIQuantity_Save: 'FLMContract_ContractTerm_KPIQuantity_SaveExpr',
        TermKPIQuantity_NoTInList: 'FLMContract_ContractTerm_KPIQuantity_NotInList',
        TermKPIQuantity_SaveNoiInList: 'FLMContract_ContractTerm_KPIQuantity_SaveNotInList',
        FLMContract_KPIQuantity_Get: 'FLMContract_KPIQuantity_Get',
    },
    Param: {
        ContractID: -1,
        TermID: -1,
...
angular.module('myapp').controller('FLMSetting_TermCtrl', ['$rootScope', '$scope', '$http', '$location', '$state', '$timeout', '$stateParams', function ($rootScope, $scope, $http, $location, $state, $timeout, $stateParams) {
    Common.Log('FLMSetting_TermCtrl');
    $rootScope.IsLoading = false;

    _FLMSetting_Term.Param = $.extend(true, _FLMSetting_Term.Param, $state.params);
    $scope.TabIndex = 0;
    ...
    Common.Services.Call($http, {
        ...
        method: _FLMSetting_Term.URL.Get,
        data: { id: _FLMSetting_Term.Param.TermID, contractID: _FLMSetting_Term.Param.ContractID },
    ...
    $scope.Update_Click = function ($event, vform) {
        ...
        if (vform()) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.FLM,
                method: _FLMSetting_Term.URL.Save,
                data: { item: $scope.Item, contractID: _FLMSetting_Term.Param.ContractID },
                success: function (res) {
                    debugger
                    $rootScope.IsLoading = false;
                    $rootScope.Message({ Msg: "Đã cập nhật!" });
                    $state.go('main.FLMSetting.Term', { TermID: res, ContractID: _FLMSetting_Term.Param.ContractID });
                }
            });
        }
    };
    ...
    $scope.Delete_Click = function ($event) {
        ...
        $rootScope.Message({
            ...
            Ok: function () {
                Common.Services.Call($http, {
                    url: Common.Services.url.FLM,
                    method: _FLMSetting_Term.URL.Delete,
                    data: { ID: $scope.Item.ID },
                    success: function (res) {
                        Common.Services.Error(res, function (res) {
                            $rootScope.Message({ Msg: "Đã xóa!" });
                            $state.go('main.FLMSetting.Detail', { ID: _FLMSetting_Term.Param.ContractID, CustomerID: 0 });
                        })
                    }
                });
            }
    ...
    Common.Services.Call($http, {
        url: Common.Services.url.FLM,
        method: _FLMSetting_Term.URL.Get_Material,
        success: function (res) {
            ...
            _FLMSetting_Term.Data.Material = data;
        }
    });
    ...
    $scope.price_gridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.FLM,
            method: _FLMSetting_Term.URL.Price_List,
            readparam: function () {
                return {
                    contractTermID: _FLMSetting_Term.Param.TermID
                }
            },
            model: {
                id: 'ID',
    ...
    $scope.Price_Detail_Click = function ($event, item) {
        ...
        if (item.TypeOfMode == 1) {
            ...
            $scope.getLinkDetail(item.ID);
        }
    }

    $scope.getLinkDetail = function (ID) {
        Common.Services.Call($http, {
            url: Common.Services.url.FLM,
            method: _FLMSetting_Term.URL.Price_Get,
            data: { priceID: ID },
            success: function (res) {
                if (res.CheckPrice.HasNormal && !res.IsAllRouting) {
                    $state.go("main.FLMSetting.PriceDINormal", { PriceID: ID, TermID: res.ContractTermID })
                }
                else {
                    if (res.CheckPrice.HasLevel && !res.IsAllRouting) {
                        $state.go("main.FLMSetting.PriceDILevel", { PriceID: ID, TermID: res.ContractTermID })
                    }
                    else {
                        $state.go('main.FLMSetting.PriceDI', {
                            PriceID: ID,
                            TermID: _FLMSetting_Term.Param.TermID
                        });
                    }
                }
    ...
    $scope.getLinkCODetail = function (ID) {
        Common.Services.Call($http, {
            ...
            success: function (res) {
                if (res.CheckPrice.HasNormal && !res.IsAllRouting) {
                    $state.go("main.FLMSetting.PriceCONormal", { PriceID: ID, TermID: res.ContractTermID })
                }
                else {
                    $state.go('main.FLMSetting.PriceCO', {
                        PriceID: ID,
                        TermID: _FLMSetting_Term.Param.TermID
                    });
                }
    ...
    $scope.Price_Delete_Click = function ($event, item) {
        ...
        $rootScope.Message({
            ...
            Ok: function () {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.FLM,
                    method: _FLMSetting_Term.URL.Price_Delete,
                    data: { ID: item.ID },
                    success: function (res) {
                        Common.Services.Call($http, {
                            url: Common.Services.url.FLM,
        ...
        if (!flag) {
            ...
            $rootScope.Message({
                ...
                Ok: function () {
                    ...
                    Common.Services.Call($http, {
                        url: Common.Services.url.FLM,
                        method: _FLMSetting_Term.URL.Price_Copy,
                        data: { data: data },
                        success: function (res) {
                            $rootScope.IsLoading = false;
                            Common.Services.Error(res, function (res) {
    ...
    $scope.Price_win_Submit_Click = function ($event, win) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.FLM,
            method: _FLMSetting_Term.URL.Price_Save,
            data: { contractTermID: _FLMSetting_Term.Param.TermID, item: $scope.ItemPrice },
            success: function (res) {
                Common.Services.Call($http, {
                    url: Common.Services.url.FLM,
                    method: _FLMSetting_Term.URL.Get,
    ...
    $scope.kpi_gridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.FLM,
            method: _FLMSetting_Term.URL.TermKPITime_List,
            readparam: function () { return { contractTermID: _FLMSetting_Term.Param.TermID } },
            model: {
                id: 'ID',
                fields: {
    ...
    $scope.KpiNotInList_gridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.FLM,
            method: _FLMSetting_Term.URL.TermKPITime_NoTInList,
            readparam: function () { return { contractTermID: _FLMSetting_Term.Param.TermID } },
            model: {
                id: 'ID',
                fields: {
    ...
    $scope.KPITime_NotInList_Save_Click = function ($event, grid, win) {
        ...
        if (Common.HasValue(lst)) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.FLM,
                method: _FLMSetting_Term.URL.TermKPITime_SaveNoiInList,
                data: { lst: lst, contractTermID: _FLMSetting_Term.Param.TermID },
                success: function (res) {
    ...
    $scope.KPI_Check_Expression_Click = function ($event) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.FLM,
            method: _FLMSetting_Term.URL.KPI_Check_Expression,
            data: {
    ...
    $scope.KPI_Check_KPI_Click = function ($event) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.FLM,
            method: _FLMSetting_Term.URL.KPI_Check_KPI,
            data: {
                item: $scope.KPIItemCheck,
                lst: data
            },
    ...
    $scope.KPI_Save_Click = function ($event, grid, win) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.FLM,
            method: _FLMSetting_Term.URL.TermKPITime_Save,
            data: { item: $scope.KPIItemCheck, contractTermID: _FLMSetting_Term.Param.TermID },
            success: function (res) {
    ...
    $scope.kpiQuantity_gridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.FLM,
            method: _FLMSetting_Term.URL.TermKPIQuantity_List,
            readparam: function () { return { contractTermID: _FLMSetting_Term.Param.TermID } },
            model: {
                id: 'ID',
                fields: {
    ...
    $scope.KpiQuantityNotInList_gridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.FLM,
            method: _FLMSetting_Term.URL.TermKPIQuantity_NoTInList,
            readparam: function () { return { contractTermID: _FLMSetting_Term.Param.TermID } },
            model: {
                id: 'ID',
                fields: {
    ...
    $scope.KPIQuantity_Check_Click = function ($event, item, win) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.FLM,
            method: _FLMSetting_Term.URL.FLMContract_KPIQuantity_Get,
            data: { id: item.ID },
            success: function (res) {
                $scope.dataexpr = res;
                var data = [];
    ...
    $scope.KPIQuantity_NotInList_Save_Click = function ($event, grid, win) {
        ...
        if (Common.HasValue(lst)) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.FLM,
                method: _FLMSetting_Term.URL.TermKPIQuantity_SaveNoiInList,
                data: { lst: lst, contractTermID: _FLMSetting_Term.Param.TermID },
                success: function (res) {
    ...
    $scope.KPIQuantity_Check_Expression_Click = function ($event) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.FLM,
            method: _FLMSetting_Term.URL.KPIQuantity_Check_Expression,
            data: {
    ...
    $scope.KPIQuantity_Check_KPI_Click = function ($event) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.FLM,
            method: _FLMSetting_Term.URL.KPIQuantity_Check_KPI,
            data: {
                item: $scope.KPIQuantityCheck,
                lst: $scope.dataexpr,
            },
    ...
    $scope.KPIQuantity_Save_Click = function ($event, grid, win) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.FLM,
            method: _FLMSetting_Term.URL.TermKPIQuantity_Save,
            data: { item: $scope.KPIQuantityCheck, contractTermID: _FLMSetting_Term.Param.TermID },
            success: function (res) {
                grid.dataSource.read();
                win.close();
                $rootScope.IsLoading = false;
