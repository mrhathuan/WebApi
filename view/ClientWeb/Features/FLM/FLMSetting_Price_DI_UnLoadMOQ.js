...
var _FLMContract_Price_DI_UnLoadMOQ = {
    URL: {
        Price_Get: 'FLMContract_Price_Get',
        Price_Data: 'FLMContract_Price_Data',

        List: 'FLMPrice_DI_PriceMOQUnLoad_List',
        Get: 'FLMPrice_DI_PriceMOQUnLoad_Get',
        Delete: 'FLMPrice_DI_PriceMOQUnLoad_Delete',
        Save: 'FLMPrice_DI_PriceMOQUnLoad_Save',

        GroupLocation_List: 'FLMPrice_DI_PriceMOQLoad_GroupLocation_List',
        GroupLocation_Delete: 'FLMPrice_DI_PriceMOQLoad_GroupLocation_DeleteList',
        GroupLocation_Save: 'FLMPrice_DI_PriceMOQLoad_GroupLocation_SaveList',
        GroupLocation_GrouNotInList: 'FLMPrice_DI_PriceMOQLoad_GroupLocation_GroupNotInList',

        GroupProduct_List: 'FLMPrice_DI_PriceMOQLoad_GroupProduct_List',
        GroupProduct_Delete: 'FLMPrice_DI_PriceMOQLoad_GroupProduct_DeleteList',
        GroupProduct_Save: 'FLMPrice_DI_PriceMOQLoad_GroupProduct_Save',
        GroupProduct_Get: 'FLMPrice_DI_PriceMOQLoad_GroupProduct_Get',
        GroupProduct_GOPList: 'FLMPrice_DI_PriceMOQLoad_GroupProduct_GOPList',

        Location_List: 'FLMPrice_DI_PriceMOQLoad_Location_List',
        Location_Delete: 'FLMPrice_DI_PriceMOQLoad_Location_DeleteList',
        Location_Save: 'FLMPrice_DI_PriceMOQLoad_Location_LocationNotInSaveList',
        Location_NotInList: 'FLMPrice_DI_PriceMOQLoad_Location_LocationNotInList',
        LoadMOQ_Location_Save: 'FLMPrice_DI_PriceMOQLoad_Location_Save',
        LoadMOQ_Location_Get: 'FLMPrice_DI_PriceMOQLoad_Location_Get',

        Route_List: 'FLMPrice_DI_PriceMOQLoad_Route_List',
        Route_Delete: 'FLMPrice_DI_PriceMOQLoad_Route_DeleteList',
        Route_Save: 'FLMPrice_DI_PriceMOQLoad_Route_SaveList',
        Route_GrouNotInList: 'FLMPrice_DI_PriceMOQLoad_Route_RouteNotInList',

        ParentRoute_List: 'FLMPrice_DI_PriceMOQLoad_ParentRoute_List',
        ParentRoute_Delete: 'FLMPrice_DI_PriceMOQLoad_ParentRoute_DeleteList',
        ParentRoute_Save: 'FLMPrice_DI_PriceMOQLoad_ParentRoute_SaveList',
        ParentRoute_GrouNotInList: 'FLMPrice_DI_PriceMOQLoad_ParentRoute_RouteNotInList',
...
angular.module('myapp').controller('FLMSetting_Price_DI_UnLoadMOQCtrl', ['$rootScope', '$scope', '$http', '$location', '$state', '$timeout', '$stateParams', function ($rootScope, $scope, $http, $location, $state, $timeout, $stateParams) {
    Common.Log('FLMSetting_Price_DI_UnLoadMOQCtrl');
    $rootScope.IsLoading = false;

    $scope.Item = { ID: 0 };
    $scope.TabIndex = 0;

    _FLMContract_Price_DI_UnLoadMOQ.Params = $.extend({}, true, $state.params);
    ...
    //    method: _FLMContract_Price_DI_UnLoadMOQ.URL.Get,
    //    data: { priceID: _FLMContract_Price_DI_UnLoadMOQ.Params.ID },
    ...
    $scope.unload_MOQ_grid_Options = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.FLM,
            method: _FLMContract_Price_DI_UnLoadMOQ.URL.List,
            readparam: function () { return { priceID: _FLMContract_Price_DI_UnLoadMOQ.Params.PriceID } },
            model: {
                id: 'ID',
                fields: {
    ...
    $scope.unloadMOQ_GridDestroy_Click = function ($event, data) {
        ...
        $rootScope.Message({
            ...
            Ok: function () {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.FLM,
                    method: _FLMContract_Price_DI_UnLoadMOQ.URL.Delete,
                    data: { id: data.ID },
                    success: function (res) {
                        $rootScope.IsLoading = false;
    ...
    $scope.Back_Click = function ($event) {
        ...
        $state.go("main.FLMSetting.PriceDI", _FLMContract_Price_DI_UnLoadMOQ.Params)
    }
    ...
    $scope.unloadMOQ_SaveInfo_Click = function ($event, vform) {
        ...
        if (vform()) {
            if ($scope.Item.DIMOQLoadSumID > 0) {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.FLM,
                    method: _FLMContract_Price_DI_UnLoadMOQ.URL.Save,
                    data: { priceID: _FLMContract_Price_DI_UnLoadMOQ.Params.PriceID, item: $scope.Item },
                    success: function (res) {
                        Common.Services.Call($http, {
                            url: Common.Services.url.FLM,
                            method: _FLMContract_Price_DI_UnLoadMOQ.URL.Get,
    ...
    $scope.unloadMOQ_GroupLocation_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.FLM,
            method: _FLMContract_Price_DI_UnLoadMOQ.URL.GroupLocation_List,
    ...
    $scope.unloadMOQ_GroupLocation_Delete = function ($event, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.FLM,
                method: _FLMContract_Price_DI_UnLoadMOQ.URL.GroupLocation_Delete,
                data: { lst: datasend },
                success: function (res) {
                    $rootScope.IsLoading = false;
                    $scope.unloadMOQ_GroupLocation_GridOptions.dataSource.read();
    ...
    $scope.unloadMOQ_GroupNotIn_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.FLM,
            method: _FLMContract_Price_DI_UnLoadMOQ.URL.GroupLocation_GrouNotInList,
            readparam: function () { return { PriceMOQLoadID: $scope.Item.ID } },
            model: {
                id: 'ID',
                fields: {
    ...
    $scope.unloadMOQ_GroupNotIn_Save_Click = function ($event, win, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.FLM,
                method: _FLMContract_Price_DI_UnLoadMOQ.URL.GroupLocation_Save,
    ...
    $scope.unloadMOQ_GroupProduct_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.FLM,
            method: _FLMContract_Price_DI_UnLoadMOQ.URL.GroupProduct_List,
            readparam: function () { return { PriceMOQLoadID: $scope.Item.ID } },
            model: {
                id: 'ID',
                fields: {
    ...
    $scope.GOPLoadItem = function (id, win, vform) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.FLM,
            method: _FLMContract_Price_DI_UnLoadMOQ.URL.GroupProduct_Get,
            data: { id: id, cusID: _FLMContract_Price_DI_UnLoadMOQ.Params.CustomerID },
            success: function (res) {
                $rootScope.IsLoading = false;
                $scope.ItemGOP = res;
                win.center().open();
    ...
    $scope.unloadMOQ_GroupProduct_GridDestroy_Click = function ($event, data) {
        ...
        if (lst.length > 0) {
            Common.Services.Call($http, {
                url: Common.Services.url.FLM,
                method: _FLMContract_Price_DI_UnLoadMOQ.URL.GroupProduct_Delete,
                data: { lst: lst },
                success: function (res) {
                    $rootScope.IsLoading = false;
                    $scope.unloadMOQ_GroupProduct_GridOptions.dataSource.read();
    ...
    $scope.unloadMOQ_GOP_Save_Click = function ($event, win, vform) {
        ...
        if (vform()) {
            if ($scope.ItemGOP.GroupOfProductID > 0) {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.FLM,
                    method: _FLMContract_Price_DI_UnLoadMOQ.URL.GroupProduct_Save,
    ...
    Common.Services.Call($http, {
        url: Common.Services.url.FLM,
        method: _FLMContract_Price_DI_UnLoadMOQ.URL.GroupProduct_GOPList,
        data: { cusID: _FLMContract_Price_DI_UnLoadMOQ.Params.CustomerID },
        success: function (res) {
    ...
    $scope.unloadMOQ_Location_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.FLM,
            method: _FLMContract_Price_DI_UnLoadMOQ.URL.Location_List,
            readparam: function () { return { PriceMOQLoadID: $scope.Item.ID } },
            model: {
                id: 'ID',
                fields: {
    ...
    $scope.unloadMOQ_Location_Delete = function ($event, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.FLM,
                method: _FLMContract_Price_DI_UnLoadMOQ.URL.Location_Delete,
                data: { lst: datasend },
                success: function (res) {
                    $rootScope.IsLoading = false;
                    $scope.unloadMOQ_Location_GridOptions.dataSource.read();
    ...
    $scope.unloadMOQ_LocationNotIn_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.FLM,
            method: _FLMContract_Price_DI_UnLoadMOQ.URL.Location_NotInList,
            readparam: function () { return { PriceMOQLoadID: $scope.Item.ID, customerID: _FLMContract_Price_DI_UnLoadMOQ.Params.CustomerID } },
            model: {
                id: 'ID',
                fields: {
                    ID: { type: 'number', editable: false, nullable: true },
    ...
    $scope.unloadMOQ_LocationNotIn_Save_Click = function ($event, win, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.FLM,
                method: _FLMContract_Price_DI_UnLoadMOQ.URL.Location_Save,
                data: { PriceMOQLoadID: $scope.Item.ID, lst: datasend },
                success: function (res) {
                    $rootScope.IsLoading = false;
                    $scope.unloadMOQ_Location_GridOptions.dataSource.read();
    ...
    $scope.Location_GridEdit_Click = function ($event, win, data) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.FLM,
            method: _FLMContract_Price_DI_UnLoadMOQ.URL.LoadMOQ_Location_Get,
            data: { id: data.ID },
            success: function (res) {
                $rootScope.IsLoading = false;
    ...
    $scope.Location_Save_Click = function ($event, win) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.FLM,
            method: _FLMContract_Price_DI_UnLoadMOQ.URL.LoadMOQ_Location_Save,
    ...
    $scope.unloadMOQ_Route_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.FLM,
            method: _FLMContract_Price_DI_UnLoadMOQ.URL.Route_List,
            readparam: function () { return { PriceMOQLoadID: $scope.Item.ID } },
            model: {
                id: 'ID',
                fields: {
    ...
    $scope.unloadMOQ_RouteNotIn_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.FLM,
            method: _FLMContract_Price_DI_UnLoadMOQ.URL.Route_GrouNotInList,
            readparam: function () { return { PriceMOQLoadID: $scope.Item.ID, contractTermID: _FLMContract_Price_DI_UnLoadMOQ.Params.TermID } },
            model: {
                id: 'ID',
                fields: {
                    ID: { type: 'number', editable: false, nullable: true },
    ...
    $scope.unloadMOQ_RouteNotIn_Save_Click = function ($event, win, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.FLM,
                method: _FLMContract_Price_DI_UnLoadMOQ.URL.Route_Save,
                data: { PriceMOQLoadID: $scope.Item.ID, lst: datasend },
                success: function (res) {
                    $rootScope.IsLoading = false;
                    $scope.unloadMOQ_Route_GridOptions.dataSource.read();
    ...
    $scope.unloadMOQ_Route_Delete = function ($event, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.FLM,
                method: _FLMContract_Price_DI_UnLoadMOQ.URL.Route_Delete,
                data: { lst: datasend },
                success: function (res) {
                    $rootScope.IsLoading = false;
                    $scope.unloadMOQ_Route_GridOptions.dataSource.read();
    ...
    $scope.unloadMOQ_ParentRoute_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.FLM,
            method: _FLMContract_Price_DI_UnLoadMOQ.URL.ParentRoute_List,
            readparam: function () { return { PriceMOQLoadID: $scope.Item.ID } },
            model: {
                id: 'ID',
                fields: {
    ...
    $scope.unloadMOQ_ParentRouteNotIn_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.FLM,
            method: _FLMContract_Price_DI_UnLoadMOQ.URL.ParentRoute_GrouNotInList,
            readparam: function () { return { PriceMOQLoadID: $scope.Item.ID, contractTermID: _FLMContract_Price_DI_UnLoadMOQ.Params.TermID } },
            model: {
                id: 'ID',
                fields: {
    ...
    $scope.unloadMOQ_ParentRouteNotIn_Save_Click = function ($event, win, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.FLM,
                method: _FLMContract_Price_DI_UnLoadMOQ.URL.ParentRoute_Save,
                data: { PriceMOQLoadID: $scope.Item.ID, lst: datasend },
                success: function (res) {
                    $rootScope.IsLoading = false;
                    $scope.unloadMOQ_ParentRoute_GridOptions.dataSource.read();
    ...
    $scope.priceEx_Province_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.FLM,
            method: _FLMContract_Price_DI_UnLoadMOQ.URL.PriceMOQ_Province_List,
    ...
    $scope.price_ex_ProvinceNotIn_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.FLM,
            method: _FLMContract_Price_DI_UnLoadMOQ.URL.PriceMOQ_Province_NotInList,
            readparam: function () { return { PriceDIMOQLoadID: $scope.Item.ID, contractTermID: _FLMContract_Price_DI_UnLoadMOQ.Params.TermID, CustomerID: _FLMContract_Price_DI_UnLoadMOQ.Params.CustomerID } },
            model: {
                id: 'ID',
                fields: {
                    ID: { type: 'number', editable: false, nullable: true },
    ...
    $scope.price_exProvince_NotIn_Save_Click = function ($event, win, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.FLM,
                method: _FLMContract_Price_DI_UnLoadMOQ.URL.PriceMOQ_Province_Save,
    ...
    $scope.priceEx_Province_Delete = function ($event, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.FLM,
                method: _FLMContract_Price_DI_UnLoadMOQ.URL.PriceMOQ_Province_Delete,
                data: { lst: datasend },
                success: function (res) {
                    $rootScope.IsLoading = false;
                    $scope.priceEx_Province_GridOptions.dataSource.read();
