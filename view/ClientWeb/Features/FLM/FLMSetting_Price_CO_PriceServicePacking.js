...
var _FLMSetting_Price_CO_PriceServicePacking = {
    URL: {
        Read: 'FLMPrice_CO_ServicePacking_List',
        Get: 'FLMPrice_CO_ServicePacking_Get',
        Save: 'FLMPrice_CO_Service_Save',
        Delete: 'FLMPrice_CO_Service_Delete',

        ListCurrency: 'CATCurrency_AllList',
        ListService: 'FLMPrice_CO_CATServicePacking_List',
        cbo_Packing_List: 'FLMPrice_CO_CATCODefault_List',
    },
    Data: {
    },
    Params: {
...
angular.module('myapp').controller('FLMSetting_Price_CO_PriceServicePackingCtrl', ['$rootScope', '$scope', '$http', '$location', '$state', '$timeout', '$stateParams', function ($rootScope, $scope, $http, $location, $state, $timeout, $stateParams) {
    Common.Log('FLMSetting_Price_CO_PriceServicePackingCtrl');
    $rootScope.IsLoading = false;
    $scope.Item = null;
    _FLMSetting_Price_CO_PriceServicePacking.Params = $.extend(true, _FLMSetting_Price_CO_PriceServicePacking.Params, $state.params);

    $scope.Service_gridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.FLM,
            method: _FLMSetting_Price_CO_PriceServicePacking.URL.Read,
            readparam: function () {
                return {
                    priceID: _FLMSetting_Price_CO_PriceServicePacking.Params.PriceID,
                }
            },
            model: {
                id: 'ID',
    ...
    $scope.ServiceLoadItem = function (id, win, vform) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.FLM,
            method: _FLMSetting_Price_CO_PriceServicePacking.URL.Get,
            data: { id: id },
    ...
    $scope.Destroy_Click = function ($event, item) {
        ...
        $rootScope.Message({
            ...
            Ok: function () {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.FLM,
                    method: _FLMSetting_Price_CO_PriceServicePacking.URL.Delete,
                    data: { ID: item.ID },
                    success: function (res) {
    ...
    $scope.Service_Save_Click = function ($event, win, vform) {
        ...
        if (vform()) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.FLM,
                method: _FLMSetting_Price_CO_PriceServicePacking.URL.Save,
                data: { item: $scope.Item, priceID: _FLMSetting_Price_CO_PriceServicePacking.Params.PriceID },
                success: function (res) {
                    $scope.Service_gridOptions.dataSource.read();
                    $rootScope.IsLoading = false;
    ...
    Common.Services.Call($http, {
        url: Common.Services.url.FLM,
        method: _FLMSetting_Price_CO_PriceServicePacking.URL.ListService,
    ...
    Common.Services.Call($http, {
        url: Common.Services.url.FLM,
        method: _FLMSetting_Price_CO_PriceServicePacking.URL.cbo_Packing_List,
        data: { contractTermID: _FLMSetting_Price_CO_PriceServicePacking.Params.TermID },
        success: function (res) {
    ...
    Common.Services.Call($http, {
        ...
        method: _FLMSetting_Price_CO_PriceServicePacking.URL.ListCurrency,
    ...
    $scope.Back_Click = function ($event) {
        $event.preventDefault();
        $state.go("main.FLMSetting.PriceCO", _FLMSetting_Price_CO_PriceServicePacking.Params)
    }
}]);