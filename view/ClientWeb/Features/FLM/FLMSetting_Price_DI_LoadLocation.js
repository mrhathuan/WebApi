...
var _FLMSetting_Price_DI_LoadLocation = {
    URL: {
        Get: 'FLMContract_Price_Get',
        Data: 'FLMContract_Price_Data',


        Loading_List: 'FLMPrice_DI_LoadLocation_List',
        Loading_Delete: 'FLMPrice_DI_Load_Delete',
        Loading_SaveList: 'FLMPrice_DI_LoadLocation_SaveList',
        Loading_DeleteList: 'FLMPrice_DI_Load_DeleteList',
        Loading_Location_NotIn_List: 'FLMPrice_DI_LoadLocation_LocationNotIn_List',
        Loading_Location_NotIn_SaveList: 'FLMPrice_DI_LoadLocation_LocationNotIn_SaveList',

        Loading_Export: 'FLMPrice_DI_LoadLocation_ExcelExport',
        Loading_Check: 'FLMPrice_DI_LoadLocation_ExcelCheck',
        Loading_Import: 'FLMPrice_DI_LoadLocation_Import',
...
angular.module('myapp').controller('FLMSetting_Price_DI_LoadLocationCtrl', ['$rootScope', '$scope', '$http', '$location', '$state', '$timeout', '$stateParams', function ($rootScope, $scope, $http, $location, $state, $timeout, $stateParams) {
    Common.Log('FLMSetting_Price_DI_LoadLocationCtrl');
    $rootScope.IsLoading = false;

    $scope.Item = null;
    _FLMSetting_Price_DI_LoadLocation.Params = $.extend(true, _FLMSetting_Price_DI_LoadLocation.Params, $state.params);
    ...
    Common.ALL.Get($http, {
        ...
        success: function (res) {
            _FLMSetting_Price_DI_LoadLocation.Data.ListPriceOfGOP = res;
        }
    })
    ...
    $scope.Back_Click = function ($event) {
        ...
        $state.go("main.FLMSetting.PriceDI", _FLMSetting_Price_DI_LoadLocation.Params)
    }

    $rootScope.IsLoading = true;
    Common.Services.Call($http, {
        url: Common.Services.url.FLM,
        method: _FLMSetting_Price_DI_LoadLocation.URL.Data,
        data: { contractTermID: _FLMSetting_Price_DI_LoadLocation.Params.TermID },
        success: function (res) {
            _FLMSetting_Price_DI_LoadLocation.Data.ListGroupProduct = res.ListGroupOfProduct;

            Common.Services.Call($http, {
                url: Common.Services.url.FLM,
                method: _FLMSetting_Price_DI_LoadLocation.URL.Get,
                data: { priceID: _FLMSetting_Price_DI_LoadLocation.Params.PriceID },
                success: function (res) {
                    $scope.Item = res;
    ...
    $scope.InitView_Loading = function () {
        ...
        for (var i = 0; i < _FLMSetting_Price_DI_LoadLocation.Data.ListGroupProduct.length; i++) {
            var item = _FLMSetting_Price_DI_LoadLocation.Data.ListGroupProduct[i];
                            ...
                            $('<input data-bind="value:' + options.field + '" />').appendTo(container)
                                .kendoComboBox({
                                    ...
                                    dataSource: Common.DataSource.Local({
                                        data: _FLMSetting_Price_DI_LoadLocation.Data.ListPriceOfGOP,
                                        model: {
                                            id: 'ID',
                                            fields: {
                                                ID: { type: 'number' },
    ...
    $scope.Loading_Delete_Click = function ($event, item, grid) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.FLM,
            method: _FLMSetting_Price_DI_LoadLocation.URL.Loading_Delete,
            data: { ID: item.ID },
            success: function (res) {
    ...
    $scope.Loading_DeleteAll_Click = function ($event, grid) {
        ...
        $rootScope.Message({
            ...
            Ok: function () {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.FLM,
                    method: _FLMSetting_Price_DI_LoadLocation.URL.Loading_DeleteList,
                    data: { data: data },
                    success: function (res) {
    ...
    $scope.Loading_Location_NotIn_Submit_Click = function ($event, grid, win) {
        ...
        if (data.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.FLM,
                method: _FLMSetting_Price_DI_LoadLocation.URL.Loading_Location_NotIn_SaveList,
    ...
    $scope.Loading_Update_Click = function ($event, grid) {
        ...
        for (var i = 0; i < dataSource.length; i++) {
            ...
            if (dataitem.dirty) {
                ...
                for (var j = 0; j < _FLMSetting_Price_DI_LoadLocation.Data.ListGroupProduct.length; j++) {
                    var product = _FLMSetting_Price_DI_LoadLocation.Data.ListGroupProduct[j];
        ...
        if (data.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.FLM,
                method: _FLMSetting_Price_DI_LoadLocation.URL.Loading_SaveList,
                data: { data: data },
                success: function (res) {
                    $scope.LoadData_Loading();
                    $rootScope.Message({ Msg: "Đã cập nhật!" });
    ...
    $scope.Loading_Excel_Click = function ($event, win) {
        ...
        $rootScope.UploadExcel({
            ...
            Download: function () {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.FLM,
                    method: _FLMSetting_Price_DI_LoadLocation.URL.Loading_Export,
                    data: { priceID: _FLMSetting_Price_DI_LoadLocation.Params.PriceID, contractTermID: _FLMSetting_Price_DI_LoadLocation.Params.TermID, },
                    success: function (res) {
                        $rootScope.IsLoading = false;
            ...
            Upload: function (e, callback) {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.FLM,
                    method: _FLMSetting_Price_DI_LoadLocation.URL.Loading_Check,
                    data: { file: e, priceID: _FLMSetting_Price_DI_LoadLocation.Params.PriceID, contractTermID: _FLMSetting_Price_DI_LoadLocation.Params.TermID },
            ...
            Complete: function (e, data) {
                if (!$scope.Item.TermClosed) {
                    ...
                    if (o.length > 0) {
                        ...
                        Common.Services.Call($http, {
                            url: Common.Services.url.FLM,
                            method: _FLMSetting_Price_DI_LoadLocation.URL.Loading_Import,
                            data: { lst: o, priceID: _FLMSetting_Price_DI_LoadLocation.Params.PriceID },
                            success: function (res) {
                                $rootScope.Message({ Msg: "Đã cập nhật!" });
    ...
    $scope.LoadData_Loading = function () {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.FLM,
            method: _FLMSetting_Price_DI_LoadLocation.URL.Loading_List,
                ...
                Common.Services.Error(res, function (res) {
                    ...
                    for (var i = 0; i < res.length; i++) {
                        ...
                        for (var j = 0; j < _FLMSetting_Price_DI_LoadLocation.Data.ListGroupProduct.length; j++) {
                            ...
                            var gop = _FLMSetting_Price_DI_LoadLocation.Data.ListGroupProduct[j];
                            var field = "F_" + gop.ID
    ...
    $scope.loading_location_notin_gridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.FLM,
            method: _FLMSetting_Price_DI_LoadLocation.URL.Loading_Location_NotIn_List,
            readparam: function () {
                return {
