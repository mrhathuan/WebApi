...
var _FLMSetting_PriceCO_PriceNormal = {
    URL: {
        Get: 'FLMContract_Price_Get',

        Data: 'FLMContract_PriceCO_Data',

        GroupContainer_GetData: 'FLMPrice_CO_COContainer_Data',
        GroupContainer_SaveList: 'FLMPrice_CO_COContainer_SaveList',

        GroupContainer_NotInList: 'FLMPrice_CO_COContainer_ContainerNotInList',
        GroupContainer_NotInSave: 'FLMPrice_CO_COContainer_ContainerNotInSave',

        GroupContainer: 'FLMPrice_CO_COContainer_ContainerList',
        GroupContainerDelete: 'FLMPrice_CO_COContainer_ContainerDelete',

        GroupContainer_Export: 'FLMPrice_CO_GroupContainer_ExcelExport',
        GroupContainer_Check: 'FLMPrice_CO_GroupContainer_ExcelCheck',
        GroupContainer_Import: 'FLMPrice_CO_GroupContainer_ExcelImport',

        ExcelInit: 'FLMPrice_CO_GroupContainer_ExcelInit',
        ExcelChange: 'FLMPrice_CO_GroupContainer_ExcelChange',
        ExcelImport: 'FLMPrice_CO_GroupContainer_ExcelOnImport',
        ExcelApprove: 'FLMPrice_CO_GroupContainer_ExcelApprove',
    },
    Data: {
        ListPackingTU: null,
        ListPackingCO: null,
...
angular.module('myapp').controller('FLMSetting_Price_CO_PriceNormalCtrl', ['$rootScope', '$scope', '$http', '$location', '$state', '$timeout', '$stateParams', function ($rootScope, $scope, $http, $location, $state, $timeout, $stateParams) {
    Common.Log('FLMSetting_Price_CO_PriceNormalCtrl');
    $rootScope.IsLoading = false;

    $scope.Item = null;
    _FLMSetting_PriceCO_PriceNormal.Params = $.extend({}, true, $state.params);
    ...
    Common.Services.Call($http, {
        ...
        method: _FLMSetting_PriceCO_PriceNormal.URL.Data,
        data: { contractTermID: _FLMSetting_PriceCO_PriceNormal.Params.TermID },
        success: function (res) {
            _FLMSetting_PriceCO_PriceNormal.Data.ListPackingCO = res.ListPackingCO;
            _FLMSetting_PriceCO_PriceNormal.Data.ListPackingTU = res.ListPackingTU;
            _FLMSetting_PriceCO_PriceNormal.Data.ListService = res.ListService;
            _FLMSetting_PriceCO_PriceNormal.Data.ListRouting = res.ListRouting;

            Common.Services.Call($http, {
                url: Common.Services.url.FLM,
                method: _FLMSetting_PriceCO_PriceNormal.URL.Get,
                data: { priceID: _FLMSetting_PriceCO_PriceNormal.Params.PriceID },
                success: function (res) {
                    $scope.Item = res;
    ...
    $scope.InitView_GroupContainer = function (isframe) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.FLM,
            method: _FLMSetting_PriceCO_PriceNormal.URL.GroupContainer_GetData,
            data: { priceID: _FLMSetting_PriceCO_PriceNormal.Params.PriceID },
            success: function (res) {
                var Model = {
                    id: 'RouteID',
                ...
                var dataGrid = [];
                if (isframe) {
                    Common.Data.Each(_FLMSetting_PriceCO_PriceNormal.Data.ListRouting, function (route) {
                        var item = {};
    ...
    $scope.GroupContainer_Save_Click = function ($event, grid) {
        ...
        if ($scope.IsFrame) {
            Common.Data.Each(data, function (row) {
                Common.Data.Each(_FLMSetting_PriceCO_PriceNormal.Data.ListPackingCO, function (level) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.FLM,
            method: _FLMSetting_PriceCO_PriceNormal.URL.GroupContainer_SaveList,
            data: { data: dataSave, priceID: _FLMSetting_PriceCO_PriceNormal.Params.PriceID },
            success: function (res) {
    ...
    $scope.groupOfContainer_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.FLM,
            method: _FLMSetting_PriceCO_PriceNormal.URL.GroupContainer,
            readparam: function () { return { priceID: _FLMSetting_PriceCO_PriceNormal.Params.PriceID } },
            model: {
                id: 'ID',
                fields: {
    ...
    $scope.GroupContainer_Choose_DeleteClick = function ($event, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.FLM,
                method: _FLMSetting_PriceCO_PriceNormal.URL.GroupContainerDelete,
                data: { lst: datasend, priceID: _FLMSetting_PriceCO_PriceNormal.Params.PriceID },
                success: function (res) {
    ...
    $scope.groupOfContainer_NotIn_GridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.FLM,
            method: _FLMSetting_PriceCO_PriceNormal.URL.GroupContainer_NotInList,
            readparam: function () { return { priceID: _FLMSetting_PriceCO_PriceNormal.Params.PriceID } },
            model: {
                id: 'ID',
                fields: {
    ...
    $scope.groupOfContainer_Save_Click = function ($event, win, grid) {
        ...
        if (datasend.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.FLM,
                method: _FLMSetting_PriceCO_PriceNormal.URL.GroupContainer_NotInSave,
                data: { priceID: _FLMSetting_PriceCO_PriceNormal.Params.PriceID, lst: datasend },
                success: function (res) {
                    $rootScope.IsLoading = false;
                    $scope.groupOfContainer_GridOptions.dataSource.read();
                    $scope.InitView_GroupContainer($scope.IsFrame);
    ...
    $scope.GroupContainer_Excel_Click = function ($event, win) {
        $rootScope.UploadExcel({
            ...
            Download: function () {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.FLM,
                    method: _FLMSetting_PriceCO_PriceNormal.URL.GroupContainer_Export,
                    data: { priceID: _FLMSetting_PriceCO_PriceNormal.Params.PriceID, contractTermID: _FLMSetting_PriceCO_PriceNormal.Params.TermID, isFrame: $scope.IsFrame },
                    success: function (res) {
                        $rootScope.IsLoading = false;
            ...
            Upload: function (e, callback) {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.FLM,
                    method: _FLMSetting_PriceCO_PriceNormal.URL.GroupContainer_Check,
                    data: { file: e, priceID: _FLMSetting_PriceCO_PriceNormal.Params.PriceID, contractTermID: _FLMSetting_PriceCO_PriceNormal.Params.TermID, isFrame: $scope.IsFrame },
            ...
            Complete: function (e, data) {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.FLM,
                    method: _FLMSetting_PriceCO_PriceNormal.URL.GroupContainer_Import,
                    data: { lst: data, priceID: _FLMSetting_PriceCO_PriceNormal.Params.PriceID },
                    success: function (res) {
                        $rootScope.IsLoading = false;
                        $rootScope.Message({ Msg: 'Thành công', NotifyType: Common.Message.NotifyType.SUCCESS });
                        $scope.InitView_GroupContainer($scope.IsFrame);
    ...
    $scope.GroupContainer_ExcelOn_Click = function ($event) {
        ...
        $rootScope.excelShare.Init({
            ...
            params: {
                priceID: _FLMSetting_PriceCO_PriceNormal.Params.PriceID,
                contractTermID: _FLMSetting_PriceCO_PriceNormal.Params.TermID,
                isFrame: $scope.IsFrame
            },
            rowStart: 1,
            colCheckChange: 6,
            url: Common.Services.url.FLM,
            methodInit: _FLMSetting_PriceCO_PriceNormal.URL.ExcelInit,
            methodChange: _FLMSetting_PriceCO_PriceNormal.URL.ExcelChange,
            methodImport: _FLMSetting_PriceCO_PriceNormal.URL.ExcelImport,
            methodApprove: _FLMSetting_PriceCO_PriceNormal.URL.ExcelApprove,
    ...
    $scope.Back_Click = function ($event) {
        $event.preventDefault();
        $state.go("main.FLMSetting.Term", { TermID: _FLMSetting_PriceCO_PriceNormal.Params.TermID, ContractID: $scope.Item.ContractID })
    }
