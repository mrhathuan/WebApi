...
var _FLMContract_Price_DI_UnLoadTypeOfPartner = {
    URL: {
        Get: 'FLMContract_Price_Get',
        Data: 'FLMContract_Price_Data',
        UnLoading_List: 'FLMPrice_DI_UnLoadPartner_List',
        UnLoading_Partner_NotIn_List: 'FLMPrice_DI_UnLoadPartner_PartnerNotIn_List',
        UnLoading_Partner_NotIn_SaveList: 'FLMPrice_DI_UnLoadPartner_PartnerNotIn_SaveList',
        UnLoading_Delete: 'FLMPrice_DI_UnLoad_Delete',
        UnLoading_SaveList: 'FLMPrice_DI_UnLoadPartner_SaveList',
...
angular.module('myapp').controller('FLMSetting_Price_DI_UnLoadTypeOfPartnerCtrl', ['$rootScope', '$scope', '$http', '$location', '$state', '$timeout', '$stateParams', function ($rootScope, $scope, $http, $location, $state, $timeout, $stateParams) {
    Common.Log('FLMSetting_Price_DI_UnLoadTypeOfPartnerCtrl');
    $rootScope.IsLoading = true;

    $scope.Item = null;
    _FLMContract_Price_DI_UnLoadTypeOfPartner.Params = $.extend({}, true, $state.params);

    Common.ALL.Get($http, {
        url: Common.ALL.URL.SYSVarPriceOfGOP,
        success: function (res) {
            _FLMContract_Price_DI_UnLoadTypeOfPartner.Data.ListPriceOfGOP = res;
        }
    })

    Common.Services.Call($http, {
        url: Common.Services.url.FLM,
        method: _FLMContract_Price_DI_UnLoadTypeOfPartner.URL.Data,
        data: { contractTermID: _FLMContract_Price_DI_UnLoadTypeOfPartner.Params.TermID },
        success: function (res) {
            _FLMContract_Price_DI_UnLoadTypeOfPartner.Data.ListGroupProduct = res.ListGroupOfProduct;
            Common.Services.Call($http, {
                url: Common.Services.url.FLM,
                method: _FLMContract_Price_DI_UnLoadTypeOfPartner.URL.Get,
                data: { priceID: _FLMContract_Price_DI_UnLoadTypeOfPartner.Params.PriceID },
                success: function (res) {
                    $scope.Item = res;
    ...
    $scope.Back_Click = function ($event) {
        ...
        $state.go("main.FLMSetting.PriceDI", _FLMContract_Price_DI_UnLoadTypeOfPartner.Params)
    }
    ...
    $scope.InitView_UnLoading = function () {
        ...
        for (var i = 0; i < _FLMContract_Price_DI_UnLoadTypeOfPartner.Data.ListGroupProduct.length; i++) {
            var item = _FLMContract_Price_DI_UnLoadTypeOfPartner.Data.ListGroupProduct[i];
                            ...
                            $('<input data-bind="value:' + options.field + '" />').appendTo(container)
                                .kendoComboBox({
                                    ...
                                    dataSource: Common.DataSource.Local({
                                        data: _FLMContract_Price_DI_UnLoadTypeOfPartner.Data.ListPriceOfGOP,
                                        model: {
                                            id: 'ID',
                                            fields: {
                                                ID: { type: 'number' },
    ...
    $scope.LoadData_UnLoading = function () {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.FLM,
            method: _FLMContract_Price_DI_UnLoadTypeOfPartner.URL.UnLoading_List,
            ...
            success: function (res) {
                ...
                Common.Services.Error(res, function (res) {
                    ...
                    for (var i = 0; i < res.length; i++) {
                        ...
                        for (var j = 0; j < _FLMContract_Price_DI_UnLoadTypeOfPartner.Data.ListGroupProduct.length; j++) {

                            var gop = _FLMContract_Price_DI_UnLoadTypeOfPartner.Data.ListGroupProduct[j];
                            var field = "F_" + gop.ID
    ...
    $scope.UnLoading_Delete_Click = function ($event, item, grid) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.FLM,
            method: _FLMContract_Price_DI_UnLoadTypeOfPartner.URL.UnLoading_Delete,
            data: { ID: item.ID },
            success: function (res) {
    ...
    $scope.UnLoading_Update_Click = function ($event, grid) {
        ...
        for (var i = 0; i < dataSource.length; i++) {
            ...
            if (dataitem.dirty) {
                ...
                for (var j = 0; j < _FLMContract_Price_DI_UnLoadTypeOfPartner.Data.ListGroupProduct.length; j++) {
                    var product = _FLMContract_Price_DI_UnLoadTypeOfPartner.Data.ListGroupProduct[j];
        ...
        if (data.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.FLM,
                method: _FLMContract_Price_DI_UnLoadTypeOfPartner.URL.UnLoading_SaveList,
                data: { data: data },
                success: function (res) {
                    $scope.LoadData_UnLoading();
    ...
    $scope.UnLoading_DeleteAll_Click = function ($event, grid) {
        ...
        $rootScope.Message({
            ...
            Ok: function () {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.FLM,
                    method: _FLMContract_Price_DI_UnLoadTypeOfPartner.URL.UnLoading_DeleteList,
                    data: { data: data },
                    success: function (res) {
    ...
    $scope.unloading_partner_notin_gridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.FLM,
            method: _FLMContract_Price_DI_UnLoadTypeOfPartner.URL.UnLoading_Partner_NotIn_List,
            readparam: function () {
                return {
    ...
    $scope.UnLoading_Partner_NotIn_Submit_Click = function ($event, grid, win) {
        ...
        if (data.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.FLM,
                method: _FLMContract_Price_DI_UnLoadTypeOfPartner.URL.UnLoading_Partner_NotIn_SaveList,
    ...
    $scope.Loading_Excel_Click = function ($event, win) {
        ...
        $rootScope.UploadExcel({
            ...
            Download: function () {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.FLM,
                    method: _FLMContract_Price_DI_UnLoadTypeOfPartner.URL.Excel_Export,
                    data: { contractTermID: _FLMContract_Price_DI_UnLoadTypeOfPartner.Params.TermID, priceID: _FLMContract_Price_DI_UnLoadTypeOfPartner.Params.PriceID },
                    success: function (res) {
                        $rootScope.IsLoading = false;
            ...
            Upload: function (e, callback) {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.FLM,
                    method: _FLMContract_Price_DI_UnLoadTypeOfPartner.URL.Excel_Check,
                    data: { file: e, contractTermID: _FLMContract_Price_DI_UnLoadTypeOfPartner.Params.TermID, priceID: _FLMContract_Price_DI_UnLoadTypeOfPartner.Params.PriceID },
            ...
            Complete: function (e, data) {
                if (!$scope.Item.TermClosed) {
                    ...
                    Common.Services.Call($http, {
                        url: Common.Services.url.FLM,
                        method: _FLMContract_Price_DI_UnLoadTypeOfPartner.URL.Excel_Save,
                        data: { lst: data, priceID: _FLMContract_Price_DI_UnLoadTypeOfPartner.Params.PriceID },
                        success: function (res) {
                            $rootScope.Message({
                                Msg: 'Đã cập nhật.',
