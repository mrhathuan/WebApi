...
var _FLMContract_Price_DIV2 = {
    URL: {
        ...
        //#region price ex
        PriceEx_List: 'FLMPrice_DI_Ex_List',
        PriceEx_Get: 'FLMPrice_DI_Ex_Get',
        PriceEx_Save: 'FLMPrice_DI_Ex_Save',
        PriceEx_Delete: 'FLMPrice_DI_Ex_Delete',
        ...
        //#endregion
        Price_DI_Load_DeleteAll: 'FLMPrice_DI_Load_DeleteAllList',
        Price_DI_UnLoad_DeleteAll: 'FLMPrice_DI_UnLoad_DeleteAllList',
...
angular.module('myapp').controller('FLMSetting_PriceDICtrl', ['$rootScope', '$scope', '$http', '$location', '$state', '$timeout', '$stateParams', function ($rootScope, $scope, $http, $location, $state, $timeout, $stateParams) {
    Common.Log('FLMSetting_PriceDICtrl');
    $rootScope.IsLoading = false;
    _FLMContract_Price_DIV2.Params = $.extend({}, true, $state.params);
    ...
    Common.Services.Call($http, {
        ...
        method: _FLMContract_Price_DIV2.URL.Get,
        data: { priceID: _FLMContract_Price_DIV2.Params.PriceID },
    ...
    $scope.price_ex_grid_Options = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.FLM,
            method: _FLMContract_Price_DIV2.URL.PriceEx_List,
            readparam: function () { return { priceID: _FLMContract_Price_DIV2.Params.PriceID } },
            model: {
                id: 'ID',
                fields: {
    ...
    $scope.priceEx_GridEdit_Click = function ($event, data) {
        $event.preventDefault();
        $state.go("main.FLMSetting.PriceDIEx", {
            PriceID: _FLMContract_Price_DIV2.Params.PriceID,
            PriceIDEx: data.ID,
    ...
    $scope.priceEx_GridDestroy_Click = function ($event, data) {
        ...
        $rootScope.Message({
            ...
            Ok: function () {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.FLM,
                    method: _FLMContract_Price_DIV2.URL.PriceEx_Delete,
                    data: { id: data.ID },
                    success: function (res) {
                        $rootScope.IsLoading = false;
    ...
    $scope.PriceDI_AddNormal_Click = function ($event) {
        ...
        if ((!$scope.ItemPrice.HasNormal && !$scope.ItemPrice.HasLevel) || $scope.ItemPrice.HasNormal) {
            $state.go("main.FLMSetting.PriceDINormal", _FLMContract_Price_DIV2.Params)
        }
    }
    ...
    $scope.PriceDI_AddLevel_Click = function ($event) {
        ...
        if ((!$scope.ItemPrice.HasNormal && !$scope.ItemPrice.HasLevel) || $scope.ItemPrice.HasLevel) {
            $state.go("main.FLMSetting.PriceDILevel", _FLMContract_Price_DIV2.Params)
        }
    }

    $scope.PriceDI_AddMOQ_Click = function ($event) {
        $event.preventDefault();
        $state.go("main.FLMSetting.PriceDIMOQ", { PriceID: _FLMContract_Price_DIV2.Params.PriceID, TermID: _FLMContract_Price_DIV2.Params.TermID, CustomerID: $scope.ItemPrice.CustomerID })
    }
    ...
    $scope.PriceDI_DeleteNormal_Click = function ($event) {
        ...
        //        Common.Services.Call($http, {
        //            url: Common.Services.url.FLM,
        //            method: _FLMContract_Price_DIV2.URL.Delete_PriceNormal,
        //            data: { priceID: _FLMContract_Price_DIV2.Params.ID },
        //            success: function (res) {
        //                $scope.LoadItemPrice();
        //            },
        //            error: function (res) {
    ...
    $scope.PriceDI_DeleteLevel_Click = function ($event) {
        ...
        //        Common.Services.Call($http, {
        //            url: Common.Services.url.FLM,
        //            method: _FLMContract_Price_DIV2.URL.Delete_PriceLevel,
        //            data: { priceID: _FLMContract_Price_DIV2.Params.ID },
        //            success: function (res) {
        //                $scope.LoadItemPrice();
        //            },
    ...
    $scope.PriceDI_DeleteMOQ_Click = function ($event) {
        ...
        //        Common.Services.Call($http, {
        //            url: Common.Services.url.FLM,
        //            method: _FLMContract_Price_DIV2.URL.PriceMOQ_DeleteList,
        //            data: { priceID: _FLMContract_Price_DIV2.Params.ID },
        //            success: function (res) {
        //                $scope.LoadItemPrice();
        //            },
    ...
    $scope.PriceDI_LoadLocation_Click = function ($event) {
        $event.preventDefault();
        $state.go("main.FLMSetting.PriceDILoadLocation", _FLMContract_Price_DIV2.Params)
    }
    $scope.PriceDI_LoadLocation_DeleteClick = function ($event) {
        ...
        //        Common.Services.Call($http, {
        //            url: Common.Services.url.FLM,
        //            method: _FLMContract_Price_DIV2.URL.PriceLoad_Location_DeleteList,
        //            data: { priceID: _FLMContract_Price_DIV2.Params.ID },
        //            success: function (res) {
        //                $scope.LoadItemPrice();
        //            },
    ...
    $scope.PriceDI_Load_DeleteAllClick = function ($event) {
        ...
        //        Common.Services.Call($http, {
        //            url: Common.Services.url.FLM,
        //            method: _FLMContract_Price_DIV2.URL.Price_DI_Load_DeleteAll,
        //            data: { priceID: _FLMContract_Price_DIV2.Params.ID },
        //            success: function (res) {
        //                $scope.LoadItemPrice();
        //                $rootScope.IsLoading = false;
    ...
    $scope.PriceDI_LoadRoute_Click = function ($event) {
        $event.preventDefault();
        $state.go("main.FLMSetting.PriceDILoadRoute", _FLMContract_Price_DIV2.Params)
    }
    $scope.PriceDI_LoadRoute_DeleteClick = function ($event) {
        ...
        //        Common.Services.Call($http, {
        //            url: Common.Services.url.FLM,
        //            method: _FLMContract_Price_DIV2.URL.PriceLoad_Route_DeleteList,
        //            data: { priceID: _FLMContract_Price_DIV2.Params.ID },
        //            success: function (res) {
        //                $scope.LoadItemPrice();
        //            },
    ...
    $scope.PriceDI_LoadPartner_Click = function ($event) {
        $event.preventDefault();
        $state.go("main.FLMSetting.PriceDILoadPartner", _FLMContract_Price_DIV2.Params)
    }
    $scope.PriceDI_LoadTypeOfPartner_Click = function ($event) {
        $event.preventDefault();
        $state.go("main.FLMSetting.PriceDILoadTypeOfPartner", _FLMContract_Price_DIV2.Params)
    }
    $scope.PriceDI_LoadPartner_DeleteClick = function ($event) {
        ...
        //        Common.Services.Call($http, {
        //            url: Common.Services.url.FLM,
        //            method: _FLMContract_Price_DIV2.URL.PriceLoad_Partner_DeleteList,
        //            data: { priceID: _FLMContract_Price_DIV2.Params.ID },
        //            success: function (res) {
        //                $scope.LoadItemPrice();
        //            },
    ...
    $scope.PriceDI_LoadMOQ_Click = function ($event) {
        $event.preventDefault();
        $state.go("main.FLMSetting.PriceDILoadMOQ", { PriceID: _FLMContract_Price_DIV2.Params.PriceID, TermID: _FLMContract_Price_DIV2.Params.TermID, CustomerID: $scope.ItemPrice.CustomerID })
    }
    $scope.PriceDI_LoadMOQ_DeleteClick = function ($event) {
        ...
        //        Common.Services.Call($http, {
        //            url: Common.Services.url.FLM,
        //            method: _FLMContract_Price_DIV2.URL.PriceLoad_MOQ_DeleteList,
        //            data: { priceID: _FLMContract_Price_DIV2.Params.ID },
        //            success: function (res) {
        //                $scope.LoadItemPrice();
        //            },
    ...
    $scope.PriceDI_UnLoadLocation_Click = function ($event) {
        $event.preventDefault();
        $state.go("main.FLMSetting.PriceDIUnLoadLocation", _FLMContract_Price_DIV2.Params)
    }
    $scope.PriceDI_UnLoadLocation_DeleteClick = function ($event) {
        ...
        //        Common.Services.Call($http, {
        //            url: Common.Services.url.FLM,
        //            method: _FLMContract_Price_DIV2.URL.PriceUnLoad_Partner_DeleteList,
        //            data: { priceID: _FLMContract_Price_DIV2.Params.ID },
        //            success: function (res) {
        //                $scope.LoadItemPrice();
        //            },
    ...
    $scope.PriceDI_UnLoadRoute_Click = function ($event) {
        $event.preventDefault();
        $state.go("main.FLMSetting.PriceDIUnLoadRoute", _FLMContract_Price_DIV2.Params)
    }
    ...
    $scope.PriceDI_UnLoadPartner_Click = function ($event) {
        $event.preventDefault();
        $state.go("main.FLMSetting.PriceDIUnLoadPartner", _FLMContract_Price_DIV2.Params)
    }

    $scope.PriceDI_UnLoadTypeOfPartner_Click = function ($event) {
        $event.preventDefault();
        $state.go("main.FLMSetting.PriceDIUnLoadTypeOfPartner", _FLMContract_Price_DIV2.Params)
    }
    ...
    $scope.PriceDI_UnLoadMOQ_Click = function ($event) {
        $event.preventDefault();
        $state.go("main.FLMSetting.PriceDIUnLoadMOQ", { PriceID: _FLMContract_Price_DIV2.Params.PriceID, TermID: _FLMContract_Price_DIV2.Params.TermID, CustomerID: $scope.ItemPrice.CustomerID })
    }
    $scope.PriceDI_UnLoadMOQ_DeleteClick = function ($event) {
        ...
        //        Common.Services.Call($http, {
        //            url: Common.Services.url.FLM,
        //            method: _FLMContract_Price_DIV2.URL.PriceUnLoad_MOQ_DeleteList,
        //            data: { priceID: _FLMContract_Price_DIV2.Params.ID },
        //            success: function (res) {
        //                $scope.LoadItemPrice();
        //            },
    ...
    $scope.PriceDI_UnLoad_DeleteAllClick = function ($event) {
        ...
        //        Common.Services.Call($http, {
        //            url: Common.Services.url.FLM,
        //            method: _FLMContract_Price_DIV2.URL.Price_DI_UnLoad_DeleteAll,
        //            data: { priceID: _FLMContract_Price_DIV2.Params.ID },
        //            success: function (res) {
        //                $scope.LoadItemPrice();
        //                $rootScope.IsLoading = false;
    ...
    $scope.PriceDI_Ex_Click = function ($event) {
        $event.preventDefault();
        $state.go("main.FLMSetting.PriceDIEx", _FLMContract_Price_DIV2.Params)
    }
    ...
    $scope.Back_Click = function ($event) {
        $event.preventDefault();
        $state.go("main.FLMSetting.Term", { TermID: _FLMContract_Price_DIV2.Params.TermID, ContractID: $scope.ItemPrice.ContractID })
    }
}]);