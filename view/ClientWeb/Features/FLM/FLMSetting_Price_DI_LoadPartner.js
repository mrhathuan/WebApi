...
var _FLMSetting_Price_DI_LoadPartner = {
    URL: {
        Get: 'FLMContract_Price_Get',
        Data: 'FLMContract_Price_Data',


        Loading_List: 'FLMPrice_DI_LoadPartner_Partner_List',
        Loading_Delete: 'FLMPrice_DI_Load_Delete',
        Loading_SaveList: 'FLMPrice_DI_LoadPartner_Partner_SaveList',
        Loading_DeleteList: 'FLMPrice_DI_LoadPartner_Partner_DeleteList',
        Loading_Location_NotIn_List: 'FLMPrice_DI_LoadPartner_Partner_PartnerNotIn_List',
        Loading_Location_NotIn_SaveList: 'FLMPrice_DI_LoadPartner_Partner_PartnerNotIn_SaveList',

        Excel_Export: "FLMPrice_DI_LoadPartner_ExcelExport",
        Excel_Check: "FLMPrice_DI_LoadPartner_ExcelCheck",
        Excel_Save: "FLMPrice_DI_LoadPartner_Import",
...
angular.module('myapp').controller('FLMSetting_Price_DI_LoadPartnerCtrl', ['$rootScope', '$scope', '$http', '$location', '$state', '$timeout', '$stateParams', function ($rootScope, $scope, $http, $location, $state, $timeout, $stateParams) {
    Common.Log('FLMSetting_Price_DI_LoadPartnerCtrl');
    $rootScope.IsLoading = false;

    $scope.Item = null;
    _FLMSetting_Price_DI_LoadPartner.Params = $.extend({}, true, $state.params);
        ...
        $rootScope.UploadExcel({
            ...
            Download: function () {
                ...
                Common.Services.Call($http, {
                    ...
                    method: _FLMSetting_Price_DI_LoadPartner.URL.Excel_Export,
                    data: { contractTermID: _FLMSetting_Price_DI_LoadPartner.Params.TermID, priceID: _FLMSetting_Price_DI_LoadPartner.Params.PriceID },
            ...
            Upload: function (e, callback) {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.FLM,
                    method: _FLMSetting_Price_DI_LoadPartner.URL.Excel_Check,
                    data: { file: e, contractTermID: _FLMSetting_Price_DI_LoadPartner.Params.TermID, priceID: _FLMSetting_Price_DI_LoadPartner.Params.PriceID },
            ...
            Complete: function (e, data) {
                if (!$scope.Item.TermClosed) {
                    ...
                    Common.Services.Call($http, {
                        url: Common.Services.url.FLM,
                        method: _FLMSetting_Price_DI_LoadPartner.URL.Excel_Save,
                        data: { lst: data, priceID: _FLMSetting_Price_DI_LoadPartner.Params.PriceID },
                        success: function (res) {
                            $rootScope.Message({
                                Msg: 'Đã cập nhật.',
    ...
    Common.ALL.Get($http, {
        ...
        success: function (res) {
            _FLMSetting_Price_DI_LoadPartner.Data.ListPriceOfGOP = res;
        }
    })
    ...
    Common.Services.Call($http, {
        url: Common.Services.url.FLM,
        method: _FLMSetting_Price_DI_LoadPartner.URL.Data,
        data: { contractTermID: _FLMSetting_Price_DI_LoadPartner.Params.TermID },
        success: function (res) {
            _FLMSetting_Price_DI_LoadPartner.Data.ListGroupProduct = res.ListGroupOfProduct;

            Common.Services.Call($http, {
                url: Common.Services.url.FLM,
                method: _FLMSetting_Price_DI_LoadPartner.URL.Get,
                data: { priceID: _FLMSetting_Price_DI_LoadPartner.Params.PriceID },
                success: function (res) {
                    $scope.Item = res;
    ...
    $scope.Back_Click = function ($event) {
        ...
        $state.go("main.CUSContract.PriceDI", _FLMSetting_Price_DI_LoadPartner.Params)
    }
    ...
    $scope.InitView_Loading = function () {
        ...
        for (var i = 0; i < _FLMSetting_Price_DI_LoadPartner.Data.ListGroupProduct.length; i++) {
            var item = _FLMSetting_Price_DI_LoadPartner.Data.ListGroupProduct[i];
                            ...
                            $('<input data-bind="value:' + options.field + '" />').appendTo(container)
                                .kendoComboBox({
                                    ...
                                    dataSource: Common.DataSource.Local({
                                        data: _FLMSetting_Price_DI_LoadPartner.Data.ListPriceOfGOP,
                                        model: {
                                            id: 'ID',
                                            fields: {
                                                ID: { type: 'number' },
    ...
    $scope.Loading_Delete_Click = function ($event, item, grid) {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.FLM,
            method: _FLMSetting_Price_DI_LoadPartner.URL.Loading_Delete,
            data: { ID: item.ID },
            success: function (res) {
    ...
    $scope.Loading_DeleteAll_Click = function ($event, grid) {
        ...
        $rootScope.Message({
            ...
            Ok: function () {
                ...
                Common.Services.Call($http, {
                    url: Common.Services.url.FLM,
                    method: _FLMSetting_Price_DI_LoadPartner.URL.Loading_DeleteList,
                    data: { priceID: _FLMSetting_Price_DI_LoadPartner.Params.PriceID },
                    success: function (res) {
    ...
    $scope.Loading_Location_NotIn_Submit_Click = function ($event, grid, win) {
        ...
        if (data.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.FLM,
                method: _FLMSetting_Price_DI_LoadPartner.URL.Loading_Location_NotIn_SaveList,
    ...
    $scope.Loading_Update_Click = function ($event, grid) {
        ...
        for (var i = 0; i < dataSource.length; i++) {
            ...
            if (dataitem.dirty) {
                ...
                for (var j = 0; j < _FLMSetting_Price_DI_LoadPartner.Data.ListGroupProduct.length; j++) {
                    var product = _FLMSetting_Price_DI_LoadPartner.Data.ListGroupProduct[j];
        ...
        if (data.length > 0) {
            ...
            Common.Services.Call($http, {
                url: Common.Services.url.FLM,
                method: _FLMSetting_Price_DI_LoadPartner.URL.Loading_SaveList,
                data: { data: data },
                success: function (res) {
                    $scope.LoadData_Loading();
                    $rootScope.Message({ Msg: "Đã cập nhật!" });
    ...
    $scope.LoadData_Loading = function () {
        ...
        Common.Services.Call($http, {
            url: Common.Services.url.FLM,
            method: _FLMSetting_Price_DI_LoadPartner.URL.Loading_List,
                ...
                Common.Services.Error(res, function (res) {
                    ...
                    for (var i = 0; i < res.length; i++) {
                        ...
                        for (var j = 0; j < _FLMSetting_Price_DI_LoadPartner.Data.ListGroupProduct.length; j++) {
                            ...
                            var gop = _FLMSetting_Price_DI_LoadPartner.Data.ListGroupProduct[j];
                            var field = "F_" + gop.ID
    ...
    $scope.loading_location_notin_gridOptions = {
        dataSource: Common.DataSource.Grid($http, {
            url: Common.Services.url.FLM,
            method: _FLMSetting_Price_DI_LoadPartner.URL.Loading_Location_NotIn_List,
            readparam: function () {
                return {
