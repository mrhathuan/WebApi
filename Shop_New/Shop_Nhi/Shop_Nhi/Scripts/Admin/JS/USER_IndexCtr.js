...
app.controller('USER_IndexCtr', ['$http', '$scope', '$rootScope', function ($http, $scope, $rootScope) {
    $rootScope.title = 'Quản lý tài khoản';
    $scope.Item = null;
    ...
    $scope.User_gridOptions = {
        ...
        toolbar: kendo.template($('#UserGridTemplate').html()),
        excel: {
            fileName: "Tai_khoan.xlsx",
            filterable: true,
        ...
        columns: [
                 {
                     title: ' ', width: '110px',
                     template: '<a href="\\#" class="event-button" ng-click="USER_WinClick($event,#=id#)"><i class="fa fa-pencil"></i></a>' +
